...
/**
* @brief          Symbolic name for the channel DioChannel_LED1_RED_PA5.
*
*/
#define  DioConf_DioChannel_DioChannel_LED1_RED_PA5 ((uint16)0x0005U)
...
/**
* @brief          Symbolic name for the channel DioChannel_LED3_GREEN_PB14.
*
*/
#define  DioConf_DioChannel_DioChannel_LED3_GREEN_PB14 ((uint16)0x002eU)
