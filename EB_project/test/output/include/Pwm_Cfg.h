...
*
*/
#define PwmChannel_LED_FREEN                            ((Pwm_ChannelType)0U)
#define PwmChannel_EM0_CH10                            ((Pwm_ChannelType)1U)
#define PwmChannel_EM0_CH6                            ((Pwm_ChannelType)2U)

/**
* @brief        Symbolic name for configured channels - TPS_ECUC_02108 compliant.
*
*/
#define PwmConf_PwmChannel_PwmChannel_LED_FREEN          ((Pwm_ChannelType)0U)
#define PwmConf_PwmChannel_PwmChannel_EM0_CH10          ((Pwm_ChannelType)1U)
#define PwmConf_PwmChannel_PwmChannel_EM0_CH6          ((Pwm_ChannelType)2U)
