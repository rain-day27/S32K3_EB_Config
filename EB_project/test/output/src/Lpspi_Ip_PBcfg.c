...
#define LPSPI_IP_SW_MAJOR_VERSION_PBCFG_C                 5
...
#error "Software Version Numbers of Lpspi_Ip.h and Lpspi_Ip_PBcfg.c are different"
        ...
        #if ((DMA_IP_CFG_AR_RELEASE_MAJOR_VERSION != LPSPI_IP_AR_RELEASE_MAJOR_VERSION_PBCFG_C) || \
             (DMA_IP_CFG_AR_RELEASE_MINOR_VERSION != LPSPI_IP_AR_RELEASE_MINOR_VERSION_PBCFG_C))
        #error "AutoSar Version Numbers of Lpspi_Ip_PBcfg.c and Dma_Ip_Cfg.h are different"
        #endif
    #endif
#endif
/*==================================================================================================
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_1_Instance_0 =
{
    ...
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
        ...
        (uint32)(LPSPI_CCR_SCKPCS(79U) | LPSPI_CCR_PCSSCK(79U) | LPSPI_CCR_SCKDIV(78U) | LPSPI_CCR_DBT(78U)), /* CCR */
        /* Normal Mode TCR */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(1U) | LPSPI_TCR_CPHA(1U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(2U) | LPSPI_TCR_CONT(1U)) /* TCR */
