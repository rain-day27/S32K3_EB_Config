...
#define SPI_SW_MAJOR_VERSION_PBCFG_C                 5
...
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_0 =
{
        ...
        128U, /* Length (configured in SpiEbMaxLength) */
        &Spi_Buffer_SpiChannel_0, /* pcBufferDescriptor */
...
static const Spi_ChannelConfigType Spi_ChannelConfig_SpiChannel_1 =
{
        ...
        (uint32)1U, /* In the case SpiDefaultData is disabled. Set this value is 1U */
        128U, /* Length (configured in SpiEbMaxLength) */
        &Spi_Buffer_SpiChannel_1, /* pcBufferDescriptor */
        (uint32)SPI_SPURIOUS_USER_ID_U32,
};
...
static const Spi_JobType Spi_SpiSequence_0_JobAssignment[2] = 
{
...
static const Spi_ConfigType Spi_Config=
{
    ...
    (uint32)SPI_SPURIOUS_USER_ID_U32, /* u32SpiPartitionUse */
