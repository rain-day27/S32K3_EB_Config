 ...
 * @version 1.3
 * @date 2023-06-08
 * @brief Peripheral Access Layer for S32K311_BCTU
 *
...
#if !defined(S32K311_BCTU_H_)  /* Check if memory map has not been already included */
#define S32K311_BCTU_H_
...
#endif  /* #if !defined(S32K311_BCTU_H_) */
