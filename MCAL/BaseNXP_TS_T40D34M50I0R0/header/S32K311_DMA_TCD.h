...
/*!
 * @file S32K311_DMA_TCD.h
 * @version 1.3
 * @date 2023-06-08
 * @brief Peripheral Access Layer for S32K311_DMA_TCD
 *
...
#if !defined(S32K311_DMA_TCD_H_)  /* Check if memory map has not been already included */
#define S32K311_DMA_TCD_H_
...
#endif  /* #if !defined(S32K311_DMA_TCD_H_) */
