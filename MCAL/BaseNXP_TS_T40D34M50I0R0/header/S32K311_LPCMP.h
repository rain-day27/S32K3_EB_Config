...
/*!
 * @file S32K311_LPCMP.h
 * @version 1.3
 * @date 2023-06-08
 * @brief Peripheral Access Layer for S32K311_LPCMP
 *
...
#if !defined(S32K311_LPCMP_H_)  /* Check if memory map has not been already included */
#define S32K311_LPCMP_H_
...
#define LPCMP_INSTANCE_COUNT                     (1u)
...
#define IP_LPCMP_BASE_ADDRS                      { IP_LPCMP_0_BASE }
/** Array initializer of LPCMP peripheral base pointers */
#define IP_LPCMP_BASE_PTRS                       { IP_LPCMP_0 }
...
#endif  /* #if !defined(S32K311_LPCMP_H_) */
