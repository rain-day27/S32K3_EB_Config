 ...
 * @version 1.0
 * @date 2022-06-16
 * @brief Peripheral Access Layer for S32K311_MPU
 *
...
#if !defined(S32K311_MPU_H_)  /* Check if memory map has not been already included */
#define S32K311_MPU_H_
...
#endif  /* #if !defined(S32K311_MPU_H_) */
