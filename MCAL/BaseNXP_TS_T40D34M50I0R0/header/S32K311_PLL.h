 ...
 * @version 1.3
 * @date 2023-06-08
 * @brief Peripheral Access Layer for S32K311_PLL
 *
...
#if !defined(S32K311_PLL_H_)  /* Check if memory map has not been already included */
#define S32K311_PLL_H_
...
#define PLL_PLLCLKMUX_REFCLKSEL_MASK             (0x1U)
#define PLL_PLLCLKMUX_REFCLKSEL_SHIFT            (0U)
#define PLL_PLLCLKMUX_REFCLKSEL_WIDTH            (1U)
#define PLL_PLLCLKMUX_REFCLKSEL(x)               (((uint32_t)(((uint32_t)(x)) << PLL_PLLCLKMUX_REFCLKSEL_SHIFT)) & PLL_PLLCLKMUX_REFCLKSEL_MASK)
/*! @} */
...
#endif  /* #if !defined(S32K311_PLL_H_) */
