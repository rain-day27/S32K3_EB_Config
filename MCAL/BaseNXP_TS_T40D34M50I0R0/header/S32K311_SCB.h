 ...
 * @version 1.0
 * @date 2022-06-16
 * @brief Peripheral Access Layer for S32K311_SCB
 *
...
#if !defined(S32K311_SCB_H_)  /* Check if memory map has not been already included */
#define S32K311_SCB_H_
...
#endif  /* #if !defined(S32K311_SCB_H_) */
