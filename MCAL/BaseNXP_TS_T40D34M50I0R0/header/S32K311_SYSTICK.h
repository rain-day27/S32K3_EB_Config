...
**     Reference manual:    S32K3xx RM Rev4
**     Version:             rev. 1.0, 2022-06-15
**     Build:               b220618
**
**     Abstract:
...
/*!
 * @file S32K311_SYSTICK.h
 * @version 1.0
 * @date 2022-06-16
 * @brief Peripheral Access Layer for S32K311_SYSTICK
 *
...
#if !defined(S32K311_SYSTICK_H_)  /* Check if memory map has not been already included */
#define S32K311_SYSTICK_H_
...
#endif  /* #if !defined(S32K311_SYSTICK_H_) */
