 ...
 * @version 1.3
 * @date 2023-06-08
 * @brief Peripheral Access Layer for S32K311_WKPU
 *
...
#if !defined(S32K311_WKPU_H_)  /* Check if memory map has not been already included */
#define S32K311_WKPU_H_
...
#define WKPU_WISR_64_EIF_1_MASK                  (0x3FU)
#define WKPU_WISR_64_EIF_1_SHIFT                 (0U)
#define WKPU_WISR_64_EIF_1_WIDTH                 (6U)
...
#define WKPU_IRER_64_EIRE_1_MASK                 (0x3FU)
#define WKPU_IRER_64_EIRE_1_SHIFT                (0U)
#define WKPU_IRER_64_EIRE_1_WIDTH                (6U)
...
#define WKPU_WRER_64_WRE_1_MASK                  (0x3FU)
#define WKPU_WRER_64_WRE_1_SHIFT                 (0U)
#define WKPU_WRER_64_WRE_1_WIDTH                 (6U)
...
#define WKPU_WIREER_64_IREE_1_MASK               (0x3FU)
#define WKPU_WIREER_64_IREE_1_SHIFT              (0U)
#define WKPU_WIREER_64_IREE_1_WIDTH              (6U)
...
#define WKPU_WIFEER_64_IFEEx_1_MASK              (0x3FU)
#define WKPU_WIFEER_64_IFEEx_1_SHIFT             (0U)
#define WKPU_WIFEER_64_IFEEx_1_WIDTH             (6U)
...
#define WKPU_WIFER_64_IFE_1_MASK                 (0x3FU)
#define WKPU_WIFER_64_IFE_1_SHIFT                (0U)
#define WKPU_WIFER_64_IFE_1_WIDTH                (6U)
...
#endif  /* #if !defined(S32K311_WKPU_H_) */
