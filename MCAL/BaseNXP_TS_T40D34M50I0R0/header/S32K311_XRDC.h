 ...
 * @version 1.3
 * @date 2023-06-08
 * @brief Peripheral Access Layer for S32K311_XRDC
 *
...
#if !defined(S32K311_XRDC_H_)  /* Check if memory map has not been already included */
#define S32K311_XRDC_H_
...
#define XRDC_DERRW0_COUNT                         18u
#define XRDC_PID_COUNT                            4u
#define XRDC_PDAC_SLOT_PDACN_COUNT                108u
...
typedef struct {
  ...
  struct {                                         /* offset: 0x400, array step: 0x10 */
    __I  uint32_t DERR_W0;                           /**< Domain Error Word 0, array offset: 0x400, array step: 0x10, valid indices: [0-1, 16-17] */
    __I  uint32_t DERR_W1;                           /**< Domain Error Word 1, array offset: 0x404, array step: 0x10, valid indices: [0-1, 16-17] */
    uint8_t RESERVED_0[4];
    __O  uint32_t DERR_W3;                           /**< Domain Error Word 3, array offset: 0x40C, array step: 0x10, valid indices: [0-1, 16-17] */
  ...
  struct {                                         /* offset: 0x1000, array step: 0x400 */
    struct {                                         /* offset: 0x1000, array step: index*0x400, index2*0x8 */
      __IO uint32_t PDAC_W0;                           /**< Peripheral Domain Access Control Word 0, array offset: 0x1000, array step: index*0x400, index2*0x8, valid indices: [0][32-35, 38-41, 44-45, 48], [1][1, 3-39, 42-43, 45, 47, 49-50, 52-56, 58-60, 65-67, 73-77, 84-89, 92, 95-107] */
      __IO uint32_t PDAC_W1;                           /**< Peripheral Domain Access Control Word 1, array offset: 0x1004, array step: index*0x400, index2*0x8, valid indices: [0][32-35, 38-41, 44-45, 48], [1][1, 3-39, 42-43, 45, 47, 49-50, 52-56, 58-60, 65-67, 73-77, 84-89, 92, 95-107] */
...
#endif  /* #if !defined(S32K311_XRDC_H_) */
