...
/*!
 * @file S32K314_AXBS_LITE.h
 * @version 1.1
 * @date 2021-10-27
 * @brief Peripheral Access Layer for S32K314_AXBS_LITE
 *
...
#if !defined(S32K314_AXBS_LITE_H_)  /* Check if memory map has not been already included */
#define S32K314_AXBS_LITE_H_
...
#endif  /* #if !defined(S32K314_AXBS_LITE_H_) */
