 ...
 * @version 1.1
 * @date 2021-10-27
 * @brief Peripheral Access Layer for S32K314_CRC
 *
...
#if !defined(S32K314_CRC_H_)  /* Check if memory map has not been already included */
#define S32K314_CRC_H_
...
#endif  /* #if !defined(S32K314_CRC_H_) */
