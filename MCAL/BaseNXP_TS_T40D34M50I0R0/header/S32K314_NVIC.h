 ...
 * @version 1.0
 * @date 2021-09-03
 * @brief Peripheral Access Layer for S32K314_NVIC
 *
...
#if !defined(S32K314_NVIC_H_)  /* Check if memory map has not been already included */
#define S32K314_NVIC_H_
...
#endif  /* #if !defined(S32K314_NVIC_H_) */
