...
/*!
 * @file S32K322_CMU_FM.h
 * @version 1.1
 * @date 2022-12-06
 * @brief Peripheral Access Layer for S32K322_CMU_FM
 *
...
#if !defined(S32K322_CMU_FM_H_)  /* Check if memory map has not been already included */
#define S32K322_CMU_FM_H_
...
#endif  /* #if !defined(S32K322_CMU_FM_H_) */
