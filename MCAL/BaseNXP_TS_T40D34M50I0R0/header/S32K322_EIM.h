 ...
 * @version 1.1
 * @date 2022-12-06
 * @brief Peripheral Access Layer for S32K322_EIM
 *
...
#if !defined(S32K322_EIM_H_)  /* Check if memory map has not been already included */
#define S32K322_EIM_H_
...
#endif  /* #if !defined(S32K322_EIM_H_) */
