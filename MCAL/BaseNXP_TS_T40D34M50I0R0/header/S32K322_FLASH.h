...
/*!
 * @file S32K322_FLASH.h
 * @version 1.1
 * @date 2022-12-06
 * @brief Peripheral Access Layer for S32K322_FLASH
 *
...
#if !defined(S32K322_FLASH_H_)  /* Check if memory map has not been already included */
#define S32K322_FLASH_H_
...
#define IP_FLASH_ALT_BASE                        (0x402F0000u)
/** Peripheral FLASH_ALT base pointer */
#define IP_FLASH_ALT                             ((FLASH_Type *)IP_FLASH_ALT_BASE)
/** Array initializer of FLASH peripheral base addresses */
#define IP_FLASH_BASE_ADDRS                      { IP_FLASH_BASE, IP_FLASH_ALT_BASE }
/** Array initializer of FLASH peripheral base pointers */
#define IP_FLASH_BASE_PTRS                       { IP_FLASH, IP_FLASH_ALT }
...
#endif  /* #if !defined(S32K322_FLASH_H_) */
