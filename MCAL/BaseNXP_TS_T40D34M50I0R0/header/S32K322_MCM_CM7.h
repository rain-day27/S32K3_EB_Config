...
/*!
 * @file S32K322_MCM_CM7.h
 * @version 1.1
 * @date 2022-12-06
 * @brief Peripheral Access Layer for S32K322_MCM_CM7
 *
...
#if !defined(S32K322_MCM_CM7_H_)  /* Check if memory map has not been already included */
#define S32K322_MCM_CM7_H_
...
#define IP_MCM_CM7_BASE_ADDRS                    { IP_MCM_0_CM7_BASE, IP_MCM_1_CM7_BASE }
/** Array initializer of MCM_CM7 peripheral base pointers */
#define IP_MCM_CM7_BASE_PTRS                     { IP_MCM_0_CM7, IP_MCM_1_CM7 }
...
#endif  /* #if !defined(S32K322_MCM_CM7_H_) */
