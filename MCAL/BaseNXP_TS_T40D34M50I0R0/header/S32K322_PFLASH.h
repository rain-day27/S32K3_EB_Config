...
/*!
 * @file S32K322_PFLASH.h
 * @version 1.1
 * @date 2022-12-06
 * @brief Peripheral Access Layer for S32K322_PFLASH
 *
...
#if !defined(S32K322_PFLASH_H_)  /* Check if memory map has not been already included */
#define S32K322_PFLASH_H_
...
#endif  /* #if !defined(S32K322_PFLASH_H_) */
