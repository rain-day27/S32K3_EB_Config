...
/*!
 * @file S32K322_PRAMC.h
 * @version 1.1
 * @date 2022-12-06
 * @brief Peripheral Access Layer for S32K322_PRAMC
 *
...
#if !defined(S32K322_PRAMC_H_)  /* Check if memory map has not been already included */
#define S32K322_PRAMC_H_
...
#endif  /* #if !defined(S32K322_PRAMC_H_) */
