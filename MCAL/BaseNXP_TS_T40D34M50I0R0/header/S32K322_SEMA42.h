...
/*!
 * @file S32K322_SEMA42.h
 * @version 1.1
 * @date 2022-12-06
 * @brief Peripheral Access Layer for S32K322_SEMA42
 *
...
#if !defined(S32K322_SEMA42_H_)  /* Check if memory map has not been already included */
#define S32K322_SEMA42_H_
...
#endif  /* #if !defined(S32K322_SEMA42_H_) */
