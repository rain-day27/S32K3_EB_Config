...
/*!
 * @file S32K322_SIUL2.h
 * @version 1.1
 * @date 2022-12-06
 * @brief Peripheral Access Layer for S32K322_SIUL2
 *
...
#if !defined(S32K322_SIUL2_H_)  /* Check if memory map has not been already included */
#define S32K322_SIUL2_H_
...
typedef struct {
  ...
  __IO uint32_t MSCR[SIUL2_MSCR_COUNT];            /**< SIUL2 Multiplexed Signal Configuration, array offset: 0x240, array step: 0x4 */
  uint8_t RESERVED_11[1428];
  __IO uint32_t IMCR[SIUL2_IMCR_COUNT];            /**< SIUL2 Input Multiplexed Signal Configuration, array offset: 0xA40, array step: 0x4 */
...
#endif  /* #if !defined(S32K322_SIUL2_H_) */
