 ...
 * @version 1.1
 * @date 2022-12-06
 * @brief Peripheral Access Layer for S32K322_SWT
 *
...
#if !defined(S32K322_SWT_H_)  /* Check if memory map has not been already included */
#define S32K322_SWT_H_
...
#define IP_SWT_BASE_ADDRS                        { IP_SWT_0_BASE, IP_SWT_1_BASE }
/** Array initializer of SWT peripheral base pointers */
#define IP_SWT_BASE_PTRS                         { IP_SWT_0, IP_SWT_1 }
...
#endif  /* #if !defined(S32K322_SWT_H_) */
