...
/*!
 * @file S32K324_MC_CGM.h
 * @version 1.1
 * @date 2021-10-21
 * @brief Peripheral Access Layer for S32K324_MC_CGM
 *
...
#if !defined(S32K324_MC_CGM_H_)  /* Check if memory map has not been already included */
#define S32K324_MC_CGM_H_
...
#endif  /* #if !defined(S32K324_MC_CGM_H_) */
