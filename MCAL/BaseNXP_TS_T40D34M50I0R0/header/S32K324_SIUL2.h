...
/*!
 * @file S32K324_SIUL2.h
 * @version 1.1
 * @date 2021-10-21
 * @brief Peripheral Access Layer for S32K324_SIUL2
 *
...
#if !defined(S32K324_SIUL2_H_)  /* Check if memory map has not been already included */
#define S32K324_SIUL2_H_
...
#endif  /* #if !defined(S32K324_SIUL2_H_) */
