 ...
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_M7
 *
...
#if !defined(S32K341_COMMON_H_)  /* Check if memory map has not been already included */
#define S32K341_COMMON_H_
#define MCU_S32K341

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error S32K341_M7 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  BCTU_IRQn                    = 87,               /**< An interrupt is requested when a conversion is issued to the ADC, An interrupt is requested when new data is available from ADC0 conversion, An interrupt is requested when new data is available from ADC1 conversion,An Interrupt output for FIFO1,An Interrupt output for FIFO2 */
...
#endif  /* #if !defined(S32K341_COMMON_H_) */
