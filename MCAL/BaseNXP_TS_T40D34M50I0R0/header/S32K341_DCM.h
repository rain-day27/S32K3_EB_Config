 ...
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_DCM
 *
...
#if !defined(S32K341_DCM_H_)  /* Check if memory map has not been already included */
#define S32K341_DCM_H_
...
typedef struct {
  ...
  __I  uint32_t DCMLCC;                            /**< LC and LC Control, offset: 0x4 */
...
#endif  /* #if !defined(S32K341_DCM_H_) */
