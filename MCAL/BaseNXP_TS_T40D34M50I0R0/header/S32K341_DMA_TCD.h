...
/*!
 * @file S32K341_DMA_TCD.h
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_DMA_TCD
 *
...
#if !defined(S32K341_DMA_TCD_H_)  /* Check if memory map has not been already included */
#define S32K341_DMA_TCD_H_
...
#endif  /* #if !defined(S32K341_DMA_TCD_H_) */
