 ...
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_EIM
 *
...
#if !defined(S32K341_EIM_H_)  /* Check if memory map has not been already included */
#define S32K341_EIM_H_
...
#define EIM_EICHD28_WORD1_B0_3DATA_MASK_MASK     (0xFFFFFFFU)
#define EIM_EICHD28_WORD1_B0_3DATA_MASK_SHIFT    (0U)
#define EIM_EICHD28_WORD1_B0_3DATA_MASK_WIDTH    (28U)
...
#endif  /* #if !defined(S32K341_EIM_H_) */
