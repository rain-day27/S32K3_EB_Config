 ...
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_FCCU
 *
...
#if !defined(S32K341_FCCU_H_)  /* Check if memory map has not been already included */
#define S32K341_FCCU_H_
...
#endif  /* #if !defined(S32K341_FCCU_H_) */
