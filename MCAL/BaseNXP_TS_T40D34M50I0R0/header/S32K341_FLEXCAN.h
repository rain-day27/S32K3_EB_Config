...
/*!
 * @file S32K341_FLEXCAN.h
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_FLEXCAN
 *
...
#if !defined(S32K341_FLEXCAN_H_)  /* Check if memory map has not been already included */
#define S32K341_FLEXCAN_H_
...
typedef struct {
  ...
  __IO uint32_t IMASK2;                            /**< Interrupt Masks 2 Register, offset: 0x24, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3) */
  __IO uint32_t IMASK1;                            /**< Interrupt Masks 1 Register, offset: 0x28 */
  __IO uint32_t IFLAG2;                            /**< Interrupt Flags 2 Register, offset: 0x2C, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3) */
  ...
  __IO uint32_t RXIMR[FLEXCAN_RXIMR_COUNT];        /**< Rx Individual Mask Registers, array offset: 0x880, array step: 0x4, irregular array, not all indices are valid */
  ...
  __IO uint32_t ERFCR;                             /**< Enhanced Rx FIFO Control Register, offset: 0xC0C, available only on: CAN_0 (missing on CAN_1, CAN_2, CAN_3) */
  __IO uint32_t ERFIER;                            /**< Enhanced Rx FIFO Interrupt Enable Register, offset: 0xC10, available only on: CAN_0 (missing on CAN_1, CAN_2, CAN_3) */
  __IO uint32_t ERFSR;                             /**< Enhanced Rx FIFO Status Register, offset: 0xC14, available only on: CAN_0 (missing on CAN_1, CAN_2, CAN_3) */
  uint8_t RESERVED_5[24];
  __IO uint32_t HR_TIME_STAMP[FLEXCAN_HR_TIME_STAMP_COUNT]; /**< High Resolution Time Stamp, array offset: 0xC30, array step: 0x4, irregular array, not all indices are valid */
  uint8_t RESERVED_6[8912];
  __IO uint32_t ERFFEL[FLEXCAN_ERFFEL_COUNT];      /**< Enhanced Rx FIFO Filter Element, array offset: 0x3000, array step: 0x4, available only on: CAN_0 (missing on CAN_1, CAN_2, CAN_3) */
...
#endif  /* #if !defined(S32K341_FLEXCAN_H_) */
