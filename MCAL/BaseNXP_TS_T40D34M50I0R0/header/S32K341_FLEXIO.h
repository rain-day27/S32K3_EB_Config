...
/*!
 * @file S32K341_FLEXIO.h
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_FLEXIO
 *
...
#if !defined(S32K341_FLEXIO_H_)  /* Check if memory map has not been already included */
#define S32K341_FLEXIO_H_
...
typedef struct {
  ...
  __IO uint32_t SHIFTBUFHWS[FLEXIO_SHIFTBUFHWS_COUNT]; /**< Shifter Buffer N Halfword Swapped Register, array offset: 0x700, array step: 0x4 */
...
/*! @name SHIFTBUFHWS - Shifter Buffer N Halfword Swapped Register */
/*! @{ */
...
#endif  /* #if !defined(S32K341_FLEXIO_H_) */
