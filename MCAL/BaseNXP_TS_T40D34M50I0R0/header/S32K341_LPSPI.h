...
/*!
 * @file S32K341_LPSPI.h
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_LPSPI
 *
...
#if !defined(S32K341_LPSPI_H_)  /* Check if memory map has not been already included */
#define S32K341_LPSPI_H_
...
#endif  /* #if !defined(S32K341_LPSPI_H_) */
