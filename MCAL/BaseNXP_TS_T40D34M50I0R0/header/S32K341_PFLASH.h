...
/*!
 * @file S32K341_PFLASH.h
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_PFLASH
 *
...
#if !defined(S32K341_PFLASH_H_)  /* Check if memory map has not been already included */
#define S32K341_PFLASH_H_
...
#define PFLASH_PFCBLK_SSPELOCK_SSLCK_WIDTH       (4U)
...
#define PFLASH_PFCBLK_SSETSLOCK_SSETSLCK_WIDTH   (4U)
...
#endif  /* #if !defined(S32K341_PFLASH_H_) */
