 ...
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_PIT
 *
...
#if !defined(S32K341_PIT_H_)  /* Check if memory map has not been already included */
#define S32K341_PIT_H_
...
typedef struct {
  ...
  __I  uint32_t LTMR64H;                           /**< PIT Upper Lifetime Timer Register, offset: 0xE0, available only on: PIT_0 (missing on PIT_1, PIT_2) */
  __I  uint32_t LTMR64L;                           /**< PIT Lower Lifetime Timer Register, offset: 0xE4, available only on: PIT_0 (missing on PIT_1, PIT_2) */
  uint8_t RESERVED_1[4];
  __IO uint32_t RTI_LDVAL_STAT;                    /**< RTI Timer Load Value Sync Status Register, offset: 0xEC, available only on: PIT_0 (missing on PIT_1, PIT_2) */
  __IO uint32_t RTI_LDVAL;                         /**< Timer Load Value Register, offset: 0xF0, available only on: PIT_0 (missing on PIT_1, PIT_2) */
  __I  uint32_t RTI_CVAL;                          /**< Current Timer Value Register, offset: 0xF4, available only on: PIT_0 (missing on PIT_1, PIT_2) */
  __IO uint32_t RTI_TCTRL;                         /**< Timer Control Register, offset: 0xF8, available only on: PIT_0 (missing on PIT_1, PIT_2) */
  __IO uint32_t RTI_TFLG;                          /**< Timer Flag Register, offset: 0xFC, available only on: PIT_0 (missing on PIT_1, PIT_2) */
...
#endif  /* #if !defined(S32K341_PIT_H_) */
