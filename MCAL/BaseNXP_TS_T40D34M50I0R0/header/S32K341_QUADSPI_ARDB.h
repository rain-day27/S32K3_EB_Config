...
/*!
 * @file S32K341_QuadSPI_ARDB.h
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_QuadSPI_ARDB
 *
...
#if !defined(S32K341_QuadSPI_ARDB_H_)  /* Check if memory map has not been already included */
#define S32K341_QuadSPI_ARDB_H_
...
#define QuadSPI_ARDB_ARDB_COUNT                   32u
...
#endif  /* #if !defined(S32K341_QuadSPI_ARDB_H_) */
