 ...
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_SAI
 *
...
#if !defined(S32K341_SAI_H_)  /* Check if memory map has not been already included */
#define S32K341_SAI_H_
...
typedef struct {
  ...
  __O  uint32_t TDR[SAI_TDR_COUNT];                /**< Transmit Data, array offset: 0x20, array step: 0x4, irregular array, not all indices are valid */
...
#endif  /* #if !defined(S32K341_SAI_H_) */
