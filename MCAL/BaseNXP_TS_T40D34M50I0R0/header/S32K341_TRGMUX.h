...
/*!
 * @file S32K341_TRGMUX.h
 * @version 1.1
 * @date 2023-02-02
 * @brief Peripheral Access Layer for S32K341_TRGMUX
 *
...
#if !defined(S32K341_TRGMUX_H_)  /* Check if memory map has not been already included */
#define S32K341_TRGMUX_H_
...
typedef struct {
  __IO uint32_t TRGMUXn[TRGMUX_TRGMUXn_COUNT];     /**< TRGMUX ADC12_0 Register..TRGMUX CM7_RXEV Register, array offset: 0x0, array step: 0x4, valid indices: [0-1, 3-4, 6-39] */
...
#endif  /* #if !defined(S32K341_TRGMUX_H_) */
