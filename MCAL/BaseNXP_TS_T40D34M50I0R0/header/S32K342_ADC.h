 ...
 * @version 1.5
 * @date 2023-02-07
 * @brief Peripheral Access Layer for S32K342_ADC
 *
...
#if !defined(S32K342_ADC_H_)  /* Check if memory map has not been already included */
#define S32K342_ADC_H_
...
#endif  /* #if !defined(S32K342_ADC_H_) */
