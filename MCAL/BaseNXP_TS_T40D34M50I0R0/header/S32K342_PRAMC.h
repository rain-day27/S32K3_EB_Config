...
/*!
 * @file S32K342_PRAMC.h
 * @version 1.5
 * @date 2023-02-07
 * @brief Peripheral Access Layer for S32K342_PRAMC
 *
...
#if !defined(S32K342_PRAMC_H_)  /* Check if memory map has not been already included */
#define S32K342_PRAMC_H_
...
#endif  /* #if !defined(S32K342_PRAMC_H_) */
