 ...
 * @version 1.5
 * @date 2020-11-11
 * @brief Peripheral Access Layer for S32K342_SCB
 *
...
#if !defined(S32K342_SCB_H_)  /* Check if memory map has not been already included */
#define S32K342_SCB_H_
...
#endif  /* #if !defined(S32K342_SCB_H_) */
