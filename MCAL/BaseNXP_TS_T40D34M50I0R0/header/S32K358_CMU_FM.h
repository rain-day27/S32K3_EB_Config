...
/*!
 * @file S32K358_CMU_FM.h
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_CMU_FM
 *
...
#if !defined(S32K358_CMU_FM_H_)  /* Check if memory map has not been already included */
#define S32K358_CMU_FM_H_
...
#endif  /* #if !defined(S32K358_CMU_FM_H_) */
