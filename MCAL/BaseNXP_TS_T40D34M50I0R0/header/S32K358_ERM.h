 ...
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_ERM
 *
...
#if !defined(S32K358_ERM_H_)  /* Check if memory map has not been already included */
#define S32K358_ERM_H_
...
typedef struct {
  ...
  __I  uint32_t EAR16;                             /**< ERM Memory 16 Error Address Register, offset: 0x200, available only on: ERM_0 (missing on ERM_1) */
  __I  uint32_t SYN16;                             /**< ERM Memory 16 Syndrome Register, offset: 0x204, available only on: ERM_0 (missing on ERM_1) */
  __IO uint32_t CORR_ERR_CNT16;                    /**< ERM Memory 16 Correctable Error Count Register, offset: 0x208, available only on: ERM_0 (missing on ERM_1) */
  ...
  __I  uint32_t EAR18;                             /**< ERM Memory 18 Error Address Register, offset: 0x220, available only on: ERM_0 (missing on ERM_1) */
  uint8_t RESERVED_21[4];
  __IO uint32_t CORR_ERR_CNT18;                    /**< ERM Memory 18 Correctable Error Count Register, offset: 0x228, available only on: ERM_0 (missing on ERM_1) */
  uint8_t RESERVED_22[4];
  __I  uint32_t EAR19;                             /**< ERM Memory 19 Error Address Register, offset: 0x230, available only on: ERM_0 (missing on ERM_1) */
  uint8_t RESERVED_23[4];
  __IO uint32_t CORR_ERR_CNT19;                    /**< ERM Memory 19 Correctable Error Count Register, offset: 0x238, available only on: ERM_0 (missing on ERM_1) */
...
#endif  /* #if !defined(S32K358_ERM_H_) */
