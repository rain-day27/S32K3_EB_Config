...
/*!
 * @file S32K358_LPCMP.h
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_LPCMP
 *
...
#if !defined(S32K358_LPCMP_H_)  /* Check if memory map has not been already included */
#define S32K358_LPCMP_H_
...
#endif  /* #if !defined(S32K358_LPCMP_H_) */
