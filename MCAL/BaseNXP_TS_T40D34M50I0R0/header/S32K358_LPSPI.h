...
/*!
 * @file S32K358_LPSPI.h
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_LPSPI
 *
...
#if !defined(S32K358_LPSPI_H_)  /* Check if memory map has not been already included */
#define S32K358_LPSPI_H_
...
#endif  /* #if !defined(S32K358_LPSPI_H_) */
