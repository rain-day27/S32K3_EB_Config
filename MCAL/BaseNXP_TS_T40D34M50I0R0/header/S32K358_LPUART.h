...
/*!
 * @file S32K358_LPUART.h
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_LPUART
 *
...
#if !defined(S32K358_LPUART_H_)  /* Check if memory map has not been already included */
#define S32K358_LPUART_H_
...
typedef struct {
  ...
  __IO uint32_t MCR;                               /**< MODEM Control, offset: 0x40, not available in all instances (available on 2 out of 16) */
  __IO uint32_t MSR;                               /**< MODEM Status, offset: 0x44, not available in all instances (available on 2 out of 16) */
  __IO uint32_t REIR;                              /**< Receiver Extended Idle, offset: 0x48, not available in all instances (available on 2 out of 16) */
  __IO uint32_t TEIR;                              /**< Transmitter Extended Idle, offset: 0x4C, not available in all instances (available on 2 out of 16) */
  __IO uint32_t HDCR;                              /**< Half Duplex Control, offset: 0x50, not available in all instances (available on 2 out of 16) */
  uint8_t RESERVED_1[4];
  __IO uint32_t TOCR;                              /**< Timeout Control, offset: 0x58, not available in all instances (available on 2 out of 16) */
  __IO uint32_t TOSR;                              /**< Timeout Status, offset: 0x5C, not available in all instances (available on 2 out of 16) */
  __IO uint32_t TIMEOUT[LPUART_TIMEOUT_COUNT];     /**< Timeout N, array offset: 0x60, array step: 0x4, not available in all instances (available on 2 out of 16) */
  uint8_t RESERVED_2[400];
  __O  uint32_t TCBR[LPUART_TCBR_COUNT];           /**< Transmit Command Burst, array offset: 0x200, array step: 0x4, not available in all instances (available on 2 out of 16) */
  __O  uint32_t TDBR[LPUART_TDBR_COUNT];           /**< Transmit Data Burst, array offset: 0x400, array step: 0x4, not available in all instances (available on 2 out of 16) */
...
#endif  /* #if !defined(S32K358_LPUART_H_) */
