...
/*!
 * @file S32K358_MCM_CM7.h
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_MCM_CM7
 *
...
#if !defined(S32K358_MCM_CM7_H_)  /* Check if memory map has not been already included */
#define S32K358_MCM_CM7_H_
...
#define MCM_CM7_INSTANCE_COUNT                   (3u)
...
#define IP_MCM_CM7_BASE_ADDRS                    { IP_MCM_0_CM7_BASE, IP_MCM_1_CM7_BASE, IP_MCM_2_CM7_BASE }
/** Array initializer of MCM_CM7 peripheral base pointers */
#define IP_MCM_CM7_BASE_PTRS                     { IP_MCM_0_CM7, IP_MCM_1_CM7, IP_MCM_2_CM7 }
...
#endif  /* #if !defined(S32K358_MCM_CM7_H_) */
