 ...
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_MU
 *
...
#if !defined(S32K358_MU_H_)  /* Check if memory map has not been already included */
#define S32K358_MU_H_
...
typedef struct {
  ...
  __IO uint32_t CCR0;                              /**< Core Control 0, offset: 0x10, available only on: MU_0.MUB/MU_0__MUB, MU_1.MUB/MU_1__MUB (missing on MU_2.MUA/MU_2__MUA, MU_2.MUB/MU_2__MUB) */
  uint8_t RESERVED_0[4];
  __IO uint32_t CSSR0;                             /**< Core Sticky Status 0, offset: 0x18, available only on: MU_0.MUB/MU_0__MUB, MU_1.MUB/MU_1__MUB (missing on MU_2.MUA/MU_2__MUA, MU_2.MUB/MU_2__MUB) */
...
#define IP_MU_BASE_ADDRS                         { IP_MU_0__MUB_BASE, IP_MU_1__MUB_BASE, IP_MU_2__MUA_BASE, IP_MU_2__MUB_BASE }
/** Array initializer of MU peripheral base pointers */
#define IP_MU_BASE_PTRS                          { IP_MU_0__MUB, IP_MU_1__MUB, IP_MU_2__MUA, IP_MU_2__MUB }
...
#endif  /* #if !defined(S32K358_MU_H_) */
