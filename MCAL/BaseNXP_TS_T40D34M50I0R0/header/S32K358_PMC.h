 ...
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_PMC
 *
...
#if !defined(S32K358_PMC_H_)  /* Check if memory map has not been already included */
#define S32K358_PMC_H_
...
typedef struct {
  ...
  __IO uint32_t SMPSCONFIG;                        /**< SMPS Configuration Register, offset: 0x8 */
...
#define PMC_LVSC_Reserved_MASK                   (0x2000U)
#define PMC_LVSC_Reserved_SHIFT                  (13U)
#define PMC_LVSC_Reserved_WIDTH                  (1U)
#define PMC_LVSC_Reserved(x)                     (((uint32_t)(((uint32_t)(x)) << PMC_LVSC_Reserved_SHIFT)) & PMC_LVSC_Reserved_MASK)
...
/*! @name SMPSCONFIG - SMPS Configuration Register */
/*! @{ */
...
#endif  /* #if !defined(S32K358_PMC_H_) */
