...
/*!
 * @file S32K358_QuadSPI.h
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_QuadSPI
 *
...
#if !defined(S32K358_QuadSPI_H_)  /* Check if memory map has not been already included */
#define S32K358_QuadSPI_H_
...
typedef struct {
  ...
  __IO uint32_t SFACR;                             /**< Serial Flash Memory Address Register, offset: 0x104 */
...
#define QuadSPI_IPCR_ARB_LOCK_MASK               (0x400000U)
#define QuadSPI_IPCR_ARB_LOCK_SHIFT              (22U)
#define QuadSPI_IPCR_ARB_LOCK_WIDTH              (1U)
#define QuadSPI_IPCR_ARB_LOCK(x)                 (((uint32_t)(((uint32_t)(x)) << QuadSPI_IPCR_ARB_LOCK_SHIFT)) & QuadSPI_IPCR_ARB_LOCK_MASK)

#define QuadSPI_IPCR_ARB_UNLOCK_MASK             (0x800000U)
#define QuadSPI_IPCR_ARB_UNLOCK_SHIFT            (23U)
#define QuadSPI_IPCR_ARB_UNLOCK_WIDTH            (1U)
#define QuadSPI_IPCR_ARB_UNLOCK(x)               (((uint32_t)(((uint32_t)(x)) << QuadSPI_IPCR_ARB_UNLOCK_SHIFT)) & QuadSPI_IPCR_ARB_UNLOCK_MASK)
...
#define QuadSPI_TGIPCRS_ARB_LOCK_MASK            (0x200000U)
#define QuadSPI_TGIPCRS_ARB_LOCK_SHIFT           (21U)
#define QuadSPI_TGIPCRS_ARB_LOCK_WIDTH           (1U)
#define QuadSPI_TGIPCRS_ARB_LOCK(x)              (((uint32_t)(((uint32_t)(x)) << QuadSPI_TGIPCRS_ARB_LOCK_SHIFT)) & QuadSPI_TGIPCRS_ARB_LOCK_MASK)

#define QuadSPI_TGIPCRS_ARB_UNLOCK_MASK          (0x400000U)
#define QuadSPI_TGIPCRS_ARB_UNLOCK_SHIFT         (22U)
#define QuadSPI_TGIPCRS_ARB_UNLOCK_WIDTH         (1U)
#define QuadSPI_TGIPCRS_ARB_UNLOCK(x)            (((uint32_t)(((uint32_t)(x)) << QuadSPI_TGIPCRS_ARB_UNLOCK_SHIFT)) & QuadSPI_TGIPCRS_ARB_UNLOCK_MASK)
...
#define QuadSPI_FLSEQREQ_ARB_LOCK_MASK           (0x400U)
#define QuadSPI_FLSEQREQ_ARB_LOCK_SHIFT          (10U)
#define QuadSPI_FLSEQREQ_ARB_LOCK_WIDTH          (1U)
#define QuadSPI_FLSEQREQ_ARB_LOCK(x)             (((uint32_t)(((uint32_t)(x)) << QuadSPI_FLSEQREQ_ARB_LOCK_SHIFT)) & QuadSPI_FLSEQREQ_ARB_LOCK_MASK)
...
#define QuadSPI_FSMSTAT_ARB_LOCK_MASK            (0x20000U)
#define QuadSPI_FSMSTAT_ARB_LOCK_SHIFT           (17U)
#define QuadSPI_FSMSTAT_ARB_LOCK_WIDTH           (1U)
#define QuadSPI_FSMSTAT_ARB_LOCK(x)              (((uint32_t)(((uint32_t)(x)) << QuadSPI_FSMSTAT_ARB_LOCK_SHIFT)) & QuadSPI_FSMSTAT_ARB_LOCK_MASK)
...
#endif  /* #if !defined(S32K358_QuadSPI_H_) */
