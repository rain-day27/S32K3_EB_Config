...
/*!
 * @file S32K358_QuadSPI_ARDB.h
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_QuadSPI_ARDB
 *
...
#if !defined(S32K358_QuadSPI_ARDB_H_)  /* Check if memory map has not been already included */
#define S32K358_QuadSPI_ARDB_H_
...
#endif  /* #if !defined(S32K358_QuadSPI_ARDB_H_) */
