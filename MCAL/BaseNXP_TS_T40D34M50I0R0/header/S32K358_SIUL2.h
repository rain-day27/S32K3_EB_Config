...
/*!
 * @file S32K358_SIUL2.h
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_SIUL2
 *
...
#if !defined(S32K358_SIUL2_H_)  /* Check if memory map has not been already included */
#define S32K358_SIUL2_H_
...
typedef struct {
  ...
  __IO uint32_t MSCR[SIUL2_MSCR_COUNT];            /**< SIUL2 Multiplexed Signal Configuration Register, array offset: 0x240, array step: 0x4, valid indices: [0-37, 40-236] */
  uint8_t RESERVED_11[1100];
  __IO uint32_t IMCR[SIUL2_IMCR_COUNT];            /**< SIUL2 Input Multiplexed Signal Configuration, array offset: 0xA40, array step: 0x4, valid indices: [0-5, 16-71, 80-103, 112-135, 144-149, 152-202, 211-268, 289-309, 315-325, 343-378, 389, 398-399, 409-434, 437, 440] */
  uint8_t RESERVED_12[476];
...
#endif  /* #if !defined(S32K358_SIUL2_H_) */
