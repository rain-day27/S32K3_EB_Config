 ...
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_STCU
 *
...
#if !defined(S32K358_STCU_H_)  /* Check if memory map has not been already included */
#define S32K358_STCU_H_
...
typedef struct {
  ...
  struct STCU_LB {                                 /* offset: 0x200, array step: 0x30 */
...
#endif  /* #if !defined(S32K358_STCU_H_) */
