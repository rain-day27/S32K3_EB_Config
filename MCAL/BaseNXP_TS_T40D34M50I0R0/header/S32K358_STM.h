 ...
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_STM
 *
...
#if !defined(S32K358_STM_H_)  /* Check if memory map has not been already included */
#define S32K358_STM_H_
...
#define IP_STM_BASE_ADDRS                        { IP_STM_0_BASE, IP_STM_1_BASE, IP_STM_2_BASE }
/** Array initializer of STM peripheral base pointers */
#define IP_STM_BASE_PTRS                         { IP_STM_0, IP_STM_1, IP_STM_2 }
...
#endif  /* #if !defined(S32K358_STM_H_) */
