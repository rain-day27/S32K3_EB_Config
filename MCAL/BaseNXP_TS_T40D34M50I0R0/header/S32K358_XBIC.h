 ...
 * @version 1.2
 * @date 2024-02-12
 * @brief Peripheral Access Layer for S32K358_XBIC
 *
...
#if !defined(S32K358_XBIC_H_)  /* Check if memory map has not been already included */
#define S32K358_XBIC_H_
...
#define IP_XBIC_BASE_ADDRS                       { IP_XBIC_AXBS_BASE, IP_XBIC_AXBS_EDMA_BASE, IP_XBIC_AXBS_PERI_BASE, IP_XBIC_AXBS_PRAM_TCM_BASE }
/** Array initializer of XBIC peripheral base pointers */
#define IP_XBIC_BASE_PTRS                        { IP_XBIC_AXBS, IP_XBIC_AXBS_EDMA, IP_XBIC_AXBS_PERI, IP_XBIC_AXBS_PRAM_TCM }
...
#endif  /* #if !defined(S32K358_XBIC_H_) */
