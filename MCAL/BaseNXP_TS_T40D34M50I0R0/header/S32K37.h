...
**                                 9)ETPU module is removed.           
**                                                          
** -1.8 Suman Rani 11-Apr-23       1)Initial release based
**                                 on RM Rev.2 Draft B.
**                                 2)DCM_GPR-
**                                 -Register DCMROD5
**                                  -TEST_ACTIVATION_3_ERR bit field is removed.
**                                 -Register DCMROD6 
**                                  -ETPU_GLEX_ERR bit field is removed.
**                                 -Register DCMROF1
**                                  -EMAC_MDC_CHID_0 bit field is replaced 
**                                  with MAC_MDC_CHID_0.
**                                  -EMAC_MDC_CHID_1 bit field is replaced
**                                  with MAC_MDC_CHID_1.
**                                 -Register DCMRWP1
...
**                                  ETPU_DBG_DIS_CM7_0,SWG0_DBG_DIS_CM7_0 and
**                                  SWG1_DBG_DIS_CM7_0.
**                                 -Register DCMRWD9
**                                  -Following bitfields are removed:
**                                  ETPU_DBG_DIS_CM7_1,SWG0_DBG_DIS_CM7_1 and
**                                  SWG1_DBG_DIS_CM7_1. 
**                                 -Register DCMRWD13
**                                  -Following bitfields are removed:
**                                  ETPU_DBG_DIS_CM7_2,
...
**                                  SWG1_DBG_DIS_CM7_2.
**                                 -Register DCMRWD14
**                                  -ETPU_GLEX_ERR_EN bit field
**                                  is removed.
**                                 -Register DCMRWF2
**                                  -PMC_TRIM_RGM_DCF__BYP_STDBY_EXT
**                                  bit field is replaced with
**                                  PMC_TRIM_RGM_DCF_BYP_STDBY_EXT.
**                                 3)DIGRF_TOP-
**                                 -SLCR register is removed.
**                                 4)FLEXPWM-
**                                 -SM prefix is removed from the
**                                 registers within SM array.
**                                 -Register array FAULT is removed and
**                                 replaced with FP_CTRL,FP_STS,FP_FILT,
**                                 FP_TST and FP_CTRL2 registers array.
**                                 -Register FAULT_FCTRL is replaced
**                                 with FP_CTRL.
**                                 -Register FAULT_FSTS is replaced
**                                 with FP_STS.
**                                 -Register FAULT_FFILT is replaced
**                                 with FP_FILT.
**                                 -Register FAULT_FTST is replaced
**                                 with FP_TST.
**                                 -Register FAULT_FCTRL2 is replaced
**                                 with FP_CTRL2.
**                                 -Register SM0BIST_CTRL is replaced
**                                 with SM0_BIST_CTRL.
**                                 -Register SM0BIST_CTRL1 is replaced 
**                                 with SM0_BIST_CTRL1.
**                                 -Register SM1BIST_CTRL is replaced
**                                 with SM1_BIST_CTRL.
**                                 -Register SM1BIST_CTRL1 is replaced
**                                 with SM1_BIST_CTRL1.
**                                 -Register SM2BIST_CTRL is replaced
**                                 with SM2_BIST_CTRL.
**                                 -Register SM2BIST_CTRL1 is replaced
**                                 with SM2_BIST_CTRL1.
**                                 -Register SM3BIST_CTRL is replaced
**                                 with SM3_BIST_CTRL.
**                                 -Register SM3BIST_CTRL1 is replaced
**                                 with SM3_BIST_CTRL1.
**                                 -Register SM0BIST_STATUS is replaced 
**                                 with SM0_BIST_STATUS.
**                                 -Register SM0BIST_STATUS1 is replaced
**                                 with SM0_BIST_STATUS1.
**                                 -Register SM1BIST_STATUS is replaced
**                                 with SM1_BIST_STATUS.
**                                 -Register SM1BIST_STATUS1 is replaced
**                                 with SM1_BIST_STATUS1.
**                                 -Register SM2BIST_STATUS is replaced 
**                                 with SM2_BIST_STATUS.
**                                 -Register SM2BIST_STATUS1 is replaced
**                                 with SM2_BIST_STATUS1.
**                                 -Register SM3BIST_STATUS is replaced
**                                 with SM3_BIST_STATUS.
**                                 -Register SM3BIST_STATUS1 is replaced
**                                 with SM3_BIST_STATUS1.
**                                 5)LPCMP-                               
**                                 -Register CCR0                         
**                                  -LINKEN bit field is removed.         
**                                 -Register DCR                          
**                                  -DAC_HPMD bit field is added.
**                                 6)MC_RGM-
**                                 -Registers FRENTC and LPDEBUG
**                                 are removed. 
**                                 7)MDM_AP-                                             
**                                 -Registers MDMAPETPUCTRLEN and         
**                                 MDMAPETPUSTTSEN are removed.
**                                 -Register MDMAPCTL                     
**                                  -Following bitfields are added:       
**                                  CM7_0_CORE_ACCESS,CM7_1_CORE_ACCESS,
**                                  CM7_2_CORE_ACCESS and CM7_2_CHK_CORE_ACCESS.
**                                 8)MSCM-
**                                 -Registers IAHBCFGREG and IAHBCFGREG1
**                                 are removed.
**                                 9)TRGMUX_APP-
**                                 -Following Registers are removed:
**                                  -ETPU_A_INPUT,ETPU_AB_INPUT,
**                                  ETPU_B_INPUT,ETPU1_ODIS and
**                                  ETPU2_ODIS.
**
...
**
** -2.0 Jalaj Awasthi 28-Mar-24    1)Initial release based               
**                                 on RM Rev 3.                          
**                                 2)CONFIGURATION_GPR-                  
...
**                                 8)LBIST and MBIST IRQ(interrupts) are removed.
**
** ############################################################################################
*/
 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37
 *
...
#if !defined(S32K37_H_)  /* Check if memory map has not been already included */
#define S32K37_H_
...
#include "S32K37_ADC.h"
#include "S32K37_ADC_BIST.h"
#include "S32K37_ADC_BIST_FIR.h"
#include "S32K37_AXBS_LITE.h"
#include "S32K37_BCTU.h"
#include "S32K37_CMU_FC.h"
#include "S32K37_CMU_FM.h"
#include "S32K37_CONFIGURATION_GPR.h"
#include "S32K37_CRC.h"
#include "S32K37_DCM.h"
#include "S32K37_DCM_GPR.h"
#include "S32K37_DIGRF_TOP.h"
#include "S32K37_DMA.h"
#include "S32K37_DMAMUX.h"
#include "S32K37_DSPI_MSC.h"
#include "S32K37_DSPSS.h"
#include "S32K37_D_IP_SWG_SYN.h"
#include "S32K37_EIM.h"
#include "S32K37_EIM_1.h"
#include "S32K37_EIM_2.h"
#include "S32K37_EMAC.h"
#include "S32K37_EMIOS.h"
#include "S32K37_ERM.h"
#include "S32K37_FCCU.h"
#include "S32K37_FIRC.h"
#include "S32K37_FLASH.h"
#include "S32K37_FLEXCAN.h"
#include "S32K37_FLEXIO.h"
#include "S32K37_FLEXPWM.h"
#include "S32K37_FXOSC.h"
#include "S32K37_IGF.h"
#include "S32K37_INTM.h"
#include "S32K37_JDC.h"
#include "S32K37_LCU.h"
#include "S32K37_LPCMP.h"
#include "S32K37_LPI2C.h"
#include "S32K37_LPSPI.h"
#include "S32K37_LPUART.h"
#include "S32K37_MCM_CM7.h"
#include "S32K37_MC_CGM.h"
#include "S32K37_MC_ME.h"
#include "S32K37_MC_RGM.h"
#include "S32K37_MDM_AP.h"
#include "S32K37_MSCM.h"
#include "S32K37_MU.h"
#include "S32K37_OMU_CM7.h"
#include "S32K37_PFLASH.h"
#include "S32K37_PIT.h"
#include "S32K37_PLL.h"
#include "S32K37_PMC.h"
#include "S32K37_PRAMC.h"
#include "S32K37_QUADSPI.h"
#include "S32K37_QUADSPI_ARDB.h"
#include "S32K37_RTC.h"
#include "S32K37_SDADC.h"
#include "S32K37_SDA_AP.h"
#include "S32K37_SELFTEST_GPR.h"
#include "S32K37_SEMA42.h"
#include "S32K37_SIPI1.h"
#include "S32K37_SIRC.h"
#include "S32K37_SIUL2.h"
#include "S32K37_STCU.h"
#include "S32K37_STM.h"
#include "S32K37_SWT.h"
#include "S32K37_TCD_0.h"
#include "S32K37_TCD_1.h"
#include "S32K37_TEMPSENSE.h"
#include "S32K37_TRGMUX_APP.h"
#include "S32K37_TRGMUX_MSC.h"
#include "S32K37_VIRT_WRAPPER.h"
#include "S32K37_WKPU.h"
#include "S32K37_XBIC.h"
#include "S32K37_XRDC.h"
#include "S32K37_NVIC.h"
#include "S32K37_SCB.h"
#include "S32K37_SYSTICK.h"
#include "S32K37_MPU.h"

#endif  /* #if !defined(S32K37_H_) */
