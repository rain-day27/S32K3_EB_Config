 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_BCTU
 *
...
#if !defined(S32K37_BCTU_H_)  /* Check if memory map has not been already included */
#define S32K37_BCTU_H_
...
#define BCTU_TRGCFG_COUNT                         45u
#define BCTU_ADCDR_COUNT                          4u
...
typedef struct {
  ...
  __I  uint32_t ADCDR[BCTU_ADCDR_COUNT];           /**< ADC0 Result Data..ADC3 Result Data, array offset: 0x23C, array step: 0x4, irregular array, not all indices are valid */
  ...
  __I  uint32_t FIFO3DR;                           /**< FIFO Result Data, offset: 0x458 */
...
/** Peripheral BCTU_1 base address */
#define IP_BCTU_1_BASE                           (0x406C4000u)
/** Peripheral BCTU_1 base pointer */
#define IP_BCTU_1                                ((BCTU_Type *)IP_BCTU_1_BASE)
/** Array initializer of BCTU peripheral base addresses */
#define IP_BCTU_BASE_ADDRS                       { IP_BCTU_BASE, IP_BCTU_1_BASE }
/** Array initializer of BCTU peripheral base pointers */
#define IP_BCTU_BASE_PTRS                        { IP_BCTU, IP_BCTU_1 }
...
#define BCTU_MCR_IEN3_MASK                       (0x8U)
#define BCTU_MCR_IEN3_SHIFT                      (3U)
#define BCTU_MCR_IEN3_WIDTH                      (1U)
#define BCTU_MCR_IEN3(x)                         (((uint32_t)(((uint32_t)(x)) << BCTU_MCR_IEN3_SHIFT)) & BCTU_MCR_IEN3_MASK)
...
#define BCTU_MCR_DMA3_MASK                       (0x80000U)
#define BCTU_MCR_DMA3_SHIFT                      (19U)
#define BCTU_MCR_DMA3_WIDTH                      (1U)
#define BCTU_MCR_DMA3(x)                         (((uint32_t)(((uint32_t)(x)) << BCTU_MCR_DMA3_SHIFT)) & BCTU_MCR_DMA3_MASK)
...
#define BCTU_MSR_NDATA3_MASK                     (0x8U)
#define BCTU_MSR_NDATA3_SHIFT                    (3U)
#define BCTU_MSR_NDATA3_WIDTH                    (1U)
#define BCTU_MSR_NDATA3(x)                       (((uint32_t)(((uint32_t)(x)) << BCTU_MSR_NDATA3_SHIFT)) & BCTU_MSR_NDATA3_MASK)
...
#define BCTU_MSR_DATAOVR3_MASK                   (0x80U)
#define BCTU_MSR_DATAOVR3_SHIFT                  (7U)
#define BCTU_MSR_DATAOVR3_WIDTH                  (1U)
#define BCTU_MSR_DATAOVR3(x)                     (((uint32_t)(((uint32_t)(x)) << BCTU_MSR_DATAOVR3_SHIFT)) & BCTU_MSR_DATAOVR3_MASK)
...
#define BCTU_MSR_LIST3_Last_MASK                 (0x800U)
#define BCTU_MSR_LIST3_Last_SHIFT                (11U)
#define BCTU_MSR_LIST3_Last_WIDTH                (1U)
#define BCTU_MSR_LIST3_Last(x)                   (((uint32_t)(((uint32_t)(x)) << BCTU_MSR_LIST3_Last_SHIFT)) & BCTU_MSR_LIST3_Last_MASK)
...
#define BCTU_MSR_NDATA3_CLR_MASK                 (0x80000U)
#define BCTU_MSR_NDATA3_CLR_SHIFT                (19U)
#define BCTU_MSR_NDATA3_CLR_WIDTH                (1U)
#define BCTU_MSR_NDATA3_CLR(x)                   (((uint32_t)(((uint32_t)(x)) << BCTU_MSR_NDATA3_CLR_SHIFT)) & BCTU_MSR_NDATA3_CLR_MASK)
...
#define BCTU_MSR_DATAOVR3_CLR_MASK               (0x800000U)
#define BCTU_MSR_DATAOVR3_CLR_SHIFT              (23U)
#define BCTU_MSR_DATAOVR3_CLR_WIDTH              (1U)
#define BCTU_MSR_DATAOVR3_CLR(x)                 (((uint32_t)(((uint32_t)(x)) << BCTU_MSR_DATAOVR3_CLR_SHIFT)) & BCTU_MSR_DATAOVR3_CLR_MASK)
...
#define BCTU_MSR_LIST3_Last_CLR_MASK             (0x8000000U)
#define BCTU_MSR_LIST3_Last_CLR_SHIFT            (27U)
#define BCTU_MSR_LIST3_Last_CLR_WIDTH            (1U)
#define BCTU_MSR_LIST3_Last_CLR(x)               (((uint32_t)(((uint32_t)(x)) << BCTU_MSR_LIST3_Last_CLR_SHIFT)) & BCTU_MSR_LIST3_Last_CLR_MASK)
...
#define BCTU_TRGCFG_ADC_SEL3_MASK                (0x800U)
#define BCTU_TRGCFG_ADC_SEL3_SHIFT               (11U)
#define BCTU_TRGCFG_ADC_SEL3_WIDTH               (1U)
#define BCTU_TRGCFG_ADC_SEL3(x)                  (((uint32_t)(((uint32_t)(x)) << BCTU_TRGCFG_ADC_SEL3_SHIFT)) & BCTU_TRGCFG_ADC_SEL3_MASK)
...
/*! @name ADCDR - ADC0 Result Data..ADC3 Result Data */
/*! @{ */
...
/*! @name FIFO3DR - FIFO Result Data */
/*! @{ */

#define BCTU_FIFO3DR_ADC_DATA_MASK               (0x7FFFU)
#define BCTU_FIFO3DR_ADC_DATA_SHIFT              (0U)
#define BCTU_FIFO3DR_ADC_DATA_WIDTH              (15U)
#define BCTU_FIFO3DR_ADC_DATA(x)                 (((uint32_t)(((uint32_t)(x)) << BCTU_FIFO3DR_ADC_DATA_SHIFT)) & BCTU_FIFO3DR_ADC_DATA_MASK)

#define BCTU_FIFO3DR_ADC_NUM_MASK                (0x30000U)
#define BCTU_FIFO3DR_ADC_NUM_SHIFT               (16U)
#define BCTU_FIFO3DR_ADC_NUM_WIDTH               (2U)
#define BCTU_FIFO3DR_ADC_NUM(x)                  (((uint32_t)(((uint32_t)(x)) << BCTU_FIFO3DR_ADC_NUM_SHIFT)) & BCTU_FIFO3DR_ADC_NUM_MASK)

#define BCTU_FIFO3DR_CH_MASK                     (0x1FC0000U)
#define BCTU_FIFO3DR_CH_SHIFT                    (18U)
#define BCTU_FIFO3DR_CH_WIDTH                    (7U)
#define BCTU_FIFO3DR_CH(x)                       (((uint32_t)(((uint32_t)(x)) << BCTU_FIFO3DR_CH_SHIFT)) & BCTU_FIFO3DR_CH_MASK)

#define BCTU_FIFO3DR_TRG_SRC_MASK                (0xFE000000U)
#define BCTU_FIFO3DR_TRG_SRC_SHIFT               (25U)
#define BCTU_FIFO3DR_TRG_SRC_WIDTH               (7U)
#define BCTU_FIFO3DR_TRG_SRC(x)                  (((uint32_t)(((uint32_t)(x)) << BCTU_FIFO3DR_TRG_SRC_SHIFT)) & BCTU_FIFO3DR_TRG_SRC_MASK)
/*! @} */
...
#define BCTU_FIFOCR_IEN_FIFO3_MASK               (0x40000U)
#define BCTU_FIFOCR_IEN_FIFO3_SHIFT              (18U)
#define BCTU_FIFOCR_IEN_FIFO3_WIDTH              (1U)
#define BCTU_FIFOCR_IEN_FIFO3(x)                 (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOCR_IEN_FIFO3_SHIFT)) & BCTU_FIFOCR_IEN_FIFO3_MASK)
...
#define BCTU_FIFOCR_DMA_EN_FIFO3_MASK            (0x4000000U)
#define BCTU_FIFOCR_DMA_EN_FIFO3_SHIFT           (26U)
#define BCTU_FIFOCR_DMA_EN_FIFO3_WIDTH           (1U)
#define BCTU_FIFOCR_DMA_EN_FIFO3(x)              (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOCR_DMA_EN_FIFO3_SHIFT)) & BCTU_FIFOCR_DMA_EN_FIFO3_MASK)
/*! @} */
...
#define BCTU_FIFOWM_WM_FIFO3_MASK                (0x70000U)
#define BCTU_FIFOWM_WM_FIFO3_SHIFT               (16U)
#define BCTU_FIFOWM_WM_FIFO3_WIDTH               (3U)
#define BCTU_FIFOWM_WM_FIFO3(x)                  (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOWM_WM_FIFO3_SHIFT)) & BCTU_FIFOWM_WM_FIFO3_MASK)
/*! @} */
...
#define BCTU_FIFOERR_WM_INT_FIFO3_MASK           (0x40000U)
#define BCTU_FIFOERR_WM_INT_FIFO3_SHIFT          (18U)
#define BCTU_FIFOERR_WM_INT_FIFO3_WIDTH          (1U)
#define BCTU_FIFOERR_WM_INT_FIFO3(x)             (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOERR_WM_INT_FIFO3_SHIFT)) & BCTU_FIFOERR_WM_INT_FIFO3_MASK)
...
#define BCTU_FIFOERR_OVR_ERR_FIFO3_MASK          (0x10000000U)
#define BCTU_FIFOERR_OVR_ERR_FIFO3_SHIFT         (28U)
#define BCTU_FIFOERR_OVR_ERR_FIFO3_WIDTH         (1U)
#define BCTU_FIFOERR_OVR_ERR_FIFO3(x)            (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOERR_OVR_ERR_FIFO3_SHIFT)) & BCTU_FIFOERR_OVR_ERR_FIFO3_MASK)

#define BCTU_FIFOERR_UNDR_ERR_FIFO3_MASK         (0x20000000U)
#define BCTU_FIFOERR_UNDR_ERR_FIFO3_SHIFT        (29U)
#define BCTU_FIFOERR_UNDR_ERR_FIFO3_WIDTH        (1U)
#define BCTU_FIFOERR_UNDR_ERR_FIFO3(x)           (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOERR_UNDR_ERR_FIFO3_SHIFT)) & BCTU_FIFOERR_UNDR_ERR_FIFO3_MASK)
/*! @} */
...
#define BCTU_FIFOSR_FULL_FIFO3_MASK              (0x4U)
#define BCTU_FIFOSR_FULL_FIFO3_SHIFT             (2U)
#define BCTU_FIFOSR_FULL_FIFO3_WIDTH             (1U)
#define BCTU_FIFOSR_FULL_FIFO3(x)                (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOSR_FULL_FIFO3_SHIFT)) & BCTU_FIFOSR_FULL_FIFO3_MASK)
/*! @} */
...
#define BCTU_FIFOCNTR_CNTR_FIFO3_MASK            (0xF0000U)
#define BCTU_FIFOCNTR_CNTR_FIFO3_SHIFT           (16U)
#define BCTU_FIFOCNTR_CNTR_FIFO3_WIDTH           (4U)
#define BCTU_FIFOCNTR_CNTR_FIFO3(x)              (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOCNTR_CNTR_FIFO3_SHIFT)) & BCTU_FIFOCNTR_CNTR_FIFO3_MASK)
/*! @} */
...
#endif  /* #if !defined(S32K37_BCTU_H_) */
