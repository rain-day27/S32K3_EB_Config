 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_CRC
 *
...
#if !defined(S32K37_CRC_H_)  /* Check if memory map has not been already included */
#define S32K37_CRC_H_
...
#endif  /* #if !defined(S32K37_CRC_H_) */
