...
/*!
 * @file S32K37_DIGRF_TOP.h
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_DIGRF_TOP
 *
...
#if !defined(S32K37_DIGRF_TOP_H_)  /* Check if memory map has not been already included */
#define S32K37_DIGRF_TOP_H_
...
typedef struct {
  ...
  __IO uint32_t LCR;                               /**< LFAST LVDS Control, offset: 0x40 */
  ...
  __I  uint32_t UNSRDR[DIGRF_TOP_UNSRDR_COUNT];    /**< LFAST Unsolicited Rx Data, array offset: 0xAC, array step: 0x4 */
...
#define DIGRF_TOP_GPR_LFAST_TX_OBE_EN_MASK       (0x200000U)
#define DIGRF_TOP_GPR_LFAST_TX_OBE_EN_SHIFT      (21U)
#define DIGRF_TOP_GPR_LFAST_TX_OBE_EN_WIDTH      (1U)
#define DIGRF_TOP_GPR_LFAST_TX_OBE_EN(x)         (((uint32_t)(((uint32_t)(x)) << DIGRF_TOP_GPR_LFAST_TX_OBE_EN_SHIFT)) & DIGRF_TOP_GPR_LFAST_TX_OBE_EN_MASK)
/*! @} */
...
#endif  /* #if !defined(S32K37_DIGRF_TOP_H_) */
