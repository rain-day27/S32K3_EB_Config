...
/*!
 * @file S32K37_DSPI_MSC.h
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_DSPI
 *
...
#if !defined(S32K37_DSPI_H_)  /* Check if memory map has not been already included */
#define S32K37_DSPI_H_
...
/** Peripheral DSPI base address */
#define IP_DSPI_BASE                         (0x40508000u)
/** Peripheral DSPI base pointer */
#define IP_DSPI                              ((DSPI_Type *)IP_DSPI_BASE)
/** Array initializer of DSPI peripheral base addresses */
#define IP_DSPI_BASE_ADDRS                   { IP_DSPI_BASE }
/** Array initializer of DSPI peripheral base pointers */
#define IP_DSPI_BASE_PTRS                    { IP_DSPI }
...
#endif  /* #if !defined(S32K37_DSPI_H_) */
