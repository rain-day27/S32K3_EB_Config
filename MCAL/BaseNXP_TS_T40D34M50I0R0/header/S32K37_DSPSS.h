 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_DSPSS
 *
...
#if !defined(S32K37_DSPSS_H_)  /* Check if memory map has not been already included */
#define S32K37_DSPSS_H_
...
typedef struct {
  __IO uint32_t DSPSS_SCHEDULER_XMEM_ADDR_TH0;     /**< Thread Start And End Address Location Configuration, offset: 0x0, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_SCHEDULER_XMEM_TH0;          /**< Thread Threshold And Enable, offset: 0x4, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_SCHEDULER_DSP_CFG_TH0;       /**< PC Initial Value, offset: 0x8, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  ...
  __IO uint32_t THREAD_SUSPEND_REQ0;               /**< Thread Suspend Request For Thread Disabling/PCINIT Change, offset: 0x54, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  ...
  __IO uint32_t DSPSS_SCHEDULER_XMEM_ADDR_TH1;     /**< Thread Start And End Address Location Configuration, offset: 0x300, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_SCHEDULER_XMEM_TH1;          /**< Thread Threshold And Enable, offset: 0x304, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_SCHEDULER_DSP_CFG_TH1;       /**< PC Initial Value, offset: 0x308, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  ...
  __IO uint32_t THREAD_SUSPEND_REQ1;               /**< Thread Suspend Request For Thread Disabling/PCINIT Change, offset: 0x354, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  ...
  __IO uint32_t DSPSS_SCHEDULER_XMEM_ADDR_TH2;     /**< Thread Start And End Address Location Configuration, offset: 0x600, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_SCHEDULER_XMEM_TH2;          /**< Thread Threshold And Enable, offset: 0x604, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_SCHEDULER_DSP_CFG_TH2;       /**< PC Initial Value, offset: 0x608, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  ...
  __IO uint32_t THREAD_SUSPEND_REQ2;               /**< Thread Suspend Request For Thread Disabling/PCINIT Change, offset: 0x654, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  ...
  __IO uint32_t DSPSS_SCHEDULER_XMEM_ADDR_TH3;     /**< Thread Start And End Address Location Configuration, offset: 0x900, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_SCHEDULER_XMEM_TH3;          /**< Thread Threshold And Enable, offset: 0x904, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_SCHEDULER_DSP_CFG_TH3;       /**< PC Initial Value, offset: 0x908, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  ...
  __IO uint32_t THREAD_SUSPEND_REQ3;               /**< Thread Suspend Request For Thread Disabling/PCINIT Change, offset: 0x954, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  ...
  __IO uint32_t DSPSS_SOFT_RESET_REGISTER;         /**< DSPSS Soft Reset, offset: 0xBE4, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSP_ACK_TIMEOUT_CFG_AND_ERR_CTRL;  /**< DSP ACK Timeout Configuration And Error Control, offset: 0xBE8, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t ECC_ERROR_MONITOR_THREAD_SUSPEND_CTRL; /**< Disable Monitoring of ECC Errors In XMEM And PMEM, offset: 0xBEC, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t INTERRUPT_ENABLE_REGISTER2;        /**< Interrupt Enable, offset: 0xBF0, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t SDADC_SYNC_FIFO_ERROR_STATUS;      /**< FIFO Overflow Status, offset: 0xBF4, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  uint8_t RESERVED_36[4];
  __IO uint32_t DSP_CORE_BUFFER_CFG;               /**< Configuration For DSP-Core Buffer, offset: 0xBFC, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DMA_BUFFER_CFG;                    /**< DMA Buffer Configuration, offset: 0xC00, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t SCHEDULER_MODE_CFG;                /**< Thread Scheduling Mode Selection, offset: 0xC04, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_DSP0_CFG;                    /**< DSP0 Reset And Core Trigger Configuration, offset: 0xC08, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  uint8_t RESERVED_37[4];
  __IO uint32_t INTERRUPT_ENABLE_REGISTER;         /**< Interrupt Enable, offset: 0xC10, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  __IO uint32_t DSPSS_DSP_IO_INTF0;                /**< DSP Trigger to Core, offset: 0xC14 */
  uint8_t RESERVED_38[4];
  __IO uint32_t CURR_ACTIVE_THRD;                  /**< DSP Core Status, offset: 0xC1C, available only on: dspss_0/DSPSS_0 (missing on dspss_1/DSPSS_1) */
  uint8_t RESERVED_39[4];
  __IO uint32_t DSPSS_DSP_CORE_TRIGGER_SAFETY;     /**< >DSP Safety Trigger to Core, offset: 0xC24 */
  ...
  __I  uint32_t DSPSS_DSP_THREAD_INFO[DSPSS_DSPSS_DSP_THREAD_INFO_COUNT]; /**< Thread Status Info 0..Thread Status Info 3, array offset: 0x1200, array step: 0x4, available only on: dspss_1/DSPSS_1 (missing on dspss_0/DSPSS_0) */
...
/*! @name DSPSS_DSP_CORE_TRIGGER_SAFETY - >DSP Safety Trigger to Core */
/*! @{ */
...
#endif  /* #if !defined(S32K37_DSPSS_H_) */
