 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_EMAC
 *
...
#if !defined(S32K37_EMAC_H_)  /* Check if memory map has not been already included */
#define S32K37_EMAC_H_
...
typedef struct {
  ...
  __I  uint32_t RX_RECEIVE_ERROR_PACKETS;          /**< Receive Error Packets, offset: 0x7E0 */
  ...
  __IO uint32_t MAC_PPS2_TARGET_TIME_SECONDS;      /**< MAC PPS2 Target Time In Seconds, offset: 0xBA0 */
  ...
  __I  uint32_t MTL_SAFETY_INTERRUPT_STATUS;       /**< MTL Safety Interrupt Status, offset: 0xCC4 */
  ...
  __I  uint32_t MTL_ECC_ERR_ADDR_STATUS;           /**< MTL ECC Error Address Status, offset: 0xCD4 */
  ...
  __IO uint32_t DMA_CH0_RXDESC_TAIL_POINTER;       /**< DMA Channel 0 Rx Descriptor List Pointer, offset: 0x1128 */
...
/*! @name RX_RECEIVE_ERROR_PACKETS - Receive Error Packets */
/*! @{ */
...
/*! @name MAC_PPS2_TARGET_TIME_SECONDS - MAC PPS2 Target Time In Seconds */
/*! @{ */
...
/*! @name MTL_SAFETY_INTERRUPT_STATUS - MTL Safety Interrupt Status */
/*! @{ */
...
/*! @name MTL_ECC_ERR_ADDR_STATUS - MTL ECC Error Address Status */
/*! @{ */
...
/*! @name DMA_CH0_RXDESC_TAIL_POINTER - DMA Channel 0 Rx Descriptor List Pointer */
/*! @{ */
...
#endif  /* #if !defined(S32K37_EMAC_H_) */
