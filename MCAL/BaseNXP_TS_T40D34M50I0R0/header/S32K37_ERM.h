 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_ERM
 *
...
#if !defined(S32K37_ERM_H_)  /* Check if memory map has not been already included */
#define S32K37_ERM_H_
...
typedef struct {
  ...
  __I  uint32_t EAR0;                              /**< ERM Memory 0 Error Address Register, offset: 0x100, available only on: ERM_0 (missing on ERM_1) */
  __I  uint32_t SYN0;                              /**< ERM Memory 0 Syndrome Register, offset: 0x104, available only on: ERM_0 (missing on ERM_1) */
  __IO uint32_t CORR_ERR_CNT0;                     /**< ERM Memory 0 Correctable Error Count Register, offset: 0x108, available only on: ERM_0 (missing on ERM_1) */
  uint8_t RESERVED_2[4];
  __I  uint32_t EAR1;                              /**< ERM Memory 1 Error Address Register, offset: 0x110, available only on: ERM_0 (missing on ERM_1) */
  __I  uint32_t SYN1;                              /**< ERM Memory 1 Syndrome Register, offset: 0x114, available only on: ERM_0 (missing on ERM_1) */
  __IO uint32_t CORR_ERR_CNT1;                     /**< ERM Memory 1 Correctable Error Count Register, offset: 0x118, available only on: ERM_0 (missing on ERM_1) */
  ...
  __IO uint32_t CORR_ERR_CNT6;                     /**< ERM Memory 6 Correctable Error Count Register, offset: 0x168, available only on: ERM_0 (missing on ERM_1) */
  uint8_t RESERVED_8[12];
  __IO uint32_t CORR_ERR_CNT7;                     /**< ERM Memory 7 Correctable Error Count Register, offset: 0x178, available only on: ERM_0 (missing on ERM_1) */
  uint8_t RESERVED_9[12];
  __IO uint32_t CORR_ERR_CNT8;                     /**< ERM Memory 8 Correctable Error Count Register, offset: 0x188, available only on: ERM_0 (missing on ERM_1) */
  uint8_t RESERVED_10[12];
  __IO uint32_t CORR_ERR_CNT9;                     /**< ERM Memory 9 Correctable Error Count Register, offset: 0x198, available only on: ERM_0 (missing on ERM_1) */
  ...
  __I  uint32_t EAR13;                             /**< ERM Memory 13 Error Address Register, offset: 0x1D0, available only on: ERM_0 (missing on ERM_1) */
  __I  uint32_t SYN13;                             /**< ERM Memory 13 Syndrome Register, offset: 0x1D4, available only on: ERM_0 (missing on ERM_1) */
  __IO uint32_t CORR_ERR_CNT13;                    /**< ERM Memory 13 Correctable Error Count Register, offset: 0x1D8, available only on: ERM_0 (missing on ERM_1) */
  uint8_t RESERVED_15[4];
  __I  uint32_t EAR14;                             /**< ERM Memory 14 Error Address Register, offset: 0x1E0, available only on: ERM_0 (missing on ERM_1) */
  __I  uint32_t SYN14;                             /**< ERM Memory 14 Syndrome Register, offset: 0x1E4, available only on: ERM_0 (missing on ERM_1) */
  __IO uint32_t CORR_ERR_CNT14;                    /**< ERM Memory 14 Correctable Error Count Register, offset: 0x1E8, available only on: ERM_0 (missing on ERM_1) */
  uint8_t RESERVED_16[4];
  __I  uint32_t EAR15;                             /**< ERM Memory 15 Error Address Register, offset: 0x1F0, available only on: ERM_0 (missing on ERM_1) */
  __I  uint32_t SYN15;                             /**< ERM Memory 15 Syndrome Register, offset: 0x1F4, available only on: ERM_0 (missing on ERM_1) */
  __IO uint32_t CORR_ERR_CNT15;                    /**< ERM Memory 15 Correctable Error Count Register, offset: 0x1F8, available only on: ERM_0 (missing on ERM_1) */
  ...
  __I  uint32_t SYN18;                             /**< ERM Memory 18 Syndrome Register, offset: 0x224, available only on: ERM_1 (missing on ERM_0) */
  ...
  __I  uint32_t SYN19;                             /**< ERM Memory 19 Syndrome Register, offset: 0x234, available only on: ERM_1 (missing on ERM_0) */
  __IO uint32_t CORR_ERR_CNT19;                    /**< ERM Memory 19 Correctable Error Count Register, offset: 0x238 */
  uint8_t RESERVED_22[4];
  __I  uint32_t EAR20;                             /**< ERM Memory 20 Error Address Register, offset: 0x240, available only on: ERM_1 (missing on ERM_0) */
  __I  uint32_t SYN20;                             /**< ERM Memory 20 Syndrome Register, offset: 0x244, available only on: ERM_1 (missing on ERM_0) */
  __IO uint32_t CORR_ERR_CNT20;                    /**< ERM Memory 20 Correctable Error Count Register, offset: 0x248, available only on: ERM_1 (missing on ERM_0) */
  uint8_t RESERVED_23[4];
  __I  uint32_t EAR21;                             /**< ERM Memory 21 Error Address Register, offset: 0x250, available only on: ERM_1 (missing on ERM_0) */
  __I  uint32_t SYN21;                             /**< ERM Memory 21 Syndrome Register, offset: 0x254, available only on: ERM_1 (missing on ERM_0) */
  __IO uint32_t CORR_ERR_CNT21;                    /**< ERM Memory 21 Correctable Error Count Register, offset: 0x258, available only on: ERM_1 (missing on ERM_0) */
  uint8_t RESERVED_24[4];
  __I  uint32_t EAR22;                             /**< ERM Memory 22 Error Address Register, offset: 0x260, available only on: ERM_1 (missing on ERM_0) */
  __I  uint32_t SYN22;                             /**< ERM Memory 22 Syndrome Register, offset: 0x264, available only on: ERM_1 (missing on ERM_0) */
  __IO uint32_t CORR_ERR_CNT22;                    /**< ERM Memory 22 Correctable Error Count Register, offset: 0x268, available only on: ERM_1 (missing on ERM_0) */
  uint8_t RESERVED_25[4];
  __I  uint32_t EAR23;                             /**< ERM Memory 23 Error Address Register, offset: 0x270, available only on: ERM_1 (missing on ERM_0) */
  __I  uint32_t SYN23;                             /**< ERM Memory 23 Syndrome Register, offset: 0x274, available only on: ERM_1 (missing on ERM_0) */
  __IO uint32_t CORR_ERR_CNT23;                    /**< ERM Memory 23 Correctable Error Count Register, offset: 0x278, available only on: ERM_1 (missing on ERM_0) */
} ERM_Type, *ERM_MemMapPtr;

/** Number of instances of the ERM module. */
#define ERM_INSTANCE_COUNT                       (2u)

/* ERM - Peripheral instance base addresses */
/** Peripheral ERM_0 base address */
#define IP_ERM_0_BASE                            (0x4025C000u)
/** Peripheral ERM_0 base pointer */
#define IP_ERM_0                                 ((ERM_Type *)IP_ERM_0_BASE)
/** Peripheral ERM_1 base address */
#define IP_ERM_1_BASE                            (0x4000C000u)
/** Peripheral ERM_1 base pointer */
#define IP_ERM_1                                 ((ERM_Type *)IP_ERM_1_BASE)
/** Array initializer of ERM peripheral base addresses */
#define IP_ERM_BASE_ADDRS                        { IP_ERM_0_BASE, IP_ERM_1_BASE }
/** Array initializer of ERM peripheral base pointers */
#define IP_ERM_BASE_PTRS                         { IP_ERM_0, IP_ERM_1 }
...
#endif  /* #if !defined(S32K37_ERM_H_) */
