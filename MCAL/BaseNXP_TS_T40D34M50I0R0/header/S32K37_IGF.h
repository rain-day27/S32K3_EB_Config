 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_IGF
 *
...
#if !defined(S32K37_IGF_H_)  /* Check if memory map has not been already included */
#define S32K37_IGF_H_
...
typedef struct {
  struct IGF_MCR {                                 /* offset: 0x0, array step: 0x40 */
...
#define IGF_PRESR_FPRE_MASK                      (0x3FFU)
#define IGF_PRESR_FPRE_SHIFT                     (0U)
#define IGF_PRESR_FPRE_WIDTH                     (10U)
...
#endif  /* #if !defined(S32K37_IGF_H_) */
