 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_LPCMP
 *
...
#if !defined(S32K37_LPCMP_H_)  /* Check if memory map has not been already included */
#define S32K37_LPCMP_H_
...
#define LPCMP_DCR_DAC_HPMD_WIDTH                 (1U)
...
#endif  /* #if !defined(S32K37_LPCMP_H_) */
