...
/*!
 * @file S32K37_MDM_AP.h
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_MDM_AP
 *
...
#if !defined(S32K37_MDM_AP_H_)  /* Check if memory map has not been already included */
#define S32K37_MDM_AP_H_
...
#define MDM_AP_MDMAPCTL_CM7_2_CHK_CORE_ACCESS_MASK (0x80000U)
#define MDM_AP_MDMAPCTL_CM7_2_CHK_CORE_ACCESS_SHIFT (19U)
#define MDM_AP_MDMAPCTL_CM7_2_CHK_CORE_ACCESS_WIDTH (1U)
#define MDM_AP_MDMAPCTL_CM7_2_CHK_CORE_ACCESS(x) (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPCTL_CM7_2_CHK_CORE_ACCESS_SHIFT)) & MDM_AP_MDMAPCTL_CM7_2_CHK_CORE_ACCESS_MASK)
...
#endif  /* #if !defined(S32K37_MDM_AP_H_) */
