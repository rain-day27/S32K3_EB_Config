 ...
 * @version 1.9
 * @date 2023-08-29
 * @brief Peripheral Access Layer for S32K37_NVIC
 *
...
#if !defined(S32K37_NVIC_H_)  /* Check if memory map has not been already included */
#define S32K37_NVIC_H_
...
#endif  /* #if !defined(S32K37_NVIC_H_) */
