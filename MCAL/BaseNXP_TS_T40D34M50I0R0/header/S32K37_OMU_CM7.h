...
/*!
 * @file S32K37_OMU_CM7.h
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_OMU_CM7
 *
...
#if !defined(S32K37_OMU_CM7_H_)  /* Check if memory map has not been already included */
#define S32K37_OMU_CM7_H_
...
typedef struct {
  struct OMU_CM7_ZONE_REGS {                       /* offset: 0x0, array step: 0x1000 */
  ...
  __IO uint32_t GZRR;                              /**< Global Zone Request, offset: 0x4012 */
  __IO uint32_t GZRUDR;                            /**< Global Zone Request Update Delay, offset: 0x4016 */
  uint8_t RESERVED_1[998];
  struct OMU_CM7_OVERLAY_REGION_DESCRIPTOR {       /* offset: 0x4400, array step: 0x10 */
...
/*! @name GZRUDR - Global Zone Request Update Delay */
/*! @{ */

#define OMU_CM7_GZRUDR_LDEL_MASK                 (0x1FU)
#define OMU_CM7_GZRUDR_LDEL_SHIFT                (0U)
#define OMU_CM7_GZRUDR_LDEL_WIDTH                (5U)
#define OMU_CM7_GZRUDR_LDEL(x)                   (((uint32_t)(((uint32_t)(x)) << OMU_CM7_GZRUDR_LDEL_SHIFT)) & OMU_CM7_GZRUDR_LDEL_MASK)

#define OMU_CM7_GZRUDR_RDEL_MASK                 (0x1F00U)
#define OMU_CM7_GZRUDR_RDEL_SHIFT                (8U)
#define OMU_CM7_GZRUDR_RDEL_WIDTH                (5U)
#define OMU_CM7_GZRUDR_RDEL(x)                   (((uint32_t)(((uint32_t)(x)) << OMU_CM7_GZRUDR_RDEL_SHIFT)) & OMU_CM7_GZRUDR_RDEL_MASK)
/*! @} */
...
#endif  /* #if !defined(S32K37_OMU_CM7_H_) */
