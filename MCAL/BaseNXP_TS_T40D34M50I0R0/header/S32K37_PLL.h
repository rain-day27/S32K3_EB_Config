 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_PLL
 *
...
#if !defined(S32K37_PLL_H_)  /* Check if memory map has not been already included */
#define S32K37_PLL_H_
...
#define PLL_PLLODIV_DIV_MASK                     (0xFF0000U)
...
#endif  /* #if !defined(S32K37_PLL_H_) */
