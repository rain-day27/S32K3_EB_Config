 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_PMC
 *
...
#if !defined(S32K37_PMC_H_)  /* Check if memory map has not been already included */
#define S32K37_PMC_H_
...
#define PMC_LVSC_LVDSF_MASK                      (0x80U)
#define PMC_LVSC_LVDSF_SHIFT                     (7U)
#define PMC_LVSC_LVDSF_WIDTH                     (1U)
#define PMC_LVSC_LVDSF(x)                        (((uint32_t)(((uint32_t)(x)) << PMC_LVSC_LVDSF_SHIFT)) & PMC_LVSC_LVDSF_MASK)
...
#define PMC_LVSC_LVDSS_MASK                      (0x8000U)
#define PMC_LVSC_LVDSS_SHIFT                     (15U)
#define PMC_LVSC_LVDSS_WIDTH                     (1U)
#define PMC_LVSC_LVDSS(x)                        (((uint32_t)(((uint32_t)(x)) << PMC_LVSC_LVDSS_SHIFT)) & PMC_LVSC_LVDSS_MASK)
...
#define PMC_LVSC_GNGSDADC0F_MASK                 (0x10000000U)
#define PMC_LVSC_GNGSDADC0F_SHIFT                (28U)
#define PMC_LVSC_GNGSDADC0F_WIDTH                (1U)
#define PMC_LVSC_GNGSDADC0F(x)                   (((uint32_t)(((uint32_t)(x)) << PMC_LVSC_GNGSDADC0F_SHIFT)) & PMC_LVSC_GNGSDADC0F_MASK)

#define PMC_LVSC_GNGSDADC1F_MASK                 (0x20000000U)
#define PMC_LVSC_GNGSDADC1F_SHIFT                (29U)
#define PMC_LVSC_GNGSDADC1F_WIDTH                (1U)
#define PMC_LVSC_GNGSDADC1F(x)                   (((uint32_t)(((uint32_t)(x)) << PMC_LVSC_GNGSDADC1F_SHIFT)) & PMC_LVSC_GNGSDADC1F_MASK)

#define PMC_LVSC_GNGSWGF_MASK                    (0x40000000U)
#define PMC_LVSC_GNGSWGF_SHIFT                   (30U)
#define PMC_LVSC_GNGSWGF_WIDTH                   (1U)
#define PMC_LVSC_GNGSWGF(x)                      (((uint32_t)(((uint32_t)(x)) << PMC_LVSC_GNGSWGF_SHIFT)) & PMC_LVSC_GNGSWGF_MASK)
...
#endif  /* #if !defined(S32K37_PMC_H_) */
