 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_SDADC
 *
...
#if !defined(S32K37_SDADC_H_)  /* Check if memory map has not been already included */
#define S32K37_SDADC_H_
...
typedef struct {
  ...
  __IO uint32_t CCR;                               /**< CIC Configuration Register, offset: 0x28 */
...
/*! @name CCR - CIC Configuration Register */
/*! @{ */

#define SDADC_CCR_OSR_HALF_MASK                  (0x100U)
#define SDADC_CCR_OSR_HALF_SHIFT                 (8U)
#define SDADC_CCR_OSR_HALF_WIDTH                 (1U)
#define SDADC_CCR_OSR_HALF(x)                    (((uint32_t)(((uint32_t)(x)) << SDADC_CCR_OSR_HALF_SHIFT)) & SDADC_CCR_OSR_HALF_MASK)

#define SDADC_CCR_EN_CLK_RATE_HALF_MASK          (0x400U)
#define SDADC_CCR_EN_CLK_RATE_HALF_SHIFT         (10U)
#define SDADC_CCR_EN_CLK_RATE_HALF_WIDTH         (1U)
#define SDADC_CCR_EN_CLK_RATE_HALF(x)            (((uint32_t)(((uint32_t)(x)) << SDADC_CCR_EN_CLK_RATE_HALF_SHIFT)) & SDADC_CCR_EN_CLK_RATE_HALF_MASK)

#define SDADC_CCR_CCR_B1_IPS_EN_MASK             (0x8000U)
#define SDADC_CCR_CCR_B1_IPS_EN_SHIFT            (15U)
#define SDADC_CCR_CCR_B1_IPS_EN_WIDTH            (1U)
#define SDADC_CCR_CCR_B1_IPS_EN(x)               (((uint32_t)(((uint32_t)(x)) << SDADC_CCR_CCR_B1_IPS_EN_SHIFT)) & SDADC_CCR_CCR_B1_IPS_EN_MASK)
/*! @} */
...
#endif  /* #if !defined(S32K37_SDADC_H_) */
