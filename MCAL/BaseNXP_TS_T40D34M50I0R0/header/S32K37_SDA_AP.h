...
/*!
 * @file S32K37_SDA_AP.h
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_SDA_AP
 *
...
#if !defined(S32K37_SDA_AP_H_)  /* Check if memory map has not been already included */
#define S32K37_SDA_AP_H_
...
#endif  /* #if !defined(S32K37_SDA_AP_H_) */
