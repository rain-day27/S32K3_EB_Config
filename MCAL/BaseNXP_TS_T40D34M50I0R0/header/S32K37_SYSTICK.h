...
**     Reference manual:    S32K37 RM Rev.2
...
/*!
 * @file S32K37_SYSTICK.h
 * @version 1.9
 * @date 2023-08-29
 * @brief Peripheral Access Layer for S32K37_SYSTICK
 *
...
#if !defined(S32K37_SYSTICK_H_)  /* Check if memory map has not been already included */
#define S32K37_SYSTICK_H_
...
#endif  /* #if !defined(S32K37_SYSTICK_H_) */
