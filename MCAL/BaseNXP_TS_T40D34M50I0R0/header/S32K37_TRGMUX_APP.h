...
/*!
 * @file S32K37_TRGMUX_APP.h
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_TRGMUX_APP
 *
...
#if !defined(S32K37_TRGMUX_APP_H_)  /* Check if memory map has not been already included */
#define S32K37_TRGMUX_APP_H_
...
typedef struct {
  __IO uint32_t TRGMUXn[TRGMUX_APP_TRGMUXn_COUNT]; /**< TRGMUX ADC12_0..TRGMUX LPI2C_0_Triggered, array offset: 0x0, array step: 0x4, valid indices: [0-21, 25-58, 61] */
...
/*! @name TRGMUXn - TRGMUX ADC12_0..TRGMUX LPI2C_0_Triggered */
/*! @{ */
...
#endif  /* #if !defined(S32K37_TRGMUX_APP_H_) */
