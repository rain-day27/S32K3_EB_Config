 ...
 * @version 2.0
 * @date 2024-03-28
 * @brief Peripheral Access Layer for S32K37_XBIC
 *
...
#if !defined(S32K37_XBIC_H_)  /* Check if memory map has not been already included */
#define S32K37_XBIC_H_
...
/** Peripheral EDMA1_XBIC base address */
#define IP_EDMA1_XBIC_BASE                       (0x40674000u)
/** Peripheral EDMA1_XBIC base pointer */
#define IP_EDMA1_XBIC                            ((XBIC_Type *)IP_EDMA1_XBIC_BASE)
/** Peripheral ZIPWIRE_XBIC base address */
#define IP_ZIPWIRE_XBIC_BASE                     (0x40678000u)
/** Peripheral ZIPWIRE_XBIC base pointer */
#define IP_ZIPWIRE_XBIC                          ((XBIC_Type *)IP_ZIPWIRE_XBIC_BASE)
/** Array initializer of XBIC peripheral base addresses */
#define IP_XBIC_BASE_ADDRS                       { IP_XBIC_AXBS_BASE, IP_XBIC_AXBS_PERI_BASE, IP_XBIC_AXBS_EDMA_BASE, IP_XBIC_AXBS_TCM_BASE, IP_EDMA1_XBIC_BASE, IP_ZIPWIRE_XBIC_BASE }
/** Array initializer of XBIC peripheral base pointers */
#define IP_XBIC_BASE_PTRS                        { IP_XBIC_AXBS, IP_XBIC_AXBS_PERI, IP_XBIC_AXBS_EDMA, IP_XBIC_AXBS_TCM, IP_EDMA1_XBIC, IP_ZIPWIRE_XBIC }
...
#endif  /* #if !defined(S32K37_XBIC_H_) */
