 ...
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_ACE
 *
...
#if !defined(S32K388_ACE_H_)  /* Check if memory map has not been already included */
#define S32K388_ACE_H_
...
typedef struct {
  __O  uint64_t INIT_VEC;                          /**< Initial Value, offset: 0x0, available only on: ACE.AHB/ACE__AHB (missing on ACE.AHB2/ACE__AHB2) */
  __O  uint64_t DATA_IN;                           /**< Data Input, offset: 0x8, available only on: ACE.AHB/ACE__AHB (missing on ACE.AHB2/ACE__AHB2) */
  uint8_t RESERVED_0[240];
  __I  uint64_t STATUS;                            /**< Status, offset: 0x100, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
  __IO uint64_t CONTROL;                           /**< Control, offset: 0x108, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
  uint8_t RESERVED_1[8];
  __IO uint64_t RESULT;                            /**< Result, offset: 0x118, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
  __IO uint64_t AUTH_TAG;                          /**< Auth Tag Output, offset: 0x120, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
  __I  uint64_t VERSION;                           /**< ACE Version, offset: 0x128, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
...
/** Peripheral ACE__AHB base address */
#define IP_ACE__AHB_BASE                         (0x44000000u)
/** Peripheral ACE__AHB base pointer */
#define IP_ACE__AHB                              ((ACE_Type *)IP_ACE__AHB_BASE)
/** Peripheral ACE__AHB2 base address */
#define IP_ACE__AHB2_BASE                        (0x44000000u)
/** Peripheral ACE__AHB2 base pointer */
#define IP_ACE__AHB2                             ((ACE_Type *)IP_ACE__AHB2_BASE)
/** Array initializer of ACE peripheral base addresses */
#define IP_ACE_BASE_ADDRS                        { IP_ACE__AHB_BASE, IP_ACE__AHB2_BASE }
/** Array initializer of ACE peripheral base pointers */
#define IP_ACE_BASE_PTRS                         { IP_ACE__AHB, IP_ACE__AHB2 }
...
#endif  /* #if !defined(S32K388_ACE_H_) */
