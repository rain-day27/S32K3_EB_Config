 ...
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_ADC
 *
...
#if !defined(S32K388_ADC_H_)  /* Check if memory map has not been already included */
#define S32K388_ADC_H_
...
typedef struct {
  ...
  __IO uint32_t CEOCFR2;                           /**< Channel End Of Conversion Flag For External Inputs, offset: 0x1C, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __IO uint32_t CIMR2;                             /**< EOC Interrupt Enable For External Inputs, offset: 0x2C, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __IO uint32_t DMAR2;                             /**< DMA Request Enable For External Inputs, offset: 0x4C, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __IO uint32_t PSR2;                              /**< Presampling Enable For External Inputs, offset: 0x8C, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __IO uint32_t CTR2;                              /**< Conversion Timing For External Inputs, offset: 0x9C, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __IO uint32_t NCMR2;                             /**< Normal Conversion Enable For External Inputs, offset: 0xAC, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __IO uint32_t JCMR2;                             /**< Injected Conversion Enable For External Inputs, offset: 0xBC, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  uint8_t RESERVED_7[4];
  __IO uint32_t DSDR;                              /**< Delay Start Of Data Conversion, offset: 0xC4, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __I  uint32_t ECDR[ADC_CDR3_COUNT];              /**< External Input n Conversion Data, array offset: 0x200, array step: 0x4, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __IO uint32_t CWSELREI[ADC_CWSELREI_COUNT];      /**< Channel Analog Watchdog Select For External inputs, array offset: 0x2D0, array step: 0x4, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __IO uint32_t CWENR2;                            /**< Channel Watchdog Enable For External Inputs, offset: 0x2E8, available only on: ADC_0, ADC_1 (missing on ADC_2) */
  ...
  __IO uint32_t AWORR2;                            /**< Analog Watchdog Out Of Range For External Inputs, offset: 0x2F8, available only on: ADC_0, ADC_1 (missing on ADC_2) */
...
#endif  /* #if !defined(S32K388_ADC_H_) */
