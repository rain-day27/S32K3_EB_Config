...
/*!
 * @file S32K388_CMU_FC.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_CMU_FC
 *
...
#if !defined(S32K388_CMU_FC_H_)  /* Check if memory map has not been already included */
#define S32K388_CMU_FC_H_
...
#define CMU_FC_INSTANCE_COUNT                    (5u)
...
#define IP_CMU_6_BASE                            (0x402BC0C0u)
/** Peripheral CMU_6 base pointer */
#define IP_CMU_6                                 ((CMU_FC_Type *)IP_CMU_6_BASE)
/** Array initializer of CMU_FC peripheral base addresses */
#define IP_CMU_FC_BASE_ADDRS                     { IP_CMU_0_BASE, IP_CMU_3_BASE, IP_CMU_4_BASE, IP_CMU_5_BASE, IP_CMU_6_BASE }
/** Array initializer of CMU_FC peripheral base pointers */
#define IP_CMU_FC_BASE_PTRS                      { IP_CMU_0, IP_CMU_3, IP_CMU_4, IP_CMU_5, IP_CMU_6 }
...
#endif  /* #if !defined(S32K388_CMU_FC_H_) */
