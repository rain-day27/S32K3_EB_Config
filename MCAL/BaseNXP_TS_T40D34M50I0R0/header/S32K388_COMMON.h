...
#if !defined(S32K388_COMMON_H_)  /* Check if memory map has not been already included */
#define S32K388_COMMON_H_
#define MCU_S32K388

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error S32K388 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  STM3_IRQn                    = 57,               /**< Single interrupt vector for all four channels */
  SWT3_IRQn                    = 58,               /**< Platform watchdog initial time-out */
  ...
  AESAPP0_IRQn                 = 88,               /**< Application 0 interrupt */
  AES_APP1_IRQn                = 89,               /**< Application 1 interrupt */
  AES_APP2_IRQn                = 90,               /**< Application 2 interrupt */
  AES_APP3_IRQn                = 91,               /**< Application 3 interrupt */
  LCU0_IRQn                    = 92,               /**< Interrupt 0, Interrupt 1 Interrupt 2 */
  LCU1_IRQn                    = 93,               /**< Interrupt 0, Interrupt 1 Interrupt 2 */
  AES_APP4_IRQn                = 94,               /**< Application 4 interrupt */
  AES_APP5_IRQn                = 95,               /**< Application 5 interrupt */
  ...
  PIT3_IRQn                    = 99,               /**< Interrupt for Channel0,Interrupt for Channel1,Interrupt for Channel2,Interrupt for Channel3 */
  AES_APP6_IRQn                = 100,              /**< Application 6 interrupt */
  AES_APP7_IRQn                = 101,              /**< Application 7 interrupt */
  ...
  MU4_A_0_IRQn                 = 136,              /**< ORed TX interrupt to MUA */
  MU4_A_1_IRQn                 = 137,              /**< ORed TX interrupt to MUA */
  MU4_A_2_IRQn                 = 138,              /**< ORed general purpose interrupt request to MUA */
  ...
  MU4_B_0_IRQn                 = 157,              /**< ORed TX interrupt to MUB */
  MU4_B_1_IRQn                 = 158,              /**< ORed TX interrupt to MUB */
  MU4_B_2_IRQn                 = 159,              /**< ORed general purpose interrupt request to MUB */
  ...
  GMAC1_Common_IRQn            = 171,              /**< Common interrupt */
  GMAC1_CH0_TX_IRQn            = 172,              /**< Channel0 TX interrupt */
  ...
  MU3_A_0_IRQn                 = 186,              /**< ORed TX interrupt to MUA */
  MU3_A_1_IRQn                 = 187,              /**< ORed TX interrupt to MUA */
  MU3_A_2_IRQn                 = 188,              /**< ORed general purpose interrupt request to MUA */
  ...
  MU3_B_0_IRQn                 = 199,              /**< ORed TX interrupt to MUB */
  MU3_B_1_IRQn                 = 200,              /**< ORed TX interrupt to MUB */
  MU3_B_2_IRQn                 = 201,              /**< ORed general purpose interrupt request to MUB */
  ...
  Core_clk_IRQn                = 213,              /**< Core clock fail CMU reset reaction interrupt */
  SoC2_IRQn                    = 214,              /**< PLL2 LOL interrupt */
  SoC3_IRQn                    = 215,              /**< AIPS_PLAT_CLK_FAIL CMU reset reaction interrupt */
  XRDC_IRQn                    = 216,              /**< XRDC Error Interrupt */
  SoC4_IRQn                    = 217,              /**< HSE_B_CLK_FAIL CMU reset reaction interrupt */
  SoC5_IRQn                    = 219,              /**< CM7_CORE_CLK_FAIL CMU reset reaction interrupt */
  ...
  GMAC1_CH0_RX_IRQn            = 233,              /**< Channel0 RX interrupt */
  GMAC1_CH1_TX_IRQn            = 234,              /**< Channel1 TX interrupt */
  GMAC1_CH1_RX_IRQn            = 235,              /**< Channel1 RX interrupt */
  GMAC1_CH2_TX_IRQn            = 236,              /**< Channel2 TX interrupt */
  GMAC1_CH2_RX_IRQn            = 237,              /**< Channel2 RX interrupt */
  GMAC1_SIC_IRQn               = 238,              /**< Safety interrupt correctable */
  GMAC1_SIUC_IRQn              = 239               /**< Safety interrupt un-correctable */
} IRQn_Type;
...
#endif  /* #if !defined(S32K388_COMMON_H_) */
