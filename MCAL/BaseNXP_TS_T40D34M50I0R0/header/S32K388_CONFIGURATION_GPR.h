...
/*!
 * @file S32K388_CONFIGURATION_GPR.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_CONFIGURATION_GPR
 *
...
#if !defined(S32K388_CONFIGURATION_GPR_H_)  /* Check if memory map has not been already included */
#define S32K388_CONFIGURATION_GPR_H_
...
#define CONFIGURATION_GPR_CONFIG_REG6_MAC_CLOCK_GATE_MASK (0x4U)
#define CONFIGURATION_GPR_CONFIG_REG6_MAC_CLOCK_GATE_SHIFT (2U)
#define CONFIGURATION_GPR_CONFIG_REG6_MAC_CLOCK_GATE_WIDTH (1U)
#define CONFIGURATION_GPR_CONFIG_REG6_MAC_CLOCK_GATE(x) (((uint32_t)(((uint32_t)(x)) << CONFIGURATION_GPR_CONFIG_REG6_MAC_CLOCK_GATE_SHIFT)) & CONFIGURATION_GPR_CONFIG_REG6_MAC_CLOCK_GATE_MASK)
...
#endif  /* #if !defined(S32K388_CONFIGURATION_GPR_H_) */
