...
/*!
 * @file S32K388_FEED_DMA_MP.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_FEED_DMA_MP
 *
...
#if !defined(S32K388_FEED_DMA_MP_H_)  /* Check if memory map has not been already included */
#define S32K388_FEED_DMA_MP_H_
...
#define FEED_DMA_MP_MP_GRPRI_COUNT                32u
...
/** Peripheral FEED_DMA_MP base address */
#define IP_FEED_DMA_MP_BASE                      (0x403C2000u)
/** Peripheral FEED_DMA_MP base pointer */
#define IP_FEED_DMA_MP                           ((FEED_DMA_MP_Type *)IP_FEED_DMA_MP_BASE)
/** Array initializer of FEED_DMA_MP peripheral base addresses */
#define IP_FEED_DMA_MP_BASE_ADDRS                { IP_FEED_DMA_MP_BASE }
/** Array initializer of FEED_DMA_MP peripheral base pointers */
#define IP_FEED_DMA_MP_BASE_PTRS                 { IP_FEED_DMA_MP }
...
#define FEED_DMA_MP_INT_INT_MASK                 (0xFFFFFFFFU)
#define FEED_DMA_MP_INT_INT_SHIFT                (0U)
#define FEED_DMA_MP_INT_INT_WIDTH                (32U)
...
#endif  /* #if !defined(S32K388_FEED_DMA_MP_H_) */
