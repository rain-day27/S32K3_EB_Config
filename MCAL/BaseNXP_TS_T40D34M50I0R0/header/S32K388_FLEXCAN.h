...
/*!
 * @file S32K388_FLEXCAN.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_FLEXCAN
 *
...
#if !defined(S32K388_FLEXCAN_H_)  /* Check if memory map has not been already included */
#define S32K388_FLEXCAN_H_
...
typedef struct {
  ...
  __IO uint32_t IMASK3;                            /**< Interrupt Masks 3, offset: 0x6C, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
  uint8_t RESERVED_3[4];
  __IO uint32_t IFLAG3;                            /**< Interrupt Flags 3, offset: 0x74, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
  uint8_t RESERVED_4[2056];
  __IO uint32_t RXIMR[FLEXCAN_RXIMR_COUNT];        /**< Receive Individual Mask, array offset: 0x880, array step: 0x4, irregular array, not all indices are valid */
  ...
  __IO uint32_t ERFCR;                             /**< Enhanced RX FIFO Control, offset: 0xC0C, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
  __IO uint32_t ERFIER;                            /**< Enhanced RX FIFO Interrupt Enable, offset: 0xC10, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
  __IO uint32_t ERFSR;                             /**< Enhanced RX FIFO Status, offset: 0xC14, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
  uint8_t RESERVED_7[24];
  __IO uint32_t HR_TIME_STAMP[FLEXCAN_HR_TIME_STAMP_COUNT]; /**< High-Resolution Timestamp, array offset: 0xC30, array step: 0x4, irregular array, not all indices are valid */
  uint8_t RESERVED_8[8784];
  __IO uint32_t ERFFEL[FLEXCAN_ERFFEL_COUNT];      /**< Enhanced RX FIFO Filter Element, array offset: 0x3000, array step: 0x4, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
...
#endif  /* #if !defined(S32K388_FLEXCAN_H_) */
