 ...
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_GMAC
 *
...
#if !defined(S32K388_GMAC_H_)  /* Check if memory map has not been already included */
#define S32K388_GMAC_H_
...
#define IP_GMAC_1_BASE                           (0x40488000u)
...
#endif  /* #if !defined(S32K388_GMAC_H_) */
