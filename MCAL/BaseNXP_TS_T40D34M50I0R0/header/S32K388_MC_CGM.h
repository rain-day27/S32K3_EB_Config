...
/*!
 * @file S32K388_MC_CGM.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_MC_CGM
 *
...
#if !defined(S32K388_MC_CGM_H_)  /* Check if memory map has not been already included */
#define S32K388_MC_CGM_H_
...
typedef struct {
  ...
  __IO uint32_t MUX_0_DC_7;                        /**< Clock Mux 0 Divider 7 Control Register, offset: 0x324 */
  ...
  __IO uint32_t MUX_16_DC_0;                       /**< Clock Mux 16 Divider 0 Control Register, offset: 0x708 */
  uint8_t RESERVED_18[48];
  __I  uint32_t MUX_16_DIV_UPD_STAT;               /**< Clock Mux 16 Divider Update Status Register, offset: 0x73C */
  uint8_t RESERVED_19[64];
  __IO uint32_t MUX_18_CSC;                        /**< Clock Mux 18 Select Control Register, offset: 0x780 */
  __I  uint32_t MUX_18_CSS;                        /**< Clock Mux 18 Select Status Register, offset: 0x784 */
  __IO uint32_t MUX_18_DC_0;                       /**< Clock Mux 18 Divider 0 Control Register, offset: 0x788 */
  uint8_t RESERVED_20[48];
  __I  uint32_t MUX_18_DIV_UPD_STAT;               /**< Clock Mux 18 Divider Update Status Register, offset: 0x7BC */
  __IO uint32_t MUX_19_CSC;                        /**< Clock Mux 19 Select Control Register, offset: 0x7C0 */
  __I  uint32_t MUX_19_CSS;                        /**< Clock Mux 19 Select Status Register, offset: 0x7C4 */
  __IO uint32_t MUX_19_DC_0;                       /**< Clock Mux 19 Divider 0 Control Register, offset: 0x7C8 */
  uint8_t RESERVED_21[48];
  __I  uint32_t MUX_19_DIV_UPD_STAT;               /**< Clock Mux 19 Divider Update Status Register, offset: 0x7FC */
...
/*! @name MUX_0_DC_7 - Clock Mux 0 Divider 7 Control Register */
/*! @{ */

#define MC_CGM_MUX_0_DC_7_DIV_MASK               (0x30000U)
#define MC_CGM_MUX_0_DC_7_DIV_SHIFT              (16U)
#define MC_CGM_MUX_0_DC_7_DIV_WIDTH              (2U)
#define MC_CGM_MUX_0_DC_7_DIV(x)                 (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_0_DC_7_DIV_SHIFT)) & MC_CGM_MUX_0_DC_7_DIV_MASK)

#define MC_CGM_MUX_0_DC_7_DE_MASK                (0x80000000U)
#define MC_CGM_MUX_0_DC_7_DE_SHIFT               (31U)
#define MC_CGM_MUX_0_DC_7_DE_WIDTH               (1U)
#define MC_CGM_MUX_0_DC_7_DE(x)                  (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_0_DC_7_DE_SHIFT)) & MC_CGM_MUX_0_DC_7_DE_MASK)
/*! @} */
...
#define MC_CGM_MUX_14_CSC_SELCTL_MASK            (0xF000000U)
#define MC_CGM_MUX_14_CSC_SELCTL_SHIFT           (24U)
#define MC_CGM_MUX_14_CSC_SELCTL_WIDTH           (4U)
...
#define MC_CGM_MUX_14_CSS_SELSTAT_MASK           (0xF000000U)
#define MC_CGM_MUX_14_CSS_SELSTAT_SHIFT          (24U)
#define MC_CGM_MUX_14_CSS_SELSTAT_WIDTH          (4U)
...
#define MC_CGM_MUX_15_CSC_SELCTL_MASK            (0x1F000000U)
#define MC_CGM_MUX_15_CSC_SELCTL_SHIFT           (24U)
#define MC_CGM_MUX_15_CSC_SELCTL_WIDTH           (5U)
...
#define MC_CGM_MUX_15_CSS_SELSTAT_MASK           (0x1F000000U)
#define MC_CGM_MUX_15_CSS_SELSTAT_SHIFT          (24U)
#define MC_CGM_MUX_15_CSS_SELSTAT_WIDTH          (5U)
...
#define MC_CGM_MUX_15_DC_0_DIV_MASK              (0x3F0000U)
#define MC_CGM_MUX_15_DC_0_DIV_SHIFT             (16U)
#define MC_CGM_MUX_15_DC_0_DIV_WIDTH             (6U)
...
/*! @name MUX_16_DC_0 - Clock Mux 16 Divider 0 Control Register */
/*! @{ */

#define MC_CGM_MUX_16_DC_0_DIV_MASK              (0x3F0000U)
#define MC_CGM_MUX_16_DC_0_DIV_SHIFT             (16U)
#define MC_CGM_MUX_16_DC_0_DIV_WIDTH             (6U)
#define MC_CGM_MUX_16_DC_0_DIV(x)                (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_16_DC_0_DIV_SHIFT)) & MC_CGM_MUX_16_DC_0_DIV_MASK)

#define MC_CGM_MUX_16_DC_0_DE_MASK               (0x80000000U)
#define MC_CGM_MUX_16_DC_0_DE_SHIFT              (31U)
#define MC_CGM_MUX_16_DC_0_DE_WIDTH              (1U)
#define MC_CGM_MUX_16_DC_0_DE(x)                 (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_16_DC_0_DE_SHIFT)) & MC_CGM_MUX_16_DC_0_DE_MASK)
/*! @} */

/*! @name MUX_16_DIV_UPD_STAT - Clock Mux 16 Divider Update Status Register */
/*! @{ */

#define MC_CGM_MUX_16_DIV_UPD_STAT_DIV_STAT_MASK (0x1U)
#define MC_CGM_MUX_16_DIV_UPD_STAT_DIV_STAT_SHIFT (0U)
#define MC_CGM_MUX_16_DIV_UPD_STAT_DIV_STAT_WIDTH (1U)
#define MC_CGM_MUX_16_DIV_UPD_STAT_DIV_STAT(x)   (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_16_DIV_UPD_STAT_DIV_STAT_SHIFT)) & MC_CGM_MUX_16_DIV_UPD_STAT_DIV_STAT_MASK)
/*! @} */

/*! @name MUX_18_CSC - Clock Mux 18 Select Control Register */
/*! @{ */

#define MC_CGM_MUX_18_CSC_CLK_SW_MASK            (0x4U)
#define MC_CGM_MUX_18_CSC_CLK_SW_SHIFT           (2U)
#define MC_CGM_MUX_18_CSC_CLK_SW_WIDTH           (1U)
#define MC_CGM_MUX_18_CSC_CLK_SW(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_CSC_CLK_SW_SHIFT)) & MC_CGM_MUX_18_CSC_CLK_SW_MASK)

#define MC_CGM_MUX_18_CSC_SAFE_SW_MASK           (0x8U)
#define MC_CGM_MUX_18_CSC_SAFE_SW_SHIFT          (3U)
#define MC_CGM_MUX_18_CSC_SAFE_SW_WIDTH          (1U)
#define MC_CGM_MUX_18_CSC_SAFE_SW(x)             (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_CSC_SAFE_SW_SHIFT)) & MC_CGM_MUX_18_CSC_SAFE_SW_MASK)

#define MC_CGM_MUX_18_CSC_SELCTL_MASK            (0x1F000000U)
#define MC_CGM_MUX_18_CSC_SELCTL_SHIFT           (24U)
#define MC_CGM_MUX_18_CSC_SELCTL_WIDTH           (5U)
#define MC_CGM_MUX_18_CSC_SELCTL(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_CSC_SELCTL_SHIFT)) & MC_CGM_MUX_18_CSC_SELCTL_MASK)
/*! @} */

/*! @name MUX_18_CSS - Clock Mux 18 Select Status Register */
/*! @{ */

#define MC_CGM_MUX_18_CSS_CLK_SW_MASK            (0x4U)
#define MC_CGM_MUX_18_CSS_CLK_SW_SHIFT           (2U)
#define MC_CGM_MUX_18_CSS_CLK_SW_WIDTH           (1U)
#define MC_CGM_MUX_18_CSS_CLK_SW(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_CSS_CLK_SW_SHIFT)) & MC_CGM_MUX_18_CSS_CLK_SW_MASK)

#define MC_CGM_MUX_18_CSS_SAFE_SW_MASK           (0x8U)
#define MC_CGM_MUX_18_CSS_SAFE_SW_SHIFT          (3U)
#define MC_CGM_MUX_18_CSS_SAFE_SW_WIDTH          (1U)
#define MC_CGM_MUX_18_CSS_SAFE_SW(x)             (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_CSS_SAFE_SW_SHIFT)) & MC_CGM_MUX_18_CSS_SAFE_SW_MASK)

#define MC_CGM_MUX_18_CSS_SWIP_MASK              (0x10000U)
#define MC_CGM_MUX_18_CSS_SWIP_SHIFT             (16U)
#define MC_CGM_MUX_18_CSS_SWIP_WIDTH             (1U)
#define MC_CGM_MUX_18_CSS_SWIP(x)                (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_CSS_SWIP_SHIFT)) & MC_CGM_MUX_18_CSS_SWIP_MASK)

#define MC_CGM_MUX_18_CSS_SWTRG_MASK             (0xE0000U)
#define MC_CGM_MUX_18_CSS_SWTRG_SHIFT            (17U)
#define MC_CGM_MUX_18_CSS_SWTRG_WIDTH            (3U)
#define MC_CGM_MUX_18_CSS_SWTRG(x)               (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_CSS_SWTRG_SHIFT)) & MC_CGM_MUX_18_CSS_SWTRG_MASK)

#define MC_CGM_MUX_18_CSS_SELSTAT_MASK           (0x1F000000U)
#define MC_CGM_MUX_18_CSS_SELSTAT_SHIFT          (24U)
#define MC_CGM_MUX_18_CSS_SELSTAT_WIDTH          (5U)
#define MC_CGM_MUX_18_CSS_SELSTAT(x)             (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_CSS_SELSTAT_SHIFT)) & MC_CGM_MUX_18_CSS_SELSTAT_MASK)
/*! @} */

/*! @name MUX_18_DC_0 - Clock Mux 18 Divider 0 Control Register */
/*! @{ */

#define MC_CGM_MUX_18_DC_0_DIV_MASK              (0x10000U)
#define MC_CGM_MUX_18_DC_0_DIV_SHIFT             (16U)
#define MC_CGM_MUX_18_DC_0_DIV_WIDTH             (1U)
#define MC_CGM_MUX_18_DC_0_DIV(x)                (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_DC_0_DIV_SHIFT)) & MC_CGM_MUX_18_DC_0_DIV_MASK)

#define MC_CGM_MUX_18_DC_0_DE_MASK               (0x80000000U)
#define MC_CGM_MUX_18_DC_0_DE_SHIFT              (31U)
#define MC_CGM_MUX_18_DC_0_DE_WIDTH              (1U)
#define MC_CGM_MUX_18_DC_0_DE(x)                 (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_DC_0_DE_SHIFT)) & MC_CGM_MUX_18_DC_0_DE_MASK)
/*! @} */

/*! @name MUX_18_DIV_UPD_STAT - Clock Mux 18 Divider Update Status Register */
/*! @{ */

#define MC_CGM_MUX_18_DIV_UPD_STAT_DIV_STAT_MASK (0x1U)
#define MC_CGM_MUX_18_DIV_UPD_STAT_DIV_STAT_SHIFT (0U)
#define MC_CGM_MUX_18_DIV_UPD_STAT_DIV_STAT_WIDTH (1U)
#define MC_CGM_MUX_18_DIV_UPD_STAT_DIV_STAT(x)   (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_18_DIV_UPD_STAT_DIV_STAT_SHIFT)) & MC_CGM_MUX_18_DIV_UPD_STAT_DIV_STAT_MASK)
/*! @} */

/*! @name MUX_19_CSC - Clock Mux 19 Select Control Register */
/*! @{ */

#define MC_CGM_MUX_19_CSC_CLK_SW_MASK            (0x4U)
#define MC_CGM_MUX_19_CSC_CLK_SW_SHIFT           (2U)
#define MC_CGM_MUX_19_CSC_CLK_SW_WIDTH           (1U)
#define MC_CGM_MUX_19_CSC_CLK_SW(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_CSC_CLK_SW_SHIFT)) & MC_CGM_MUX_19_CSC_CLK_SW_MASK)

#define MC_CGM_MUX_19_CSC_SAFE_SW_MASK           (0x8U)
#define MC_CGM_MUX_19_CSC_SAFE_SW_SHIFT          (3U)
#define MC_CGM_MUX_19_CSC_SAFE_SW_WIDTH          (1U)
#define MC_CGM_MUX_19_CSC_SAFE_SW(x)             (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_CSC_SAFE_SW_SHIFT)) & MC_CGM_MUX_19_CSC_SAFE_SW_MASK)

#define MC_CGM_MUX_19_CSC_SELCTL_MASK            (0xF000000U)
#define MC_CGM_MUX_19_CSC_SELCTL_SHIFT           (24U)
#define MC_CGM_MUX_19_CSC_SELCTL_WIDTH           (4U)
#define MC_CGM_MUX_19_CSC_SELCTL(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_CSC_SELCTL_SHIFT)) & MC_CGM_MUX_19_CSC_SELCTL_MASK)
/*! @} */

/*! @name MUX_19_CSS - Clock Mux 19 Select Status Register */
/*! @{ */

#define MC_CGM_MUX_19_CSS_CLK_SW_MASK            (0x4U)
#define MC_CGM_MUX_19_CSS_CLK_SW_SHIFT           (2U)
#define MC_CGM_MUX_19_CSS_CLK_SW_WIDTH           (1U)
#define MC_CGM_MUX_19_CSS_CLK_SW(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_CSS_CLK_SW_SHIFT)) & MC_CGM_MUX_19_CSS_CLK_SW_MASK)

#define MC_CGM_MUX_19_CSS_SAFE_SW_MASK           (0x8U)
#define MC_CGM_MUX_19_CSS_SAFE_SW_SHIFT          (3U)
#define MC_CGM_MUX_19_CSS_SAFE_SW_WIDTH          (1U)
#define MC_CGM_MUX_19_CSS_SAFE_SW(x)             (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_CSS_SAFE_SW_SHIFT)) & MC_CGM_MUX_19_CSS_SAFE_SW_MASK)

#define MC_CGM_MUX_19_CSS_SWIP_MASK              (0x10000U)
#define MC_CGM_MUX_19_CSS_SWIP_SHIFT             (16U)
#define MC_CGM_MUX_19_CSS_SWIP_WIDTH             (1U)
#define MC_CGM_MUX_19_CSS_SWIP(x)                (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_CSS_SWIP_SHIFT)) & MC_CGM_MUX_19_CSS_SWIP_MASK)

#define MC_CGM_MUX_19_CSS_SWTRG_MASK             (0xE0000U)
#define MC_CGM_MUX_19_CSS_SWTRG_SHIFT            (17U)
#define MC_CGM_MUX_19_CSS_SWTRG_WIDTH            (3U)
#define MC_CGM_MUX_19_CSS_SWTRG(x)               (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_CSS_SWTRG_SHIFT)) & MC_CGM_MUX_19_CSS_SWTRG_MASK)

#define MC_CGM_MUX_19_CSS_SELSTAT_MASK           (0xF000000U)
#define MC_CGM_MUX_19_CSS_SELSTAT_SHIFT          (24U)
#define MC_CGM_MUX_19_CSS_SELSTAT_WIDTH          (4U)
#define MC_CGM_MUX_19_CSS_SELSTAT(x)             (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_CSS_SELSTAT_SHIFT)) & MC_CGM_MUX_19_CSS_SELSTAT_MASK)
/*! @} */

/*! @name MUX_19_DC_0 - Clock Mux 19 Divider 0 Control Register */
/*! @{ */

#define MC_CGM_MUX_19_DC_0_DIV_MASK              (0x3F0000U)
#define MC_CGM_MUX_19_DC_0_DIV_SHIFT             (16U)
#define MC_CGM_MUX_19_DC_0_DIV_WIDTH             (6U)
#define MC_CGM_MUX_19_DC_0_DIV(x)                (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_DC_0_DIV_SHIFT)) & MC_CGM_MUX_19_DC_0_DIV_MASK)

#define MC_CGM_MUX_19_DC_0_DE_MASK               (0x80000000U)
#define MC_CGM_MUX_19_DC_0_DE_SHIFT              (31U)
#define MC_CGM_MUX_19_DC_0_DE_WIDTH              (1U)
#define MC_CGM_MUX_19_DC_0_DE(x)                 (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_DC_0_DE_SHIFT)) & MC_CGM_MUX_19_DC_0_DE_MASK)
/*! @} */

/*! @name MUX_19_DIV_UPD_STAT - Clock Mux 19 Divider Update Status Register */
/*! @{ */

#define MC_CGM_MUX_19_DIV_UPD_STAT_DIV_STAT_MASK (0x1U)
#define MC_CGM_MUX_19_DIV_UPD_STAT_DIV_STAT_SHIFT (0U)
#define MC_CGM_MUX_19_DIV_UPD_STAT_DIV_STAT_WIDTH (1U)
#define MC_CGM_MUX_19_DIV_UPD_STAT_DIV_STAT(x)   (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_19_DIV_UPD_STAT_DIV_STAT_SHIFT)) & MC_CGM_MUX_19_DIV_UPD_STAT_DIV_STAT_MASK)
/*! @} */
...
#endif  /* #if !defined(S32K388_MC_CGM_H_) */
