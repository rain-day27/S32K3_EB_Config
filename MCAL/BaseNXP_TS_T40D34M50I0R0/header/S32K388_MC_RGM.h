...
/*!
 * @file S32K388_MC_RGM.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_MC_RGM
 *
...
#if !defined(S32K388_MC_RGM_H_)  /* Check if memory map has not been already included */
#define S32K388_MC_RGM_H_
...
#define MC_RGM_DES_CM7_CORE_CLK_FAIL_MASK        (0x10000U)
#define MC_RGM_DES_CM7_CORE_CLK_FAIL_SHIFT       (16U)
#define MC_RGM_DES_CM7_CORE_CLK_FAIL_WIDTH       (1U)
#define MC_RGM_DES_CM7_CORE_CLK_FAIL(x)          (((uint32_t)(((uint32_t)(x)) << MC_RGM_DES_CM7_CORE_CLK_FAIL_SHIFT)) & MC_RGM_DES_CM7_CORE_CLK_FAIL_MASK)
...
#define MC_RGM_FES_SWT2_RST_MASK                 (0x100U)
#define MC_RGM_FES_SWT2_RST_SHIFT                (8U)
#define MC_RGM_FES_SWT2_RST_WIDTH                (1U)
#define MC_RGM_FES_SWT2_RST(x)                   (((uint32_t)(((uint32_t)(x)) << MC_RGM_FES_SWT2_RST_SHIFT)) & MC_RGM_FES_SWT2_RST_MASK)
...
#define MC_RGM_FES_SWT3_RST_MASK                 (0x400U)
#define MC_RGM_FES_SWT3_RST_SHIFT                (10U)
#define MC_RGM_FES_SWT3_RST_WIDTH                (1U)
#define MC_RGM_FES_SWT3_RST(x)                   (((uint32_t)(((uint32_t)(x)) << MC_RGM_FES_SWT3_RST_SHIFT)) & MC_RGM_FES_SWT3_RST_MASK)

#define MC_RGM_FES_PLL_AUX_MASK                  (0x1000U)
#define MC_RGM_FES_PLL_AUX_SHIFT                 (12U)
#define MC_RGM_FES_PLL_AUX_WIDTH                 (1U)
#define MC_RGM_FES_PLL_AUX(x)                    (((uint32_t)(((uint32_t)(x)) << MC_RGM_FES_PLL_AUX_SHIFT)) & MC_RGM_FES_PLL_AUX_MASK)
...
#define MC_RGM_FERD_D_SWT2_RST_MASK              (0x100U)
#define MC_RGM_FERD_D_SWT2_RST_SHIFT             (8U)
#define MC_RGM_FERD_D_SWT2_RST_WIDTH             (1U)
#define MC_RGM_FERD_D_SWT2_RST(x)                (((uint32_t)(((uint32_t)(x)) << MC_RGM_FERD_D_SWT2_RST_SHIFT)) & MC_RGM_FERD_D_SWT2_RST_MASK)
...
#define MC_RGM_FERD_D_SWT3_RST_MASK              (0x400U)
#define MC_RGM_FERD_D_SWT3_RST_SHIFT             (10U)
#define MC_RGM_FERD_D_SWT3_RST_WIDTH             (1U)
#define MC_RGM_FERD_D_SWT3_RST(x)                (((uint32_t)(((uint32_t)(x)) << MC_RGM_FERD_D_SWT3_RST_SHIFT)) & MC_RGM_FERD_D_SWT3_RST_MASK)
...
#define MC_RGM_FBRE_BE_SWT2_RST_MASK             (0x100U)
#define MC_RGM_FBRE_BE_SWT2_RST_SHIFT            (8U)
#define MC_RGM_FBRE_BE_SWT2_RST_WIDTH            (1U)
#define MC_RGM_FBRE_BE_SWT2_RST(x)               (((uint32_t)(((uint32_t)(x)) << MC_RGM_FBRE_BE_SWT2_RST_SHIFT)) & MC_RGM_FBRE_BE_SWT2_RST_MASK)
...
#define MC_RGM_FBRE_BE_SWT3_RST_MASK             (0x400U)
#define MC_RGM_FBRE_BE_SWT3_RST_SHIFT            (10U)
#define MC_RGM_FBRE_BE_SWT3_RST_WIDTH            (1U)
#define MC_RGM_FBRE_BE_SWT3_RST(x)               (((uint32_t)(((uint32_t)(x)) << MC_RGM_FBRE_BE_SWT3_RST_SHIFT)) & MC_RGM_FBRE_BE_SWT3_RST_MASK)

#define MC_RGM_FBRE_BE_PLL_AUX_MASK              (0x1000U)
#define MC_RGM_FBRE_BE_PLL_AUX_SHIFT             (12U)
#define MC_RGM_FBRE_BE_PLL_AUX_WIDTH             (1U)
#define MC_RGM_FBRE_BE_PLL_AUX(x)                (((uint32_t)(((uint32_t)(x)) << MC_RGM_FBRE_BE_PLL_AUX_SHIFT)) & MC_RGM_FBRE_BE_PLL_AUX_MASK)
...
#endif  /* #if !defined(S32K388_MC_RGM_H_) */
