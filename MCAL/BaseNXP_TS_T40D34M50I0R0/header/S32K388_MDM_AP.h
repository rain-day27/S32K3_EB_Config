...
/*!
 * @file S32K388_MDM_AP.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_MDM_AP
 *
...
#if !defined(S32K388_MDM_AP_H_)  /* Check if memory map has not been already included */
#define S32K388_MDM_AP_H_
...
#define MDM_AP_MDMAPSTTS_CM73HLT_MASK            (0x1000000U)
#define MDM_AP_MDMAPSTTS_CM73HLT_SHIFT           (24U)
#define MDM_AP_MDMAPSTTS_CM73HLT_WIDTH           (1U)
#define MDM_AP_MDMAPSTTS_CM73HLT(x)              (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPSTTS_CM73HLT_SHIFT)) & MDM_AP_MDMAPSTTS_CM73HLT_MASK)

#define MDM_AP_MDMAPSTTS_CM73DPSLP_MASK          (0x2000000U)
#define MDM_AP_MDMAPSTTS_CM73DPSLP_SHIFT         (25U)
#define MDM_AP_MDMAPSTTS_CM73DPSLP_WIDTH         (1U)
#define MDM_AP_MDMAPSTTS_CM73DPSLP(x)            (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPSTTS_CM73DPSLP_SHIFT)) & MDM_AP_MDMAPSTTS_CM73DPSLP_MASK)

#define MDM_AP_MDMAPSTTS_CM73SLPNG_MASK          (0x4000000U)
#define MDM_AP_MDMAPSTTS_CM73SLPNG_SHIFT         (26U)
#define MDM_AP_MDMAPSTTS_CM73SLPNG_WIDTH         (1U)
#define MDM_AP_MDMAPSTTS_CM73SLPNG(x)            (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPSTTS_CM73SLPNG_SHIFT)) & MDM_AP_MDMAPSTTS_CM73SLPNG_MASK)

#define MDM_AP_MDMAPSTTS_CM73DBGRSTRD_MASK       (0x8000000U)
#define MDM_AP_MDMAPSTTS_CM73DBGRSTRD_SHIFT      (27U)
#define MDM_AP_MDMAPSTTS_CM73DBGRSTRD_WIDTH      (1U)
#define MDM_AP_MDMAPSTTS_CM73DBGRSTRD(x)         (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPSTTS_CM73DBGRSTRD_SHIFT)) & MDM_AP_MDMAPSTTS_CM73DBGRSTRD_MASK)
...
#define MDM_AP_MDMAPCTL_CM73DBGREQ_MASK          (0x4000U)
#define MDM_AP_MDMAPCTL_CM73DBGREQ_SHIFT         (14U)
#define MDM_AP_MDMAPCTL_CM73DBGREQ_WIDTH         (1U)
#define MDM_AP_MDMAPCTL_CM73DBGREQ(x)            (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPCTL_CM73DBGREQ_SHIFT)) & MDM_AP_MDMAPCTL_CM73DBGREQ_MASK)
...
#define MDM_AP_MDMAPCTL_CM7_2_CORE_ACCESS_MASK   (0x40000U)
#define MDM_AP_MDMAPCTL_CM7_2_CORE_ACCESS_SHIFT  (18U)
#define MDM_AP_MDMAPCTL_CM7_2_CORE_ACCESS_WIDTH  (1U)
#define MDM_AP_MDMAPCTL_CM7_2_CORE_ACCESS(x)     (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPCTL_CM7_2_CORE_ACCESS_SHIFT)) & MDM_AP_MDMAPCTL_CM7_2_CORE_ACCESS_MASK)

#define MDM_AP_MDMAPCTL_CM7_2_CHK_MASK           (0x80000U)
#define MDM_AP_MDMAPCTL_CM7_2_CHK_SHIFT          (19U)
#define MDM_AP_MDMAPCTL_CM7_2_CHK_WIDTH          (1U)
#define MDM_AP_MDMAPCTL_CM7_2_CHK(x)             (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPCTL_CM7_2_CHK_SHIFT)) & MDM_AP_MDMAPCTL_CM7_2_CHK_MASK)
...
#define MDM_AP_MDMAPCTL_CM7_3_CORE_ACCESS_MASK   (0x200000U)
#define MDM_AP_MDMAPCTL_CM7_3_CORE_ACCESS_SHIFT  (21U)
#define MDM_AP_MDMAPCTL_CM7_3_CORE_ACCESS_WIDTH  (1U)
#define MDM_AP_MDMAPCTL_CM7_3_CORE_ACCESS(x)     (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPCTL_CM7_3_CORE_ACCESS_SHIFT)) & MDM_AP_MDMAPCTL_CM7_3_CORE_ACCESS_MASK)
...
#define MDM_AP_MDMAPCTL_CM73DBGRSRT_MASK         (0x8000000U)
#define MDM_AP_MDMAPCTL_CM73DBGRSRT_SHIFT        (27U)
#define MDM_AP_MDMAPCTL_CM73DBGRSRT_WIDTH        (1U)
#define MDM_AP_MDMAPCTL_CM73DBGRSRT(x)           (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPCTL_CM73DBGRSRT_SHIFT)) & MDM_AP_MDMAPCTL_CM73DBGRSRT_MASK)
...
#define MDM_AP_MDMAPWIREN_PRVNTRSTEN_MASK        (0x2U)
#define MDM_AP_MDMAPWIREN_PRVNTRSTEN_SHIFT       (1U)
#define MDM_AP_MDMAPWIREN_PRVNTRSTEN_WIDTH       (1U)
#define MDM_AP_MDMAPWIREN_PRVNTRSTEN(x)          (((uint32_t)(((uint32_t)(x)) << MDM_AP_MDMAPWIREN_PRVNTRSTEN_SHIFT)) & MDM_AP_MDMAPWIREN_PRVNTRSTEN_MASK)
/*! @} */
...
#endif  /* #if !defined(S32K388_MDM_AP_H_) */
