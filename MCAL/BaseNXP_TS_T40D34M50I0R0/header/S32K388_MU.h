 ...
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_MU
 *
...
#if !defined(S32K388_MU_H_)  /* Check if memory map has not been already included */
#define S32K388_MU_H_
...
typedef struct {
  ...
  __IO uint32_t CCR0;                              /**< Core Control 0, offset: 0x10, not available in all instances (available on 2 out of 8) */
  uint8_t RESERVED_0[4];
  __IO uint32_t CSSR0;                             /**< Core Sticky Status 0, offset: 0x18, not available in all instances (available on 2 out of 8) */
...
#define IP_MU_2__MUA_BASE                        (0x400B8000u)
/** Peripheral MU_2__MUA base pointer */
#define IP_MU_2__MUA                             ((MU_Type *)IP_MU_2__MUA_BASE)
/** Peripheral MU_2__MUB base address */
#define IP_MU_2__MUB_BASE                        (0x400BC000u)
/** Peripheral MU_2__MUB base pointer */
#define IP_MU_2__MUB                             ((MU_Type *)IP_MU_2__MUB_BASE)
/** Peripheral MU_3__MUA base address */
#define IP_MU_3__MUA_BASE                        (0x400C4000u)
/** Peripheral MU_3__MUA base pointer */
#define IP_MU_3__MUA                             ((MU_Type *)IP_MU_3__MUA_BASE)
/** Peripheral MU_3__MUB base address */
#define IP_MU_3__MUB_BASE                        (0x400C8000u)
/** Peripheral MU_3__MUB base pointer */
#define IP_MU_3__MUB                             ((MU_Type *)IP_MU_3__MUB_BASE)
/** Peripheral MU_4__MUA base address */
#define IP_MU_4__MUA_BASE                        (0x400CC000u)
/** Peripheral MU_4__MUA base pointer */
#define IP_MU_4__MUA                             ((MU_Type *)IP_MU_4__MUA_BASE)
/** Peripheral MU_4__MUB base address */
#define IP_MU_4__MUB_BASE                        (0x400D0000u)
/** Peripheral MU_4__MUB base pointer */
#define IP_MU_4__MUB                             ((MU_Type *)IP_MU_4__MUB_BASE)
/** Array initializer of MU peripheral base addresses */
#define IP_MU_BASE_ADDRS                         { IP_MU_0__MUB_BASE, IP_MU_1__MUB_BASE, IP_MU_2__MUA_BASE, IP_MU_2__MUB_BASE, IP_MU_3__MUA_BASE, IP_MU_3__MUB_BASE, IP_MU_4__MUA_BASE, IP_MU_4__MUB_BASE }
/** Array initializer of MU peripheral base pointers */
#define IP_MU_BASE_PTRS                          { IP_MU_0__MUB, IP_MU_1__MUB, IP_MU_2__MUA, IP_MU_2__MUB, IP_MU_3__MUA, IP_MU_3__MUB, IP_MU_4__MUA, IP_MU_4__MUB }
...
#endif  /* #if !defined(S32K388_MU_H_) */
