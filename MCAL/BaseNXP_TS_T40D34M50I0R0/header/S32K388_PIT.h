 ...
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_PIT
 *
...
#if !defined(S32K388_PIT_H_)  /* Check if memory map has not been already included */
#define S32K388_PIT_H_
...
typedef struct {
  ...
  __I  uint32_t LTMR64H;                           /**< PIT Upper Lifetimer, offset: 0xE0, available only on: PIT_0 (missing on PIT_1, PIT_2, PIT_3) */
  __I  uint32_t LTMR64L;                           /**< PIT Lower Lifetimer, offset: 0xE4, available only on: PIT_0 (missing on PIT_1, PIT_2, PIT_3) */
  uint8_t RESERVED_1[4];
  __IO uint32_t RTI_LDVAL_STAT;                    /**< RTI Timer Load Value Sync Status, offset: 0xEC, available only on: PIT_0 (missing on PIT_1, PIT_2, PIT_3) */
  __IO uint32_t RTI_LDVAL;                         /**< RTI Timer Load Value, offset: 0xF0, available only on: PIT_0 (missing on PIT_1, PIT_2, PIT_3) */
  __I  uint32_t RTI_CVAL;                          /**< Current RTI Timer Value, offset: 0xF4, available only on: PIT_0 (missing on PIT_1, PIT_2, PIT_3) */
  __IO uint32_t RTI_TCTRL;                         /**< RTI Timer Control, offset: 0xF8, available only on: PIT_0 (missing on PIT_1, PIT_2, PIT_3) */
  __IO uint32_t RTI_TFLG;                          /**< RTI Timer Interrupt Flag, offset: 0xFC, available only on: PIT_0 (missing on PIT_1, PIT_2, PIT_3) */
...
#define IP_PIT_3_BASE                            (0x40300000u)
/** Peripheral PIT_3 base pointer */
#define IP_PIT_3                                 ((PIT_Type *)IP_PIT_3_BASE)
/** Array initializer of PIT peripheral base addresses */
#define IP_PIT_BASE_ADDRS                        { IP_PIT_0_BASE, IP_PIT_1_BASE, IP_PIT_2_BASE, IP_PIT_3_BASE }
/** Array initializer of PIT peripheral base pointers */
#define IP_PIT_BASE_PTRS                         { IP_PIT_0, IP_PIT_1, IP_PIT_2, IP_PIT_3 }
...
#endif  /* #if !defined(S32K388_PIT_H_) */
