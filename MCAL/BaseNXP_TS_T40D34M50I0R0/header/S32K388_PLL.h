 ...
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_PLL
 *
...
#if !defined(S32K388_PLL_H_)  /* Check if memory map has not been already included */
#define S32K388_PLL_H_
...
typedef struct {
  ...
  __IO uint32_t PLLFM;                             /**< PLL Frequency Modulation, offset: 0xC, available only on: PLL (missing on PLL_AUX) */
  __IO uint32_t PLLFD;                             /**< PLL Fractional Divider, offset: 0x10, available only on: PLL (missing on PLL_AUX) */
  uint8_t RESERVED_0[4];
  __IO uint32_t PLLCAL2;                           /**< PLL Calibration Register 2, offset: 0x18, available only on: PLL (missing on PLL_AUX) */
...
#endif  /* #if !defined(S32K388_PLL_H_) */
