...
/*!
 * @file S32K388_RESULT_DMA_MP.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_RESULT_DMA_MP
 *
...
#if !defined(S32K388_RESULT_DMA_MP_H_)  /* Check if memory map has not been already included */
#define S32K388_RESULT_DMA_MP_H_
...
/** Peripheral RESULT_DMA_MP base address */
#define IP_RESULT_DMA_MP_BASE                    (0x403C5000u)
/** Peripheral RESULT_DMA_MP base pointer */
#define IP_RESULT_DMA_MP                         ((RESULT_DMA_MP_Type *)IP_RESULT_DMA_MP_BASE)
/** Array initializer of RESULT_DMA_MP peripheral base addresses */
#define IP_RESULT_DMA_MP_BASE_ADDRS              { IP_RESULT_DMA_MP_BASE }
/** Array initializer of RESULT_DMA_MP peripheral base pointers */
#define IP_RESULT_DMA_MP_BASE_PTRS               { IP_RESULT_DMA_MP }
...
#endif  /* #if !defined(S32K388_RESULT_DMA_MP_H_) */
