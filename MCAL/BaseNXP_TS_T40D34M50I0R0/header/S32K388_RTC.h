 ...
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_RTC
 *
...
#if !defined(S32K388_RTC_H_)  /* Check if memory map has not been already included */
#define S32K388_RTC_H_
...
#endif  /* #if !defined(S32K388_RTC_H_) */
