...
/*!
 * @file S32K388_SDA_AP.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_SDA_AP
 *
...
#if !defined(S32K388_SDA_AP_H_)  /* Check if memory map has not been already included */
#define S32K388_SDA_AP_H_
...
typedef struct {
  ...
  __O  uint32_t AUTHCTL;                           /**< Authentication Control, offset: 0x4 */
...
#define SDA_AP_SDAAPRSTCTRL_RSTRELTLCM72_MASK    (0x8000000U)
#define SDA_AP_SDAAPRSTCTRL_RSTRELTLCM72_SHIFT   (27U)
#define SDA_AP_SDAAPRSTCTRL_RSTRELTLCM72_WIDTH   (1U)
#define SDA_AP_SDAAPRSTCTRL_RSTRELTLCM72(x)      (((uint32_t)(((uint32_t)(x)) << SDA_AP_SDAAPRSTCTRL_RSTRELTLCM72_SHIFT)) & SDA_AP_SDAAPRSTCTRL_RSTRELTLCM72_MASK)

#define SDA_AP_SDAAPRSTCTRL_RSTRELTLCM73_MASK    (0x10000000U)
#define SDA_AP_SDAAPRSTCTRL_RSTRELTLCM73_SHIFT   (28U)
#define SDA_AP_SDAAPRSTCTRL_RSTRELTLCM73_WIDTH   (1U)
#define SDA_AP_SDAAPRSTCTRL_RSTRELTLCM73(x)      (((uint32_t)(((uint32_t)(x)) << SDA_AP_SDAAPRSTCTRL_RSTRELTLCM73_SHIFT)) & SDA_AP_SDAAPRSTCTRL_RSTRELTLCM73_MASK)
/*! @} */
...
#endif  /* #if !defined(S32K388_SDA_AP_H_) */
