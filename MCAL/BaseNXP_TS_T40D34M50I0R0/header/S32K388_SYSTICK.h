...
/*!
 * @file S32K388_SYSTICK.h
 * @version 1.1
 * @date 2022-11-03
 * @brief Peripheral Access Layer for S32K388_SYSTICK
 *
...
#if !defined(S32K388_SYSTICK_H_)  /* Check if memory map has not been already included */
#define S32K388_SYSTICK_H_
...
#endif  /* #if !defined(S32K388_SYSTICK_H_) */
