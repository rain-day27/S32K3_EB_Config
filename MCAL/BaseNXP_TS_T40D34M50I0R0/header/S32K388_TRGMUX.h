...
/*!
 * @file S32K388_TRGMUX.h
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_TRGMUX
 *
...
#if !defined(S32K388_TRGMUX_H_)  /* Check if memory map has not been already included */
#define S32K388_TRGMUX_H_
...
typedef struct {
  __IO uint32_t TRGMUXn[TRGMUX_TRGMUXn_COUNT];     /**< TRGMUX ADC12_0..TRGMUX CM7_RXEV, array offset: 0x0, array step: 0x4 */
...
/*! @name TRGMUXn - TRGMUX ADC12_0..TRGMUX CM7_RXEV */
/*! @{ */
...
#endif  /* #if !defined(S32K388_TRGMUX_H_) */
