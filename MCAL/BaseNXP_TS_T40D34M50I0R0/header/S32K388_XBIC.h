 ...
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_XBIC
 *
...
#if !defined(S32K388_XBIC_H_)  /* Check if memory map has not been already included */
#define S32K388_XBIC_H_
...
/** Peripheral XBIC_AXBS_ACE base address */
#define IP_XBIC_AXBS_ACE_BASE                    (0x4040C000u)
/** Peripheral XBIC_AXBS_ACE base pointer */
#define IP_XBIC_AXBS_ACE                         ((XBIC_Type *)IP_XBIC_AXBS_ACE_BASE)
/** Peripheral XBIC_AXBS_ACE_HSE base address */
#define IP_XBIC_AXBS_ACE_HSE_BASE                (0x40008000u)
/** Peripheral XBIC_AXBS_ACE_HSE base pointer */
#define IP_XBIC_AXBS_ACE_HSE                     ((XBIC_Type *)IP_XBIC_AXBS_ACE_HSE_BASE)
...
/** Peripheral XBIC_AXBS_PRAM_TCM base address */
#define IP_XBIC_AXBS_PRAM_TCM_BASE               (0x40408000u)
/** Peripheral XBIC_AXBS_PRAM_TCM base pointer */
#define IP_XBIC_AXBS_PRAM_TCM                    ((XBIC_Type *)IP_XBIC_AXBS_PRAM_TCM_BASE)
...
#define IP_XBIC_BASE_ADDRS                       { IP_XBIC_AXBS_BASE, IP_XBIC_AXBS_ACE_BASE, IP_XBIC_AXBS_ACE_HSE_BASE, IP_XBIC_AXBS_EDMA_BASE, IP_XBIC_AXBS_PERI_BASE, IP_XBIC_AXBS_PRAM_TCM_BASE, IP_XBIC_AXBS_TCM_BASE }
/** Array initializer of XBIC peripheral base pointers */
#define IP_XBIC_BASE_PTRS                        { IP_XBIC_AXBS, IP_XBIC_AXBS_ACE, IP_XBIC_AXBS_ACE_HSE, IP_XBIC_AXBS_EDMA, IP_XBIC_AXBS_PERI, IP_XBIC_AXBS_PRAM_TCM, IP_XBIC_AXBS_TCM }
...
#endif  /* #if !defined(S32K388_XBIC_H_) */
