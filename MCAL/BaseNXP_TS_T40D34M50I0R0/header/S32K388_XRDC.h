 ...
 * @version 1.3
 * @date 2023-09-12
 * @brief Peripheral Access Layer for S32K388_XRDC
 *
...
#if !defined(S32K388_XRDC_H_)  /* Check if memory map has not been already included */
#define S32K388_XRDC_H_
...
#define XRDC_MDAC_COUNT                           10u
#define XRDC_MRC_COUNT                            5u
#define XRDC_DERRLOC_COUNT                        5u
#define XRDC_DERRW0_COUNT                         19u
#define XRDC_PID_COUNT                            9u
#define XRDC_PDAC_SLOT_COUNT                      3u
#define XRDC_PDAC_SLOT_PDACN_COUNT                128u
#define XRDC_MRCN_COUNT                           5u
...
typedef struct {
  ...
  uint8_t RESERVED_3[187];
  __I  uint32_t DERRLOC[XRDC_DERRLOC_COUNT];       /**< Domain Error Location, array offset: 0x200, array step: 0x4 */
  uint8_t RESERVED_4[492];
  struct {                                         /* offset: 0x400, array step: 0x10 */
    __I  uint32_t DERR_W0;                           /**< Domain Error Word 0, array offset: 0x400, array step: 0x10, valid indices: [0-4, 16-18] */
    __I  uint32_t DERR_W1;                           /**< Domain Error Word 1, array offset: 0x404, array step: 0x10, valid indices: [0-4, 16-18] */
    uint8_t RESERVED_0[4];
    __O  uint32_t DERR_W3;                           /**< Domain Error Word 3, array offset: 0x40C, array step: 0x10, valid indices: [0-4, 16-18] */
  } DERRW0[XRDC_DERRW0_COUNT];
  uint8_t RESERVED_5[464];
  __IO uint32_t PID[XRDC_PID_COUNT];               /**< Process Identifier, array offset: 0x700, array step: 0x4, valid indices: [0, 3-4, 6, 8] */
  ...
  __IO uint32_t MDA_W0_6_DFMT0;                    /**< Master Domain Assignment, offset: 0x8C0 */
  ...
  uint8_t RESERVED_17[1024];
  struct {                                         /* offset: 0x2000, array step: index*0x200, index2*0x20 */
    __IO uint32_t XRDC_MRGD_W0;                      /**< Memory Region Descriptor Word 0, array offset: 0x2000, array step: index*0x200, index2*0x20, valid indices: [0][0-15], [1][0-15], [2][0-3], [3][0-15], [4][0-3] */
    __IO uint32_t XRDC_MRGD_W1;                      /**< Memory Region Descriptor Word 1, array offset: 0x2004, array step: index*0x200, index2*0x20, valid indices: [0][0-15], [1][0-15], [2][0-3], [3][0-15], [4][0-3] */
    __IO uint32_t XRDC_MRGD_W2;                      /**< Memory Region Descriptor Word 2, array offset: 0x2008, array step: index*0x200, index2*0x20, valid indices: [0][0-15], [1][0-15], [2][0-3], [3][0-15], [4][0-3] */
    __IO uint32_t XRDC_MRGD_W3;                      /**< Memory Region Descriptor Word 3, array offset: 0x200C, array step: index*0x200, index2*0x20, valid indices: [0][0-15], [1][0-15], [2][0-3], [3][0-15], [4][0-3] */
...
#define XRDC_MDA_W0_0_DFMT0_DID_MASK             (0x7U)
#define XRDC_MDA_W0_0_DFMT0_DID_SHIFT            (0U)
#define XRDC_MDA_W0_0_DFMT0_DID_WIDTH            (3U)
...
#define XRDC_MDA_W0_3_DFMT0_DID_MASK             (0x7U)
#define XRDC_MDA_W0_3_DFMT0_DID_SHIFT            (0U)
#define XRDC_MDA_W0_3_DFMT0_DID_WIDTH            (3U)
...
#define XRDC_MDA_W0_4_DFMT0_DID_MASK             (0x7U)
#define XRDC_MDA_W0_4_DFMT0_DID_SHIFT            (0U)
#define XRDC_MDA_W0_4_DFMT0_DID_WIDTH            (3U)
...
/*! @name MDA_W0_6_DFMT0 - Master Domain Assignment */
/*! @{ */

#define XRDC_MDA_W0_6_DFMT0_DID_MASK             (0x7U)
#define XRDC_MDA_W0_6_DFMT0_DID_SHIFT            (0U)
#define XRDC_MDA_W0_6_DFMT0_DID_WIDTH            (3U)
#define XRDC_MDA_W0_6_DFMT0_DID(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_6_DFMT0_DID_SHIFT)) & XRDC_MDA_W0_6_DFMT0_DID_MASK)

#define XRDC_MDA_W0_6_DFMT0_DIDS_MASK            (0x30U)
#define XRDC_MDA_W0_6_DFMT0_DIDS_SHIFT           (4U)
#define XRDC_MDA_W0_6_DFMT0_DIDS_WIDTH           (2U)
#define XRDC_MDA_W0_6_DFMT0_DIDS(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_6_DFMT0_DIDS_SHIFT)) & XRDC_MDA_W0_6_DFMT0_DIDS_MASK)

#define XRDC_MDA_W0_6_DFMT0_PE_MASK              (0xC0U)
#define XRDC_MDA_W0_6_DFMT0_PE_SHIFT             (6U)
#define XRDC_MDA_W0_6_DFMT0_PE_WIDTH             (2U)
#define XRDC_MDA_W0_6_DFMT0_PE(x)                (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_6_DFMT0_PE_SHIFT)) & XRDC_MDA_W0_6_DFMT0_PE_MASK)

#define XRDC_MDA_W0_6_DFMT0_PIDM_MASK            (0x3F00U)
#define XRDC_MDA_W0_6_DFMT0_PIDM_SHIFT           (8U)
#define XRDC_MDA_W0_6_DFMT0_PIDM_WIDTH           (6U)
#define XRDC_MDA_W0_6_DFMT0_PIDM(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_6_DFMT0_PIDM_SHIFT)) & XRDC_MDA_W0_6_DFMT0_PIDM_MASK)

#define XRDC_MDA_W0_6_DFMT0_PID_MASK             (0x3F0000U)
#define XRDC_MDA_W0_6_DFMT0_PID_SHIFT            (16U)
#define XRDC_MDA_W0_6_DFMT0_PID_WIDTH            (6U)
#define XRDC_MDA_W0_6_DFMT0_PID(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_6_DFMT0_PID_SHIFT)) & XRDC_MDA_W0_6_DFMT0_PID_MASK)

#define XRDC_MDA_W0_6_DFMT0_DFMT_MASK            (0x20000000U)
#define XRDC_MDA_W0_6_DFMT0_DFMT_SHIFT           (29U)
#define XRDC_MDA_W0_6_DFMT0_DFMT_WIDTH           (1U)
#define XRDC_MDA_W0_6_DFMT0_DFMT(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_6_DFMT0_DFMT_SHIFT)) & XRDC_MDA_W0_6_DFMT0_DFMT_MASK)

#define XRDC_MDA_W0_6_DFMT0_LK1_MASK             (0x40000000U)
#define XRDC_MDA_W0_6_DFMT0_LK1_SHIFT            (30U)
#define XRDC_MDA_W0_6_DFMT0_LK1_WIDTH            (1U)
#define XRDC_MDA_W0_6_DFMT0_LK1(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_6_DFMT0_LK1_SHIFT)) & XRDC_MDA_W0_6_DFMT0_LK1_MASK)

#define XRDC_MDA_W0_6_DFMT0_VLD_MASK             (0x80000000U)
#define XRDC_MDA_W0_6_DFMT0_VLD_SHIFT            (31U)
#define XRDC_MDA_W0_6_DFMT0_VLD_WIDTH            (1U)
#define XRDC_MDA_W0_6_DFMT0_VLD(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_6_DFMT0_VLD_SHIFT)) & XRDC_MDA_W0_6_DFMT0_VLD_MASK)
/*! @} */
...
#define XRDC_MDA_W0_8_DFMT0_DID_MASK             (0x7U)
#define XRDC_MDA_W0_8_DFMT0_DID_SHIFT            (0U)
#define XRDC_MDA_W0_8_DFMT0_DID_WIDTH            (3U)
#define XRDC_MDA_W0_8_DFMT0_DID(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_8_DFMT0_DID_SHIFT)) & XRDC_MDA_W0_8_DFMT0_DID_MASK)

#define XRDC_MDA_W0_8_DFMT0_DIDS_MASK            (0x30U)
#define XRDC_MDA_W0_8_DFMT0_DIDS_SHIFT           (4U)
#define XRDC_MDA_W0_8_DFMT0_DIDS_WIDTH           (2U)
#define XRDC_MDA_W0_8_DFMT0_DIDS(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_8_DFMT0_DIDS_SHIFT)) & XRDC_MDA_W0_8_DFMT0_DIDS_MASK)

#define XRDC_MDA_W0_8_DFMT0_PE_MASK              (0xC0U)
#define XRDC_MDA_W0_8_DFMT0_PE_SHIFT             (6U)
#define XRDC_MDA_W0_8_DFMT0_PE_WIDTH             (2U)
#define XRDC_MDA_W0_8_DFMT0_PE(x)                (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_8_DFMT0_PE_SHIFT)) & XRDC_MDA_W0_8_DFMT0_PE_MASK)

#define XRDC_MDA_W0_8_DFMT0_PIDM_MASK            (0x3F00U)
#define XRDC_MDA_W0_8_DFMT0_PIDM_SHIFT           (8U)
#define XRDC_MDA_W0_8_DFMT0_PIDM_WIDTH           (6U)
#define XRDC_MDA_W0_8_DFMT0_PIDM(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_8_DFMT0_PIDM_SHIFT)) & XRDC_MDA_W0_8_DFMT0_PIDM_MASK)

#define XRDC_MDA_W0_8_DFMT0_PID_MASK             (0x3F0000U)
#define XRDC_MDA_W0_8_DFMT0_PID_SHIFT            (16U)
#define XRDC_MDA_W0_8_DFMT0_PID_WIDTH            (6U)
#define XRDC_MDA_W0_8_DFMT0_PID(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_8_DFMT0_PID_SHIFT)) & XRDC_MDA_W0_8_DFMT0_PID_MASK)

#define XRDC_MDA_W0_8_DFMT0_DFMT_MASK            (0x20000000U)
#define XRDC_MDA_W0_8_DFMT0_DFMT_SHIFT           (29U)
#define XRDC_MDA_W0_8_DFMT0_DFMT_WIDTH           (1U)
#define XRDC_MDA_W0_8_DFMT0_DFMT(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_8_DFMT0_DFMT_SHIFT)) & XRDC_MDA_W0_8_DFMT0_DFMT_MASK)

#define XRDC_MDA_W0_8_DFMT0_LK1_MASK             (0x40000000U)
#define XRDC_MDA_W0_8_DFMT0_LK1_SHIFT            (30U)
#define XRDC_MDA_W0_8_DFMT0_LK1_WIDTH            (1U)
#define XRDC_MDA_W0_8_DFMT0_LK1(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_8_DFMT0_LK1_SHIFT)) & XRDC_MDA_W0_8_DFMT0_LK1_MASK)

#define XRDC_MDA_W0_8_DFMT0_VLD_MASK             (0x80000000U)
#define XRDC_MDA_W0_8_DFMT0_VLD_SHIFT            (31U)
#define XRDC_MDA_W0_8_DFMT0_VLD_WIDTH            (1U)
#define XRDC_MDA_W0_8_DFMT0_VLD(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_8_DFMT0_VLD_SHIFT)) & XRDC_MDA_W0_8_DFMT0_VLD_MASK)
/*! @} */

/*! @name MDA_W0_9_DFMT1 - Master Domain Assignment */
/*! @{ */

#define XRDC_MDA_W0_9_DFMT1_DID_MASK             (0x7U)
#define XRDC_MDA_W0_9_DFMT1_DID_SHIFT            (0U)
#define XRDC_MDA_W0_9_DFMT1_DID_WIDTH            (3U)
...
#define XRDC_MDA_W0_9_DFMT1_PA_WIDTH             (2U)
...
#define XRDC_MDA_W0_9_DFMT1_SA_WIDTH             (2U)
...
#define XRDC_MDA_W0_9_DFMT1_DIDB_WIDTH           (1U)
...
#define XRDC_MDA_W0_9_DFMT1_DFMT_WIDTH           (1U)
...
#define XRDC_MDA_W0_9_DFMT1_LK1_WIDTH            (1U)
...
#define XRDC_MDA_W0_9_DFMT1_VLD_WIDTH            (1U)
...
#endif  /* #if !defined(S32K388_XRDC_H_) */
