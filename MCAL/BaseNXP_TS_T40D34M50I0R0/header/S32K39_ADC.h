 ...
 * @version 2.0
 * @date 2024-03-27
 * @brief Peripheral Access Layer for S32K39_ADC
 *
...
#if !defined(S32K39_ADC_H_)  /* Check if memory map has not been already included */
#define S32K39_ADC_H_
...
#define ADC_CDR2_COUNT                            26u
#define ADC_CDR3_COUNT                            32u
#define ADC_CWSELRPI_COUNT                        1u
#define ADC_CWSELRSI_COUNT                        4u
...
typedef struct {
  ...
  __IO uint32_t CEOCFR2;                           /**< Channel End Of Conversion Flag For External Inputs, offset: 0x1C, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __IO uint32_t CIMR2;                             /**< EOC Interrupt Enable For External Inputs, offset: 0x2C, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __IO uint32_t DMAR2;                             /**< DMA Request Enable For External Inputs, offset: 0x4C, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __IO uint32_t PSR2;                              /**< Presampling Enable For External Inputs, offset: 0x8C, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __IO uint32_t CTR2;                              /**< Conversion Timing For External Inputs, offset: 0x9C, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __IO uint32_t NCMR2;                             /**< Normal Conversion Enable For External Inputs, offset: 0xAC, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __IO uint32_t JCMR2;                             /**< Injected Conversion Enable For External Inputs, offset: 0xBC, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  uint8_t RESERVED_7[4];
  __IO uint32_t DSDR;                              /**< Delay Start Of Data Conversion, offset: 0xC4, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __I  uint32_t ECDR[ADC_CDR3_COUNT];              /**< External Input n Conversion Data, array offset: 0x200, array step: 0x4, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __IO uint32_t CWSELREI[ADC_CWSELREI_COUNT];      /**< Channel Analog Watchdog Select For External inputs, array offset: 0x2D0, array step: 0x4, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __IO uint32_t CWENR2;                            /**< Channel Watchdog Enable For External Inputs, offset: 0x2E8, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  ...
  __IO uint32_t AWORR2;                            /**< Analog Watchdog Out Of Range For External Inputs, offset: 0x2F8, available only on: ADC_0, ADC_1 (missing on ADC_2, ADC_3, ADC_4, ADC_5, ADC_6) */
  uint8_t RESERVED_14[68];
...
#define IP_ADC_3_BASE                            (0x400AC000u)
/** Peripheral ADC_3 base pointer */
#define IP_ADC_3                                 ((ADC_Type *)IP_ADC_3_BASE)
/** Peripheral ADC_4 base address */
#define IP_ADC_4_BASE                            (0x406D0000u)
/** Peripheral ADC_4 base pointer */
#define IP_ADC_4                                 ((ADC_Type *)IP_ADC_4_BASE)
/** Peripheral ADC_5 base address */
#define IP_ADC_5_BASE                            (0x406D4000u)
/** Peripheral ADC_5 base pointer */
#define IP_ADC_5                                 ((ADC_Type *)IP_ADC_5_BASE)
/** Peripheral ADC_6 base address */
#define IP_ADC_6_BASE                            (0x406D8000u)
/** Peripheral ADC_6 base pointer */
#define IP_ADC_6                                 ((ADC_Type *)IP_ADC_6_BASE)
/** Array initializer of ADC peripheral base addresses */
#define IP_ADC_BASE_ADDRS                        { IP_ADC_0_BASE, IP_ADC_1_BASE, IP_ADC_2_BASE, IP_ADC_3_BASE, IP_ADC_4_BASE, IP_ADC_5_BASE, IP_ADC_6_BASE }
/** Array initializer of ADC peripheral base pointers */
#define IP_ADC_BASE_PTRS                         { IP_ADC_0, IP_ADC_1, IP_ADC_2, IP_ADC_3, IP_ADC_4, IP_ADC_5, IP_ADC_6 }
...
#define ADC_CEOCFR1_SIEOCF24_MASK                (0x1000000U)
#define ADC_CEOCFR1_SIEOCF24_SHIFT               (24U)
#define ADC_CEOCFR1_SIEOCF24_WIDTH               (1U)
#define ADC_CEOCFR1_SIEOCF24(x)                  (((uint32_t)(((uint32_t)(x)) << ADC_CEOCFR1_SIEOCF24_SHIFT)) & ADC_CEOCFR1_SIEOCF24_MASK)

#define ADC_CEOCFR1_SIEOCF25_MASK                (0x2000000U)
#define ADC_CEOCFR1_SIEOCF25_SHIFT               (25U)
#define ADC_CEOCFR1_SIEOCF25_WIDTH               (1U)
#define ADC_CEOCFR1_SIEOCF25(x)                  (((uint32_t)(((uint32_t)(x)) << ADC_CEOCFR1_SIEOCF25_SHIFT)) & ADC_CEOCFR1_SIEOCF25_MASK)
/*! @} */
...
#define ADC_CIMR1_SIEOCIEN24_MASK                (0x1000000U)
#define ADC_CIMR1_SIEOCIEN24_SHIFT               (24U)
#define ADC_CIMR1_SIEOCIEN24_WIDTH               (1U)
#define ADC_CIMR1_SIEOCIEN24(x)                  (((uint32_t)(((uint32_t)(x)) << ADC_CIMR1_SIEOCIEN24_SHIFT)) & ADC_CIMR1_SIEOCIEN24_MASK)

#define ADC_CIMR1_SIEOCIEN25_MASK                (0x2000000U)
#define ADC_CIMR1_SIEOCIEN25_SHIFT               (25U)
#define ADC_CIMR1_SIEOCIEN25_WIDTH               (1U)
#define ADC_CIMR1_SIEOCIEN25(x)                  (((uint32_t)(((uint32_t)(x)) << ADC_CIMR1_SIEOCIEN25_SHIFT)) & ADC_CIMR1_SIEOCIEN25_MASK)
/*! @} */
...
#define ADC_DMAR1_SIDMAREN24_MASK                (0x1000000U)
#define ADC_DMAR1_SIDMAREN24_SHIFT               (24U)
#define ADC_DMAR1_SIDMAREN24_WIDTH               (1U)
#define ADC_DMAR1_SIDMAREN24(x)                  (((uint32_t)(((uint32_t)(x)) << ADC_DMAR1_SIDMAREN24_SHIFT)) & ADC_DMAR1_SIDMAREN24_MASK)

#define ADC_DMAR1_SIDMAREN25_MASK                (0x2000000U)
#define ADC_DMAR1_SIDMAREN25_SHIFT               (25U)
#define ADC_DMAR1_SIDMAREN25_WIDTH               (1U)
#define ADC_DMAR1_SIDMAREN25(x)                  (((uint32_t)(((uint32_t)(x)) << ADC_DMAR1_SIDMAREN25_SHIFT)) & ADC_DMAR1_SIDMAREN25_MASK)
/*! @} */
...
#define ADC_PSR1_PRES24_MASK                     (0x1000000U)
#define ADC_PSR1_PRES24_SHIFT                    (24U)
#define ADC_PSR1_PRES24_WIDTH                    (1U)
#define ADC_PSR1_PRES24(x)                       (((uint32_t)(((uint32_t)(x)) << ADC_PSR1_PRES24_SHIFT)) & ADC_PSR1_PRES24_MASK)

#define ADC_PSR1_PRES25_MASK                     (0x2000000U)
#define ADC_PSR1_PRES25_SHIFT                    (25U)
#define ADC_PSR1_PRES25_WIDTH                    (1U)
#define ADC_PSR1_PRES25(x)                       (((uint32_t)(((uint32_t)(x)) << ADC_PSR1_PRES25_SHIFT)) & ADC_PSR1_PRES25_MASK)
/*! @} */
...
#define ADC_NCMR1_CH56_MASK                      (0x1000000U)
#define ADC_NCMR1_CH56_SHIFT                     (24U)
#define ADC_NCMR1_CH56_WIDTH                     (1U)
#define ADC_NCMR1_CH56(x)                        (((uint32_t)(((uint32_t)(x)) << ADC_NCMR1_CH56_SHIFT)) & ADC_NCMR1_CH56_MASK)

#define ADC_NCMR1_CH57_MASK                      (0x2000000U)
#define ADC_NCMR1_CH57_SHIFT                     (25U)
#define ADC_NCMR1_CH57_WIDTH                     (1U)
#define ADC_NCMR1_CH57(x)                        (((uint32_t)(((uint32_t)(x)) << ADC_NCMR1_CH57_SHIFT)) & ADC_NCMR1_CH57_MASK)
/*! @} */
...
#define ADC_JCMR1_CH56_MASK                      (0x1000000U)
#define ADC_JCMR1_CH56_SHIFT                     (24U)
#define ADC_JCMR1_CH56_WIDTH                     (1U)
#define ADC_JCMR1_CH56(x)                        (((uint32_t)(((uint32_t)(x)) << ADC_JCMR1_CH56_SHIFT)) & ADC_JCMR1_CH56_MASK)

#define ADC_JCMR1_CH57_MASK                      (0x2000000U)
#define ADC_JCMR1_CH57_SHIFT                     (25U)
#define ADC_JCMR1_CH57_WIDTH                     (1U)
#define ADC_JCMR1_CH57(x)                        (((uint32_t)(((uint32_t)(x)) << ADC_JCMR1_CH57_SHIFT)) & ADC_JCMR1_CH57_MASK)
/*! @} */
...
#define ADC_CWSELRSI_WSEL_SI0_3_MASK             (0x3U)
#define ADC_CWSELRSI_WSEL_SI0_3_SHIFT            (0U)
#define ADC_CWSELRSI_WSEL_SI0_3_WIDTH            (2U)
#define ADC_CWSELRSI_WSEL_SI0_3(x)               (((uint32_t)(((uint32_t)(x)) << ADC_CWSELRSI_WSEL_SI0_3_SHIFT)) & ADC_CWSELRSI_WSEL_SI0_3_MASK)
...
#define ADC_CWSELRSI_WSEL_SI1_3_MASK             (0x30U)
#define ADC_CWSELRSI_WSEL_SI1_3_SHIFT            (4U)
#define ADC_CWSELRSI_WSEL_SI1_3_WIDTH            (2U)
#define ADC_CWSELRSI_WSEL_SI1_3(x)               (((uint32_t)(((uint32_t)(x)) << ADC_CWSELRSI_WSEL_SI1_3_SHIFT)) & ADC_CWSELRSI_WSEL_SI1_3_MASK)
...
#define ADC_CWENR1_CWEN56_MASK                   (0x1000000U)
#define ADC_CWENR1_CWEN56_SHIFT                  (24U)
#define ADC_CWENR1_CWEN56_WIDTH                  (1U)
#define ADC_CWENR1_CWEN56(x)                     (((uint32_t)(((uint32_t)(x)) << ADC_CWENR1_CWEN56_SHIFT)) & ADC_CWENR1_CWEN56_MASK)

#define ADC_CWENR1_CWEN57_MASK                   (0x2000000U)
#define ADC_CWENR1_CWEN57_SHIFT                  (25U)
#define ADC_CWENR1_CWEN57_WIDTH                  (1U)
#define ADC_CWENR1_CWEN57(x)                     (((uint32_t)(((uint32_t)(x)) << ADC_CWENR1_CWEN57_SHIFT)) & ADC_CWENR1_CWEN57_MASK)
/*! @} */
...
#endif  /* #if !defined(S32K39_ADC_H_) */
