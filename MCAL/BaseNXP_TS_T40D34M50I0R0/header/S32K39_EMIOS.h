 ...
 * @version 2.0
 * @date 2024-03-27
 * @brief Peripheral Access Layer for S32K39_eMIOS
 *
...
#if !defined(S32K39_eMIOS_H_)  /* Check if memory map has not been already included */
#define S32K39_eMIOS_H_
...
#define eMIOS_INSTANCE_COUNT                     (1u)
...
#define IP_eMIOS_BASE_ADDRS                      { IP_EMIOS_0_BASE }
/** Array initializer of eMIOS peripheral base pointers */
#define IP_eMIOS_BASE_PTRS                       { IP_EMIOS_0 }
...
#endif  /* #if !defined(S32K39_eMIOS_H_) */
