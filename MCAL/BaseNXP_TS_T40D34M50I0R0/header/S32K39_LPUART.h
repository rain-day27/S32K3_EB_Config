...
/*!
 * @file S32K39_LPUART.h
 * @version 2.0
 * @date 2024-03-27
 * @brief Peripheral Access Layer for S32K39_LPUART
 *
...
#if !defined(S32K39_LPUART_H_)  /* Check if memory map has not been already included */
#define S32K39_LPUART_H_
...
typedef struct {
  ...
  __IO uint32_t MCR;                               /**< MODEM Control, offset: 0x40, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
  __IO uint32_t MSR;                               /**< MODEM Status, offset: 0x44, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
  __IO uint32_t REIR;                              /**< Receiver Extended Idle, offset: 0x48, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
  __IO uint32_t TEIR;                              /**< Transmitter Extended Idle, offset: 0x4C, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
  __IO uint32_t HDCR;                              /**< Half Duplex Control, offset: 0x50, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
  uint8_t RESERVED_1[4];
  __IO uint32_t TOCR;                              /**< Timeout Control, offset: 0x58, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
  __IO uint32_t TOSR;                              /**< Timeout Status, offset: 0x5C, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
  __IO uint32_t TIMEOUT[LPUART_TIMEOUT_COUNT];     /**< Timeout N, array offset: 0x60, array step: 0x4, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
  uint8_t RESERVED_2[400];
  __O  uint32_t TCBR[LPUART_TCBR_COUNT];           /**< Transmit Command Burst, array offset: 0x200, array step: 0x4, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
  __O  uint32_t TDBR[LPUART_TDBR_COUNT];           /**< Transmit Data Burst, array offset: 0x400, array step: 0x4, available only on: LPUART_0, LPUART_1 (missing on LPUART_2, LPUART_3, LPUART_MSC) */
} LPUART_Type, *LPUART_MemMapPtr;

/** Number of instances of the LPUART module. */
#define LPUART_INSTANCE_COUNT                    (5u)
...
/** Peripheral LPUART_MSC base address */
#define IP_LPUART_MSC_BASE                       (0x40504000u)
/** Peripheral LPUART_MSC base pointer */
#define IP_LPUART_MSC                            ((LPUART_Type *)IP_LPUART_MSC_BASE)
/** Array initializer of LPUART peripheral base addresses */
#define IP_LPUART_BASE_ADDRS                     { IP_LPUART_0_BASE, IP_LPUART_1_BASE, IP_LPUART_2_BASE, IP_LPUART_3_BASE, IP_LPUART_MSC_BASE }
/** Array initializer of LPUART peripheral base pointers */
#define IP_LPUART_BASE_PTRS                      { IP_LPUART_0, IP_LPUART_1, IP_LPUART_2, IP_LPUART_3, IP_LPUART_MSC }
...
#endif  /* #if !defined(S32K39_LPUART_H_) */
