 ...
 * @version 1.7
 * @date 2022-11-18
 * @brief Peripheral Access Layer for S32K39_MPU
 *
...
#if !defined(S32K39_MPU_H_)  /* Check if memory map has not been already included */
#define S32K39_MPU_H_
...
#endif  /* #if !defined(S32K39_MPU_H_) */
