 ...
 * @version 2.0
 * @date 2024-03-27
 * @brief Peripheral Access Layer for S32K39_MSCM
 *
...
#if !defined(S32K39_MSCM_H_)  /* Check if memory map has not been already included */
#define S32K39_MSCM_H_
...
#define MSCM_ENEDC_TCM_BACKDOOR_MASK             (0x10000U)
#define MSCM_ENEDC_TCM_BACKDOOR_SHIFT            (16U)
#define MSCM_ENEDC_TCM_BACKDOOR_WIDTH            (1U)
#define MSCM_ENEDC_TCM_BACKDOOR(x)               (((uint32_t)(((uint32_t)(x)) << MSCM_ENEDC_TCM_BACKDOOR_SHIFT)) & MSCM_ENEDC_TCM_BACKDOOR_MASK)
...
#define MSCM_ENEDC1_EDMA1_MASK                   (0x1U)
#define MSCM_ENEDC1_EDMA1_SHIFT                  (0U)
#define MSCM_ENEDC1_EDMA1_WIDTH                  (1U)
#define MSCM_ENEDC1_EDMA1(x)                     (((uint32_t)(((uint32_t)(x)) << MSCM_ENEDC1_EDMA1_SHIFT)) & MSCM_ENEDC1_EDMA1_MASK)

#define MSCM_ENEDC1_ZIPWIRE_MASK                 (0x2U)
#define MSCM_ENEDC1_ZIPWIRE_SHIFT                (1U)
#define MSCM_ENEDC1_ZIPWIRE_WIDTH                (1U)
#define MSCM_ENEDC1_ZIPWIRE(x)                   (((uint32_t)(((uint32_t)(x)) << MSCM_ENEDC1_ZIPWIRE_SHIFT)) & MSCM_ENEDC1_ZIPWIRE_MASK)
...
#define MSCM_ENEDC1_EDMA1_S0_MASK                (0x80U)
#define MSCM_ENEDC1_EDMA1_S0_SHIFT               (7U)
#define MSCM_ENEDC1_EDMA1_S0_WIDTH               (1U)
#define MSCM_ENEDC1_EDMA1_S0(x)                  (((uint32_t)(((uint32_t)(x)) << MSCM_ENEDC1_EDMA1_S0_SHIFT)) & MSCM_ENEDC1_EDMA1_S0_MASK)

#define MSCM_ENEDC1_EDMA1_S1_MASK                (0x100U)
#define MSCM_ENEDC1_EDMA1_S1_SHIFT               (8U)
#define MSCM_ENEDC1_EDMA1_S1_WIDTH               (1U)
#define MSCM_ENEDC1_EDMA1_S1(x)                  (((uint32_t)(((uint32_t)(x)) << MSCM_ENEDC1_EDMA1_S1_SHIFT)) & MSCM_ENEDC1_EDMA1_S1_MASK)

#define MSCM_ENEDC1_AIPS3_MASK                   (0x1000U)
#define MSCM_ENEDC1_AIPS3_SHIFT                  (12U)
#define MSCM_ENEDC1_AIPS3_WIDTH                  (1U)
#define MSCM_ENEDC1_AIPS3(x)                     (((uint32_t)(((uint32_t)(x)) << MSCM_ENEDC1_AIPS3_SHIFT)) & MSCM_ENEDC1_AIPS3_MASK)

#define MSCM_ENEDC1_ADD_AIPS3_MASK               (0x2000U)
#define MSCM_ENEDC1_ADD_AIPS3_SHIFT              (13U)
#define MSCM_ENEDC1_ADD_AIPS3_WIDTH              (1U)
#define MSCM_ENEDC1_ADD_AIPS3(x)                 (((uint32_t)(((uint32_t)(x)) << MSCM_ENEDC1_ADD_AIPS3_SHIFT)) & MSCM_ENEDC1_ADD_AIPS3_MASK)
...
#endif  /* #if !defined(S32K39_MSCM_H_) */
