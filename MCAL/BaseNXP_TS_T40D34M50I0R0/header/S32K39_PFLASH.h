...
/*!
 * @file S32K39_PFLASH.h
 * @version 2.0
 * @date 2024-03-27
 * @brief Peripheral Access Layer for S32K39_PFLASH
 *
...
#if !defined(S32K39_PFLASH_H_)  /* Check if memory map has not been already included */
#define S32K39_PFLASH_H_
...
#define PFLASH_PFCRI_COUNT                        4u
#define PFLASH_PFCBLKI_SPELOCK_COUNT              4u
#define PFLASH_U_PFCBLKI_SPELOCK_COUNT            1u
#define PFLASH_PFCBLKI_SSPELOCK_COUNT             3u
#define PFLASH_PFCBLKI_SETSLOCK_COUNT             4u
#define PFLASH_U_PFCBLKI_SETSLOCK_COUNT           1u
#define PFLASH_PFCBLKI_SSETSLOCK_COUNT            3u
#define PFLASH_PFCBLKI_LOCKMASTER_S_COUNT         4u
#define PFLASH_PFCBLKI_LOCKMASTER_S_PFCBLKI_LOCKMASTER_SJ_COUNT 8u
#define PFLASH_U_PFCBLKI_LOCKMASTER_S_COUNT       1u
#define PFLASH_PFCBLKI_LOCKMASTER_SS_COUNT        3u
#define PFLASH_PFCBLKI_LOCKMASTER_SS_PFCBLKI_LOCKMASTER_SSJ_COUNT 7u

/** PFLASH - Register Layout Typedef */
typedef struct {
  __IO uint32_t PFCR[PFLASH_PFCRI_COUNT];          /**< Platform Flash Memory Configuration 0..Platform Flash Memory Configuration 3, array offset: 0x0, array step: 0x4 */
  ...
  __I  uint32_t PFCBLK_LOCKMASTER_SS[PFLASH_PFCBLKI_LOCKMASTER_SS_COUNT][PFLASH_PFCBLKI_LOCKMASTER_SS_PFCBLKI_LOCKMASTER_SSJ_COUNT]; /**< Block m Lock Master Super Sector n, array offset: 0x484, array step: index*0x1C, index2*0x4 */
...
#define IP_PFLASH_ALT_BASE                       (0x4026C000u)
/** Peripheral PFLASH_ALT base pointer */
#define IP_PFLASH_ALT                            ((PFLASH_Type *)IP_PFLASH_ALT_BASE)
/** Array initializer of PFLASH peripheral base addresses */
#define IP_PFLASH_BASE_ADDRS                     { IP_PFLASH_BASE, IP_PFLASH_ALT_BASE }
/** Array initializer of PFLASH peripheral base pointers */
#define IP_PFLASH_BASE_PTRS                      { IP_PFLASH, IP_PFLASH_ALT }
...
/*! @name PFCR - Platform Flash Memory Configuration 0..Platform Flash Memory Configuration 3 */
/*! @{ */
...
#define PFLASH_PFCR_P3_CBFEN_MASK                (0x1U)
#define PFLASH_PFCR_P3_CBFEN_SHIFT               (0U)
#define PFLASH_PFCR_P3_CBFEN_WIDTH               (1U)
#define PFLASH_PFCR_P3_CBFEN(x)                  (((uint32_t)(((uint32_t)(x)) << PFLASH_PFCR_P3_CBFEN_SHIFT)) & PFLASH_PFCR_P3_CBFEN_MASK)
...
#define PFLASH_PFCR_P3_DBFEN_MASK                (0x2U)
#define PFLASH_PFCR_P3_DBFEN_SHIFT               (1U)
#define PFLASH_PFCR_P3_DBFEN_WIDTH               (1U)
#define PFLASH_PFCR_P3_DBFEN(x)                  (((uint32_t)(((uint32_t)(x)) << PFLASH_PFCR_P3_DBFEN_SHIFT)) & PFLASH_PFCR_P3_DBFEN_MASK)
...
#define PFLASH_PFCR_P3_CPFEN_MASK                (0x10U)
#define PFLASH_PFCR_P3_CPFEN_SHIFT               (4U)
#define PFLASH_PFCR_P3_CPFEN_WIDTH               (1U)
#define PFLASH_PFCR_P3_CPFEN(x)                  (((uint32_t)(((uint32_t)(x)) << PFLASH_PFCR_P3_CPFEN_SHIFT)) & PFLASH_PFCR_P3_CPFEN_MASK)
...
#define PFLASH_PFCR_P3_DPFEN_MASK                (0x20U)
#define PFLASH_PFCR_P3_DPFEN_SHIFT               (5U)
#define PFLASH_PFCR_P3_DPFEN_WIDTH               (1U)
#define PFLASH_PFCR_P3_DPFEN(x)                  (((uint32_t)(((uint32_t)(x)) << PFLASH_PFCR_P3_DPFEN_SHIFT)) & PFLASH_PFCR_P3_DPFEN_MASK)
/*! @} */
...
#define PFLASH_PFCBLK_SSPELOCK_SSLCK_MASK        (0xFFFFFFFU)
#define PFLASH_PFCBLK_SSPELOCK_SSLCK_SHIFT       (0U)
#define PFLASH_PFCBLK_SSPELOCK_SSLCK_WIDTH       (28U)
...
#define PFLASH_PFCBLK_SSETSLOCK_SSETSLCK_MASK    (0xFFFFFFFU)
#define PFLASH_PFCBLK_SSETSLOCK_SSETSLCK_SHIFT   (0U)
#define PFLASH_PFCBLK_SSETSLOCK_SSETSLCK_WIDTH   (28U)
...
#endif  /* #if !defined(S32K39_PFLASH_H_) */
