 ...
 * @version 2.0
 * @date 2024-03-27
 * @brief Peripheral Access Layer for S32K39_PMC
 *
...
#if !defined(S32K39_PMC_H_)  /* Check if memory map has not been already included */
#define S32K39_PMC_H_
...
#endif  /* #if !defined(S32K39_PMC_H_) */
