...
/*!
 * @file S32K39_SYSTICK.h
 * @version 1.7
 * @date 2022-11-18
 * @brief Peripheral Access Layer for S32K39_SYSTICK
 *
...
#if !defined(S32K39_SYSTICK_H_)  /* Check if memory map has not been already included */
#define S32K39_SYSTICK_H_
...
#endif  /* #if !defined(S32K39_SYSTICK_H_) */
