 ...
 * @version 2.0
 * @date 2024-03-27
 * @brief Peripheral Access Layer for S32K39_XRDC
 *
...
#if !defined(S32K39_XRDC_H_)  /* Check if memory map has not been already included */
#define S32K39_XRDC_H_
...
#define XRDC_MDAC_COUNT                           9u
#define XRDC_MRC_COUNT                            4u
#define XRDC_DERRLOC_COUNT                        4u
#define XRDC_DERRW0_COUNT                         20u
#define XRDC_PID_COUNT                            7u
#define XRDC_PDAC_SLOT_PDACN_COUNT                111u
#define XRDC_PDAC_SLOT_COUNT                      4u
#define XRDC_MRCN_COUNT                           4u
...
typedef struct {
  ...
  struct XRDC_DERRW0 {                             /* offset: 0x400, array step: 0x10 */
    __I  uint32_t DERR_W0;                           /**< Domain Error Word 0, array offset: 0x400, array step: 0x10, valid indices: [0-3, 16-19] */
    __I  uint32_t DERR_W1;                           /**< Domain Error Word 1, array offset: 0x404, array step: 0x10, valid indices: [0-3, 16-19] */
    uint8_t RESERVED_0[4];
    __O  uint32_t DERR_W3;                           /**< Domain Error Word 3, array offset: 0x40C, array step: 0x10, valid indices: [0-3, 16-19] */
  } DERRW0[XRDC_DERRW0_COUNT];
  uint8_t RESERVED_5[448];
  __IO uint32_t PID[XRDC_PID_COUNT];               /**< Process Identifier, array offset: 0x700, array step: 0x4, valid indices: [0, 3-4, 6] */
  ...
  struct XRDC_MRGDN {                              /* offset: 0x2000, array step: index*0x200, index2*0x20 */
    __IO uint32_t XRDC_MRGD_W0;                      /**< Memory Region Descriptor Word 0, array offset: 0x2000, array step: index*0x200, index2*0x20, valid indices: [0][0-15], [1][0-15], [2][0-3], [3][0-15] */
    __IO uint32_t XRDC_MRGD_W1;                      /**< Memory Region Descriptor Word 1, array offset: 0x2004, array step: index*0x200, index2*0x20, valid indices: [0][0-15], [1][0-15], [2][0-3], [3][0-15] */
    __IO uint32_t XRDC_MRGD_W2;                      /**< Memory Region Descriptor Word 2, array offset: 0x2008, array step: index*0x200, index2*0x20, valid indices: [0][0-15], [1][0-15], [2][0-3], [3][0-15] */
    __IO uint32_t XRDC_MRGD_W3;                      /**< Memory Region Descriptor Word 3, array offset: 0x200C, array step: index*0x200, index2*0x20, valid indices: [0][0-15], [1][0-15], [2][0-3], [3][0-15] */
...
#define XRDC_MDA_W0_6_DFMT0_DID_MASK             (0x3U)
#define XRDC_MDA_W0_6_DFMT0_DID_SHIFT            (0U)
#define XRDC_MDA_W0_6_DFMT0_DID_WIDTH            (2U)
...
#define XRDC_MDA_W0_7_DFMT1_DID_MASK             (0x3U)
#define XRDC_MDA_W0_7_DFMT1_DID_SHIFT            (0U)
#define XRDC_MDA_W0_7_DFMT1_DID_WIDTH            (2U)
...
#define XRDC_MDA_W0_8_DFMT1_DID_MASK             (0x3U)
#define XRDC_MDA_W0_8_DFMT1_DID_SHIFT            (0U)
#define XRDC_MDA_W0_8_DFMT1_DID_WIDTH            (2U)
...
#define XRDC_MDA_W0_8_DFMT1_PA_WIDTH             (2U)
...
#define XRDC_MDA_W0_8_DFMT1_SA_WIDTH             (2U)
...
#define XRDC_MDA_W0_8_DFMT1_DIDB_WIDTH           (1U)
...
#define XRDC_MDA_W0_8_DFMT1_DFMT_WIDTH           (1U)
...
#define XRDC_MDA_W0_8_DFMT1_LK1_WIDTH            (1U)
...
#define XRDC_MDA_W0_8_DFMT1_VLD_WIDTH            (1U)
...
#endif  /* #if !defined(S32K39_XRDC_H_) */
