...
#if !defined(S32M27x_COMMON_H_)  /* Check if memory map has not been already included */
#define S32M27x_COMMON_H_
#define MCU_S32M27x

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error S32M27x memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  DMA0_IRQn                    = 4,                /**< DMA channel 0 transfer complete */
  DMA1_IRQn                    = 5,                /**< DMA channel 1 transfer complete */
  DMA2_IRQn                    = 6,                /**< DMA channel 2 transfer complete */
  DMA3_IRQn                    = 7,                /**< DMA channel 3 transfer complete */
  DMA4_IRQn                    = 8,                /**< DMA channel 4 transfer complete */
  DMA5_IRQn                    = 9,                /**< DMA channel 5 transfer complete */
  DMA6_IRQn                    = 10,               /**< DMA channel 6 transfer complete */
  DMA7_IRQn                    = 11,               /**< DMA channel 7 transfer complete */
  DMA8_IRQn                    = 12,               /**< DMA channel 8 transfer complete */
  DMA9_IRQn                    = 13,               /**< DMA channel 9 transfer complete */
  DMA10_IRQn                   = 14,               /**< DMA channel 10 transfer complete */
  DMA11_IRQn                   = 15,               /**< DMA channel 11 transfer complete */
  ERM_0_IRQn                   = 36,               /**< ERM Single bit ECC error */
  ERM_1_IRQn                   = 37,               /**< ERM Multi bit ECC error */
  MCM_IRQn                     = 38,               /**< FPU ORed sources (Input Denormal, Inexact, Underflow, Overflow, Divide-by-Zero, Invalid Operand) */
  STM0_IRQn                    = 39,               /**< Single interrupt vector for all four channels */
  SWT0_IRQn                    = 42,               /**< Platform watchdog initial time-out */
  CTI0_IRQn                    = 45,               /**< CTI interrupt */
  FLASH_0_IRQn                 = 48,               /**< Program or erase operation is completed */
  FLASH_1_IRQn                 = 49,               /**< Main watchdog timeout interrupt/Express watchdog timeut interrupt */
  ...
  SIUL2_1_IRQn                 = 54,               /**< External Interrupt Vector 0 */
  SIUL2_2_IRQn                 = 55,               /**< External Interrupt Vector 0 */
  SIUL2_3_IRQn                 = 56,               /**< External Interrupt Vector 0 */
  ...
  BCTU_IRQn                    = 87,               /**< An interrupt is requested when a conversion is issued to the ADC, An interrupt is requested when new data is available from ADC0 conversion, An interrupt is requested when new data is available from ADC1 conversion, An interrupt is requested when the last command of a list is issued to the ADC, An Interrupt output for FIFO1, An Interrupt output for FIFO2 */
  ...
  FlexCAN0_0_IRQn              = 109,              /**< Interrupt indicating that the CAN bus went to Bus Off state, Interrupt indicating completion the Bus Off count process, Interrupt indicating that errors were detected on the CAN bus, Interrupt indicating that errors were detected on the CAN bus for FD messages, Interrupt indicating Transmit Error Counter transition from less than 96 to greater than equal to 96, Interrupt indicating Receive Error Counter transition from less than 96 to greater than 96, Interrupt asserted due to correctable error detected in memory read access, Interrupt asserted due to non-correctable error detected in memory read access by host (cpu),Interrupt asserted due to non-correctable error detected in memory read access by FlexCAN */
  FlexCAN0_1_IRQn              = 110,              /**< Message Buffer Interrupt line 0-31, the number of messages stored in FIFO is greater than the FIFO watermarker, At least one message stored in FIFO, An underflow occurs in the FIFO, An overflow occurs in the FIFO  */
  FlexCAN0_2_IRQn              = 111,              /**< Message Buffer Interrupt line 32-63 */
  FlexCAN1_0_IRQn              = 113,              /**< Interrupt indicating that the CAN bus went to Bus Off state, Interrupt indicating completion the Bus Off count process, Interrupt indicating that errors were detected on the CAN bus, Interrupt indicating that errors were detected on the CAN bus for FD messages, Interrupt indicating Transmit Error Counter transition from less than 96 to greater than equal to 96, Interrupt indicating Receive Error Counter transition from less than 96 to greater than equal to 96, Interrupt asserted due to correctable error detected in memory read access, Interrupt asserted due to non-correctable error detected in memory read access by host (cpu), Interrupt asserted due to non-correctable error detected in memory read access by FlexCAN */
  FlexCAN1_1_IRQn              = 114,              /**< Message Buffer Interrupt line 0-31 */
  FlexCAN1_2_IRQn              = 115,              /**< Message Buffer Interrupt line 32-63 */
  FlexCAN2_0_IRQn              = 116,              /**< Interrupt indicating that the CAN bus went to Bus Off state, Interrupt indicating completion the Bus Off count process, Interrupt indicating that errors were detected on the CAN bus, Interrupt indicating that errors were detected on the CAN bus for FD messages, Interrupt indicating Transmit Error Counter transition from less than 96 to greater than equal to 96, Interrupt indicating Receive Error Counter transition from less than 96 to greater than equal to 96, Interrupt asserted due to correctable error detected in memory read access, Interrupt asserted due to non-correctable error detected in memory read access by host (cpu), Interrupt asserted due to non-correctable error detected in memory read access by FlexCAN */
...
#endif  /* #if !defined(S32M27x_COMMON_H_) */
