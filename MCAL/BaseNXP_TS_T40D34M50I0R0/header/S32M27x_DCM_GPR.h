...
/*!
 * @file S32M27x_DCM_GPR.h
 * @version 1.4
 * @date 2024-07-02
 * @brief Peripheral Access Layer for S32M27x_DCM_GPR
 *
...
#if !defined(S32M27x_DCM_GPR_H_)  /* Check if memory map has not been already included */
#define S32M27x_DCM_GPR_H_
...
#define DCM_GPR_DCMRWF4_MUX_MODE_EN_ADC1_S18_WIDTH (1U)
...
#define DCM_GPR_DCMRWF4_MUX_MODE_EN_ADC0_S12_WIDTH (1U)
...
#define DCM_GPR_DCMRWF4_MUX_MODE_EN_ADC0_S13_WIDTH (1U)
...
#define DCM_GPR_DCMRWF4_MUX_MODE_EN_ADC0_S14_WIDTH (1U)
...
#define DCM_GPR_DCMRWF4_MUX_MODE_EN_ADC0_S17_WIDTH (1U)
...
#define DCM_GPR_DCMRWF4_MUX_MODE_EN_ADC0_P2_WIDTH (1U)
...
#endif  /* #if !defined(S32M27x_DCM_GPR_H_) */
