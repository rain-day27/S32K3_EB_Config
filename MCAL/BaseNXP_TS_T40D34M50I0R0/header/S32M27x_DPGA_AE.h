...
/*!
 * @file S32M27x_DPGA_AE.h
 * @version 1.4
 * @date 2024-07-02
 * @brief Peripheral Access Layer for S32M27x_DPGA_AE
 *
...
#if !defined(S32M27x_DPGA_AE_H_)  /* Check if memory map has not been already included */
#define S32M27x_DPGA_AE_H_
...
#endif  /* #if !defined(S32M27x_DPGA_AE_H_) */
