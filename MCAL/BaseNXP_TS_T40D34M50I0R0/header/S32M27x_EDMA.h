 ...
 * @version 1.4
 * @date 2024-07-02
 * @brief Peripheral Access Layer for S32M27x_eDMA
 *
...
#if !defined(S32M27x_eDMA_H_)  /* Check if memory map has not been already included */
#define S32M27x_eDMA_H_
...
#define eDMA_MP_GRPRI_COUNT                       12u
...
#define eDMA_CSR_ACTIVE_ID_MASK                  (0xF000000U)
#define eDMA_CSR_ACTIVE_ID_SHIFT                 (24U)
#define eDMA_CSR_ACTIVE_ID_WIDTH                 (4U)
...
#define eDMA_ES_ERRCHN_MASK                      (0xF000000U)
#define eDMA_ES_ERRCHN_SHIFT                     (24U)
#define eDMA_ES_ERRCHN_WIDTH                     (4U)
...
#define eDMA_INT_INT_MASK                        (0xFFFU)
#define eDMA_INT_INT_SHIFT                       (0U)
#define eDMA_INT_INT_WIDTH                       (12U)
...
#endif  /* #if !defined(S32M27x_eDMA_H_) */
