...
/*!
 * @file S32M27x_FLEXCAN.h
 * @version 1.4
 * @date 2024-07-02
 * @brief Peripheral Access Layer for S32M27x_FLEXCAN
 *
...
#if !defined(S32M27x_FLEXCAN_H_)  /* Check if memory map has not been already included */
#define S32M27x_FLEXCAN_H_
...
typedef struct {
  ...
  __IO uint32_t ERFCR;                             /**< Enhanced RX FIFO Control, offset: 0xC0C, available only on: CAN_0 (missing on CAN_1, CAN_2) */
  __IO uint32_t ERFIER;                            /**< Enhanced RX FIFO Interrupt Enable, offset: 0xC10, available only on: CAN_0 (missing on CAN_1, CAN_2) */
  __IO uint32_t ERFSR;                             /**< Enhanced RX FIFO Status, offset: 0xC14, available only on: CAN_0 (missing on CAN_1, CAN_2) */
  ...
  __IO uint32_t ERFFEL[FLEXCAN_ERFFEL_COUNT];      /**< Enhanced RX FIFO Filter Element, array offset: 0x3000, array step: 0x4, available only on: CAN_0 (missing on CAN_1, CAN_2) */
...
#define IP_FLEXCAN_BASE_ADDRS                    { IP_CAN_0_BASE, IP_CAN_1_BASE, IP_CAN_2_BASE }
/** Array initializer of FLEXCAN peripheral base pointers */
#define IP_FLEXCAN_BASE_PTRS                     { IP_CAN_0, IP_CAN_1, IP_CAN_2 }
...
#endif  /* #if !defined(S32M27x_FLEXCAN_H_) */
