...
/*!
 * @file S32M27x_PFLASH.h
 * @version 1.4
 * @date 2024-07-02
 * @brief Peripheral Access Layer for S32M27x_PFLASH
 *
...
#if !defined(S32M27x_PFLASH_H_)  /* Check if memory map has not been already included */
#define S32M27x_PFLASH_H_
...
typedef struct {
  ...
  struct PFLASH_PFCBLKI_LOCKMASTER_SS {            /* offset: 0x484, array step: 0x10 */
...
#endif  /* #if !defined(S32M27x_PFLASH_H_) */
