 ...
 * @version 1.0
 * @date 2021-12-23
 * @brief Peripheral Access Layer for S32M27x_SCB
 *
...
#if !defined(S32M27x_SCB_H_)  /* Check if memory map has not been already included */
#define S32M27x_SCB_H_
...
#endif  /* #if !defined(S32M27x_SCB_H_) */
