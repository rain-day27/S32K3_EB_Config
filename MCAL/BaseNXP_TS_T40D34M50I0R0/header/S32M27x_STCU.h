 ...
 * @version 1.4
 * @date 2024-07-02
 * @brief Peripheral Access Layer for S32M27x_STCU
 *
...
#if !defined(S32M27x_STCU_H_)  /* Check if memory map has not been already included */
#define S32M27x_STCU_H_
...
#endif  /* #if !defined(S32M27x_STCU_H_) */
