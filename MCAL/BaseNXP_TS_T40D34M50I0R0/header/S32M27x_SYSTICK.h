...
** ###################################################################
**     Processor:           S32M27x
**     Reference manual:    S32M27x RM Rev.1 Draft C
**     Version:             rev. 1.0, 2021-12-23
**     Build:               b211223
**
**     Abstract:
...
/*!
 * @file S32M27x_SYSTICK.h
 * @version 1.0
 * @date 2021-12-23
 * @brief Peripheral Access Layer for S32M27x_SYSTICK
 *
...
#if !defined(S32M27x_SYSTICK_H_)  /* Check if memory map has not been already included */
#define S32M27x_SYSTICK_H_
...
#endif  /* #if !defined(S32M27x_SYSTICK_H_) */
