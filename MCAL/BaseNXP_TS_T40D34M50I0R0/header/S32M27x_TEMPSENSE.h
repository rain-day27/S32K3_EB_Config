...
/*!
 * @file S32M27x_TEMPSENSE.h
 * @version 1.4
 * @date 2024-07-02
 * @brief Peripheral Access Layer for S32M27x_TEMPSENSE
 *
...
#if !defined(S32M27x_TEMPSENSE_H_)  /* Check if memory map has not been already included */
#define S32M27x_TEMPSENSE_H_
...
#endif  /* #if !defined(S32M27x_TEMPSENSE_H_) */
