 ...
 * @version 1.4
 * @date 2024-07-02
 * @brief Peripheral Access Layer for S32M27x_XRDC
 *
...
#if !defined(S32M27x_XRDC_H_)  /* Check if memory map has not been already included */
#define S32M27x_XRDC_H_
...
typedef struct {
  ...
  struct XRDC_DERRW0 {                             /* offset: 0x400, array step: 0x10 */
    __I  uint32_t DERR_W0;                           /**< Domain Error Word 0, array offset: 0x400, array step: 0x10, valid indices: [0-1, 16-18] */
    __I  uint32_t DERR_W1;                           /**< Domain Error Word 1, array offset: 0x404, array step: 0x10, valid indices: [0-1, 16-18] */
    uint8_t RESERVED_0[4];
    __O  uint32_t DERR_W3;                           /**< Domain Error Word 3, array offset: 0x40C, array step: 0x10, valid indices: [0-1, 16-18] */
  ...
  struct XRDC_PDAC_SLOT {                          /* offset: 0x1000, array step: 0x400 */
    struct XRDC_PDAC_SLOT_PDACN {                    /* offset: 0x1000, array step: index*0x400, index2*0x8 */
      __IO uint32_t PDAC_W0;                           /**< Peripheral Domain Access Control Word 0, array offset: 0x1000, array step: index*0x400, index2*0x8, valid indices: [0][32-36, 38-42, 44-47], [1][0-43, 45, 47, 49-56, 58-60, 63, 65-70, 73-81, 84-89, 91-93, 95-99, 101, 103-104, 108] */
      __IO uint32_t PDAC_W1;                           /**< Peripheral Domain Access Control Word 1, array offset: 0x1004, array step: index*0x400, index2*0x8, valid indices: [0][32-36, 38-42, 44-47], [1][0-43, 45, 47, 49-56, 58-60, 63, 65-70, 73-81, 84-89, 91-93, 95-99, 101, 103-104, 108] */
    } PDACN[XRDC_PDAC_SLOT_PDACN_COUNT];
    uint8_t RESERVED_0[152];
  } PDAC_SLOT[XRDC_PDAC_SLOT_COUNT];
  uint8_t RESERVED_11[2048];
  struct XRDC_MRCN {                               /* offset: 0x2000, array step: 0x200 */
    struct XRDC_MRCN_MRGDN {                         /* offset: 0x2000, array step: index*0x200, index2*0x20 */
...
#define XRDC_PID_PID_MASK                        (0x20U)
#define XRDC_PID_PID_SHIFT                       (5U)
#define XRDC_PID_PID_WIDTH                       (1U)
...
#endif  /* #if !defined(S32M27x_XRDC_H_) */
