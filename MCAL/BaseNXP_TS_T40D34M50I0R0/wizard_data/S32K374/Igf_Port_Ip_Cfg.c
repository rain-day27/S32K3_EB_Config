...
#define IGF_PORT_IP_SW_MAJOR_VERSION_CFG_C                5
...
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if the files Igf_Port_Ip_PBcfg.h and Igf_Port_Ip.h are of the same version */
#if (IGF_PORT_IP_VENDOR_ID_CFG_C != IGF_PORT_IP_VENDOR_ID_H)
    #error "Igf_Port_Ip_PBcfg.h and Igf_Port_Ip.h have different vendor ids"
#endif
/* Check if Igf_Port_Ip_PBcfg.h and Igf_Port_Ip.h are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Igf_Port_Ip_PBcfg.h and Igf_Port_Ip.h are different"
#endif
/* Check if Igf_Port_Ip_PBcfg.h and Igf_Port_Ip.h are of the same Software version */
    ...
    #error "Software Version Numbers of Igf_Port_Ip_PBcfg.h and Igf_Port_Ip.h are different"
#endif
