...
#define QSPI_IP_CONTROLLER_SW_MAJOR_VERSION_H                5
...
#if (QSPI_IP_CONTROLLER_VENDOR_ID_H != QSPI_IP_TYPES_VENDOR_ID_CFG)
...
/* Check if current file and Qspi_Ip_Types.h header file are of the same Autosar version */
     ...
     (QSPI_IP_CONTROLLER_AR_RELEASE_MINOR_VERSION_H    != QSPI_IP_TYPES_AR_RELEASE_MINOR_VERSION_CFG) || \
     (QSPI_IP_CONTROLLER_AR_RELEASE_REVISION_VERSION_H != QSPI_IP_TYPES_AR_RELEASE_REVISION_VERSION_CFG) \
    )
...
#if ((QSPI_IP_CONTROLLER_SW_MAJOR_VERSION_H != QSPI_IP_TYPES_SW_MAJOR_VERSION_CFG) || \
     (QSPI_IP_CONTROLLER_SW_MINOR_VERSION_H != QSPI_IP_TYPES_SW_MINOR_VERSION_CFG) || \
     (QSPI_IP_CONTROLLER_SW_PATCH_VERSION_H != QSPI_IP_TYPES_SW_PATCH_VERSION_CFG) \
    )
 ...
 ******************************************************************************/
     ...
     #define Qspi_Ip_SetAhbSeqWriteId(instance, seqID) \
             OsIf_Trusted_Call2params(Qspi_Ip_SetAhbSeqWriteId_Privileged, instance, seqID)
#else
     #define Qspi_Ip_WriteLuts(Instance, StartLutRegister, Data, Size) \
     ...
     #define Qspi_Ip_SetAhbSeqWriteId(instance, seqID) \
             Qspi_Ip_SetAhbSeqWriteId_Privileged(instance, seqID)
#endif
 ...
 * Implements   Qspi_Ip_SetAhbSeqId_Activity
 */
void Qspi_Ip_SetAhbSeqWriteId_Privileged(uint32 instance,
                                         uint8 seqID
                                        );
/*!
