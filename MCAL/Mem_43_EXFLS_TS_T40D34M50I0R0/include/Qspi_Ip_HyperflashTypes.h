...
#define QSPI_IP_HYPERFLASHTYPES_SW_MAJOR_VERSION             5
...
==================================================================================================*/
    ...
    /* Check if Qspi_Ip_HyperflashTypes header file and Std_Types.h header file are of the same Autosar version */
        ...
        #error "Autosar Version Numbers of Qspi_Ip_HyperflashTypes.h and Std_Types.h are different"
    #endif
#endif
