...
#include "Qspi_Ip_HyperramTypes.h"
...
#define QSPI_IP_TYPES_SW_MAJOR_VERSION_CFG             5
...
/* Check if current file and Qspi_Ip_HyperramTypes header file are of the same vendor */
#if (QSPI_IP_TYPES_VENDOR_ID_CFG != QSPI_IP_HYPERRAMTYPES_VENDOR_ID)
    #error "Qspi_Ip_Types.h and Qspi_Ip_HyperramTypes.h have different vendor ids"
#endif
/* Check if current file and Qspi_Ip_HyperramTypes header file are of the same Autosar version */
#if ((QSPI_IP_TYPES_AR_RELEASE_MAJOR_VERSION_CFG    != QSPI_IP_HYPERRAMTYPES_AR_RELEASE_MAJOR_VERSION) || \
     (QSPI_IP_TYPES_AR_RELEASE_MINOR_VERSION_CFG    != QSPI_IP_HYPERRAMTYPES_AR_RELEASE_MINOR_VERSION) || \
     (QSPI_IP_TYPES_AR_RELEASE_REVISION_VERSION_CFG != QSPI_IP_HYPERRAMTYPES_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Qspi_Ip_Types.h and Qspi_Ip_HyperramTypes.h are different"
#endif
/* Check if current file and Qspi_Ip_HyperramTypes header file are of the same Software version */
#if ((QSPI_IP_TYPES_SW_MAJOR_VERSION_CFG != QSPI_IP_HYPERRAMTYPES_SW_MAJOR_VERSION) || \
     (QSPI_IP_TYPES_SW_MINOR_VERSION_CFG != QSPI_IP_HYPERRAMTYPES_SW_MINOR_VERSION) || \
     (QSPI_IP_TYPES_SW_PATCH_VERSION_CFG != QSPI_IP_HYPERRAMTYPES_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Qspi_Ip_Types.h and Qspi_Ip_HyperramTypes.h are different"
#endif
...
typedef enum
{
    QSPI_IP_HYPER_RAM       = 2U,           /*!< HyperRam devices            */
...
typedef struct
{
    ...
    const Qspi_Ip_HyperRamConfigType * hrConfig;          /*!< Hyperram configuration, NULL if not used         */
