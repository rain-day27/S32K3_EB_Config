...
#define SENT_SW_MAJOR_VERSION               5
...
/* Check if current file and Sent_Types header file are of the same Software version */
    ...
    #endif
#endif /* SENT_VENDOR_ID != SENT_CFG_VENDOR_ID == STD_ON */
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
* @details          The Sent Driver module shall report the development error "SENT_E_UNINIT_U8 (0x01)",
*                   when the API Service is used without module initialization.
*/
#define SENT_E_UNINIT_U8            ((uint8)0x01U)
...
*                   "SENT_E_INVALID_CHANNEL_U8 (0x02)", when API Service used with
*                   an invalid or inactive channel parameter.
*/

#define SENT_E_INVALID_CHANNEL_U8   ((uint8)0x02U)

/**
* @brief            API service called with invalid configuration pointer
* @details          The Sent Driver module shall report the development error
*                   "SENT_E_INVALID_POINTER_U8 (0x03)", when API Service is called
*                   with invalid configuration pointer.
*
* @api
*/
#define SENT_E_INVALID_POINTER_U8   ((uint8)0x03U)

/**
* @brief            Initialization called when already initialized
* @details          The Sent Driver module shall report the development error
*                   "SENT_E_ALREADY_INITIALIZED_U8 (0x04)", when initialization is called
*                   when the driver is already initialized.
*
* @api
*/
#define SENT_E_ALREADY_INITIALIZED_U8  ((uint8)0x04U)

/**
* @brief            API service called with Invalid configuration set selection
* @details          The Sent Driver module shall report the development error
*                   "SENT_E_INIT_FAILED_U8 (0x05)", when API Service is called
*                   with invalid configuration set selection.
*
* @api
*/
#define SENT_E_INIT_FAILED_U8  ((uint8)0x05U)

/**
* @brief            API service used without controller initialization
* @details          The Sent Driver module shall report the development error "SENT_E_CTRL_UNINIT_U8 (0x06)",
*                   when the API Service is used without controller initialization.
*/
#define SENT_E_CTRL_UNINIT_U8            ((uint8)0x06U)
#endif /* STD_ON == SENT_DEV_ERROR_DETECT */

/**
* @brief            API service used with an invalid or inactive channel parameter
* @details          The Sent Driver module shall report the development error
*                   "SENT_E_INVALID_CTRL_U8 (0x07)", when API Service used with
*                   an invalid or inactive channel parameter.
*/

#define SENT_E_INVALID_CTRL_U8   ((uint8)0x07U)
/**
* @brief          Service ID (APIs) for Det reporting
* @details        Service ID (APIs) for Det reporting
*
*/
#define SENT_SID_DEINIT_U8                         ((uint8)0x01U)
/**
* @brief          Service ID (APIs) for Det reporting
* @details        Service ID (APIs) for Det reporting
*
*/
#define SENT_SID_INIT_U8                           ((uint8)0x02U)
/**
* @brief          Service ID (APIs) for Det reporting
* @details        Service ID (APIs) for Det reporting
*
*/
#define SENT_SID_GETFASTCHANNELMSGDATA_U8          ((uint8)0x03U)
/**
* @brief          Service ID (APIs) for Det reporting
* @details        Service ID (APIs) for Det reporting
*
*/
#define SENT_SID_GETSERIALCHANNELMSGDATA_U8        ((uint8)0x04U)
/**
* @brief          Service ID (APIs) for Det reporting
* @details        Service ID (APIs) for Det reporting
*
*/
#define SENT_SID_GETFASTMSGDATA_U8                 ((uint8)0x05U)
#define SENT_SID_GETSERIALMSGDATA_U8               ((uint8)0x06U)
#define SENT_SID_STARTCHANNELRECEIVING_U8          ((uint8)0x07U)
#define SENT_SID_STOPCHANNELRECEIVING_U8           ((uint8)0x08U)
#define SENT_SID_SPCREQUEST_U8                     ((uint8)0x09U)
#define SENT_SID_GETVERSIONINFO_U8                 ((uint8)0x10U)
...
/**
* @brief            This function triggers a low pulse for the specified SENT channel.
* @details          This function triggers a low pulse for the specified SENT channel.
*
* @param[in]        ControllerId: The Id of controller
* @param[in]        ChannelId: The Id of channel
* @param[in]        TimeTriggerPulse The time period in microseconds (us) to keep the pulse low
* @return           E_OK:   Channel request has been accepted.
*                   E_NOT_OK:   Channel request has not been accepted.
*
