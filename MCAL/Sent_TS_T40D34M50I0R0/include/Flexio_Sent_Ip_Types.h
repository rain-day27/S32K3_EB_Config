...
#define FLEXIO_SENT_IP_TYPES_SW_MAJOR_VERSION               5
...
*                                       DEFINES AND MACROS
==================================================================================================*/
#define     SENT_MAX_NIBBLE_DATA_U8            ((uint8) 0x06U)
/*==================================================================================================
*                                             ENUMS
==================================================================================================*/
...
typedef enum
{
    ...
    FLEXIO_SENT_ENHANCED_SERIAL_4_ID,  /*!< Serial message is ENHANCED SERIAL type */
    FLEXIO_SENT_ENHANCED_SERIAL_8_ID   /*!< Serial message is ENHANCED SERIAL type */
...
typedef struct
{
    ...
    uint8                           DataNibble[SENT_MAX_NIBBLE_DATA_U8];   /*!< Content of each nibble in the fast message */
 ...
 * @brief Callback for all peripherals which supports SENT features
 */
typedef void (*Sent_FastNotificationType)(Flexio_Sent_Ip_StatusType Event,
                                          Flexio_Sent_FastMsgType *SentFastMsg);

/**
 * @brief Callback for all peripherals which supports SENT features
 */
typedef void (*Sent_SlowNotificationType)(Flexio_Sent_Ip_StatusType Event,
                                          Flexio_Sent_SerialMsgType *SentSerialMsg);
...
typedef struct
{
    ...
    uint8                           AdditionalSpcFlexioTimer;
    uint8                           AdditionalSpcFlexioPin;
    boolean                         SpcMode;
} Flexio_ChnlConfig;
...
typedef struct
{
    uint8                           NibbleVal[SENT_MAX_NIBBLE_DATA_U8 + 2];
    uint8                           SerialData[18];
    uint8                           DataIndx;
    uint8                           FastMsgCount;
...
typedef struct
{
    ...
    Sent_CallbackType           SentFastErrorNotif[FEATURE_FLEXIO_SENT_MAX_TIMER_COUNT];        /*!< Fast CRC callback function */
    Sent_CallbackType           SentSerialErrorNotif[FEATURE_FLEXIO_SENT_MAX_TIMER_COUNT];      /*!< Slow CRC callback function */
    Sent_FastNotificationType   SentFastNotif[FEATURE_FLEXIO_SENT_MAX_TIMER_COUNT];           /*!< Fast callback function */
    Sent_SlowNotificationType   SentSerialNotif[FEATURE_FLEXIO_SENT_MAX_TIMER_COUNT];         /*!< Serial message callback function */
    Flexio_ChnlConfig           ChnlCfg[FEATURE_FLEXIO_SENT_MAX_TIMER_COUNT];                 /*!< Index of first used internal resource Instance (Timer) */
    boolean                     TransferErrorDetect[FEATURE_FLEXIO_SENT_MAX_TIMER_COUNT];
...
typedef struct
{
    ...
    const uint8 AdditionalSpcFlexioTimer;
    const uint8 AdditionalSpcFlexioPin;
    const boolean SpcMode;
