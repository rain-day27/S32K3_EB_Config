...
#define SENT_TYPES_SW_MAJOR_VERSION               5
...
/* Check if current file and Sent_Ipw_Types header file are of the same Software version */
    ...
    /* Check if current file and Std_Types.h header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of SentTypes.h and Std_Types.h are different"
    #endif
#endif
...
typedef struct
{
    /**< @brief UserID for configured controller */
    const uint32                UserIDConfigured;
