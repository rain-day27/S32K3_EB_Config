...
#define SENT_IPW_SW_MAJOR_VERSION_C             5
...
static const Flexio_CtrlConfigType * Flexio_Sent_Ip_apControllerConfig[FEATURE_FLEXIO_SENT_INSTANCE_COUNT];
...
*
*/
void Sent_Ipw_ControllerInit(uint8 ControllerId,
                             const Sent_Ipw_CtrlConfigType *IpwController)
{
...
*
*/
Std_ReturnType Sent_Ipw_GetFastChannelMsgData(uint8 ControllerId,
                                              uint8 ChannelId)
{
...
*
*/
Std_ReturnType Sent_Ipw_GetSerialChannelMsgData(uint8 ControllerId,
                                                uint8 ChannelId)
{
    Std_ReturnType RelVal;
...
*
*/
Std_ReturnType Sent_Ipw_StartChannelReceiving(uint8 ControllerId,
                                              uint8 ChannelId)
{
    Std_ReturnType RelVal;
...
*
*/
Std_ReturnType Sent_Ipw_StopChannelReceiving(uint8 ControllerId,
                                             uint8 ChannelId)
{
    Std_ReturnType RelVal;
...
* @param[in]        ControllerId: The Id of controller
* @param[in]        ChannelId: The Id of channel
* @param[in]        TimeTriggerPulse The period of time to keep the pulse low in microseconds
* @return           E_OK:   Channel request has been accepted.
*                   E_NOT_OK:   Channel request has not been accepted.
*
*/
Std_ReturnType Sent_Ipw_SpcRequest(uint8 ControllerId,
                                   uint8 ChannelId,
                                   uint16 TimeTriggerPulse)
{
    Std_ReturnType RelVal;

    if (STATUS_FLEXIO_SENT_IP_SUCCESS == (Flexio_Sent_Ip_StatusType)Flexio_Sent_Ip_SpcRequest(ControllerId, ChannelId, TimeTriggerPulse))
    {
        RelVal = E_OK;
    }
    else
