...
#define WDG_43_INSTANCE1_SW_MAJOR_VERSION_C             5
...
#endif /* (WDG_DIRECT_SERVICE_INSTANCE1 == STD_OFF) */
...
#endif /* (WDG_DIRECT_SERVICE_INSTANCE1 == STD_ON) */
...
#endif /* (WDG_CLEAR_RESET_REQUEST_INSTANCE1 == STD_ON) */
