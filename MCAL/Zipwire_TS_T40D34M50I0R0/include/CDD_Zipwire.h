...
#define CDD_ZIPWIRE_SW_MAJOR_VERSION            5
...
/* Check if the files CDD_Zipwire.h and Std_Types.h are of the same version */
...
#error "AutoSar Version Numbers of CDD_ZIPWIRE.h and Std_Types.h are different"
#endif
#endif
...
/**
* @brief        The ZIPWIRE module was never initialized
* @details      Parameter is used when raising a Det error
*
* */
...
/**
* @brief        The ZIPWIRE module uses an invalid instance
* @details      Parameter is used when raising a Det error
*
* */
#define ZIPWIRE_E_INVALID_INSTANCE     (22U)

/**
* @brief        The ZIPWIRE module uses an invalid channel
* @details      Parameter is used when raising a Det error
*
* */
#define ZIPWIRE_E_INVALID_CHANNEL      (23U)
/*==================================================================================================
*                                              ENUMS
==================================================================================================*/
